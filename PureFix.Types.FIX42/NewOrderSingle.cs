...
namespace PureFix.Types.FIX42
{
	...
	public sealed partial class NewOrderSingle : IFixMessage
	{
		...
		[TagDetails(Tag = 348, Type = TagType.Length, Offset = 29, Required = false)]
		public int? EncodedIssuerLen {get; set;}
		
		[TagDetails(Tag = 349, Type = TagType.RawData, Offset = 30, Required = false)]
		public byte[]? EncodedIssuer {get; set;}
		
		[TagDetails(Tag = 107, Type = TagType.String, Offset = 31, Required = false)]
		public string? SecurityDesc {get; set;}
		
		[TagDetails(Tag = 350, Type = TagType.Length, Offset = 32, Required = false)]
		public int? EncodedSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 351, Type = TagType.RawData, Offset = 33, Required = false)]
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 59, Required = false)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 60, Required = false)]
