...
{
	public static class CompIDReqGrpExt
	{
		public static void Parse(this CompIDReqGrp instance, MsgView? view)
		{
			...
			instance.NoCompIDs = new CompIDReqGrpNoCompIDs[countNoCompIDs];
