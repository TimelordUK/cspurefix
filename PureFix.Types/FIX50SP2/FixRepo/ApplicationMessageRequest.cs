...
{
	[MessageType("ApplicationMessageRequest", FixVersion.FIX50SP2)]
	public sealed partial class ApplicationMessageRequest : IFixMessage
	{
		...
		public ApplicationMessageRequestParties[]? Parties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new ApplicationMessageRequestParties[count];
