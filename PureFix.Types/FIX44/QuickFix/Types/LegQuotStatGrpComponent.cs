...
{
	public sealed partial class LegQuotStatGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 555, Offset = 0, Required = false)]
		public QuoteStatusReportLegQuotStatGrpNoLegs[]? NoLegs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegs") is IMessageView viewNoLegs)
			{
				...
				NoLegs = new QuoteStatusReportLegQuotStatGrpNoLegs[count];
