...
{
	[MessageType("ExecutionAcknowledgement", FixVersion.FIX50SP2)]
	public sealed partial class ExecutionAcknowledgement : IFixMessage
	{
		...
		[TagDetails(Tag = 669, Type = TagType.Float, Offset = 15, Required = false)]
		public double? LastParPx {get; set;}
		
		[TagDetails(Tag = 14, Type = TagType.Float, Offset = 16, Required = false)]
		public double? CumQty {get; set;}
		
		[TagDetails(Tag = 6, Type = TagType.Float, Offset = 17, Required = false)]
