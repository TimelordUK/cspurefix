...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class TradeAggregationRequest : IFixMessage
	{
		...
		public OrderAggregationGrpComponent? OrderAggregationGrp {get; set;}
		
		[Component(Offset = 11, Required = false)]
		public ExecutionAggregationGrpComponent? ExecutionAggregationGrp {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& TradeAggregationRequestID is not null
				&& TradeAggregationTransType is not null
				&& Side is not null
