...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class OrderCancelReject : IFixMessage
	{
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 21, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 22, Required = false, LinksToTag = 1664)]
