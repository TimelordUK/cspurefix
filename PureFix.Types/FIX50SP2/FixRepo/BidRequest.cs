...
{
	[MessageType("BidRequest", FixVersion.FIX50SP2)]
	public sealed partial class BidRequest : IFixMessage
	{
		...
		[TagDetails(Tag = 409, Type = TagType.Int, Offset = 11, Required = false)]
		public int? LiquidityIndType {get; set;}
		
		[TagDetails(Tag = 410, Type = TagType.Float, Offset = 12, Required = false)]
		public double? WtAverageLiquidity {get; set;}
		
		[TagDetails(Tag = 411, Type = TagType.Boolean, Offset = 13, Required = false)]
		public bool? ExchangeForPhysical {get; set;}
		
		[TagDetails(Tag = 412, Type = TagType.Float, Offset = 14, Required = false)]
		public double? OutMainCntryUIndex {get; set;}
		
		[TagDetails(Tag = 413, Type = TagType.Float, Offset = 15, Required = false)]
		public double? CrossPercent {get; set;}
		
		[TagDetails(Tag = 414, Type = TagType.Int, Offset = 16, Required = false)]
		public int? ProgRptReqs {get; set;}
		
		[TagDetails(Tag = 415, Type = TagType.Int, Offset = 17, Required = false)]
		public int? ProgPeriodInterval {get; set;}
		
		[TagDetails(Tag = 416, Type = TagType.Int, Offset = 18, Required = false)]
		public int? IncTaxInd {get; set;}
		
		[TagDetails(Tag = 121, Type = TagType.Boolean, Offset = 19, Required = false)]
		public bool? ForexReq {get; set;}
		
		[TagDetails(Tag = 417, Type = TagType.Int, Offset = 20, Required = false)]
		public int? NumBidders {get; set;}
		
		[TagDetails(Tag = 75, Type = TagType.LocalDate, Offset = 21, Required = false)]
		public DateOnly? TradeDate {get; set;}
		
		[TagDetails(Tag = 418, Type = TagType.String, Offset = 22, Required = true)]
		public string? BidTradeType {get; set;}
		
		[TagDetails(Tag = 419, Type = TagType.String, Offset = 23, Required = true)]
		public string? BasisPxType {get; set;}
		
		[TagDetails(Tag = 443, Type = TagType.UtcTimestamp, Offset = 24, Required = false)]
