...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class NewOrderCross : IFixMessage
	{
		...
		[TagDetails(Tag = 549, Type = TagType.Int, Offset = 3, Required = true)]
		public int? CrossType {get; set;}
		
		[TagDetails(Tag = 550, Type = TagType.Int, Offset = 4, Required = true)]
		public int? CrossPrioritization {get; set;}
		
		[Component(Offset = 5, Required = false)]
		public RootPartiesComponent? RootParties {get; set;}
		
		[Component(Offset = 6, Required = true)]
		public SideCrossOrdModGrpComponent? SideCrossOrdModGrp {get; set;}
		...
		[TagDetails(Tag = 1822, Type = TagType.Int, Offset = 15, Required = false)]
		...
		[TagDetails(Tag = 1300, Type = TagType.String, Offset = 20, Required = false)]
		public string? MarketSegmentID {get; set;}
		
		[TagDetails(Tag = 100, Type = TagType.String, Offset = 21, Required = false)]
		public string? ExDestination {get; set;}
		
		[TagDetails(Tag = 1133, Type = TagType.String, Offset = 22, Required = false)]
		...
		[TagDetails(Tag = 483, Type = TagType.UtcTimestamp, Offset = 28, Required = false)]
		...
		[TagDetails(Tag = 1092, Type = TagType.String, Offset = 33, Required = false)]
		...
		[TagDetails(Tag = 2897, Type = TagType.String, Offset = 39, Required = false)]
		public string? CurrencyCodeSource {get; set;}
		
		[TagDetails(Tag = 376, Type = TagType.String, Offset = 40, Required = false)]
		public string? ComplianceID {get; set;}
		
		[TagDetails(Tag = 23, Type = TagType.String, Offset = 41, Required = false)]
		public string? IOIID {get; set;}
		
		[TagDetails(Tag = 117, Type = TagType.String, Offset = 42, Required = false)]
		...
		[TagDetails(Tag = 1629, Type = TagType.Int, Offset = 48, Required = false)]
		public int? ExposureDuration {get; set;}
		
		[TagDetails(Tag = 1916, Type = TagType.Int, Offset = 49, Required = false)]
		public int? ExposureDurationUnit {get; set;}
		
		[TagDetails(Tag = 1815, Type = TagType.Int, Offset = 50, Required = false)]
		public int? TradingCapacity {get; set;}
		
		[TagDetails(Tag = 210, Type = TagType.Float, Offset = 51, Required = false)]
		...
		[TagDetails(Tag = 847, Type = TagType.Int, Offset = 54, Required = false)]
		...
		[TagDetails(Tag = 848, Type = TagType.String, Offset = 56, Required = false)]
		public string? TargetStrategyParameters {get; set;}
		
		[TagDetails(Tag = 849, Type = TagType.Float, Offset = 57, Required = false)]
		public double? ParticipationRate {get; set;}
		
		[TagDetails(Tag = 480, Type = TagType.String, Offset = 58, Required = false)]
		public string? CancellationRights {get; set;}
		
		[TagDetails(Tag = 481, Type = TagType.String, Offset = 59, Required = false)]
		public string? MoneyLaunderingStatus {get; set;}
		
		[TagDetails(Tag = 513, Type = TagType.String, Offset = 60, Required = false)]
		public string? RegistID {get; set;}
		
		[TagDetails(Tag = 494, Type = TagType.String, Offset = 61, Required = false)]
		public string? Designation {get; set;}
		
		[TagDetails(Tag = 1685, Type = TagType.Int, Offset = 62, Required = false)]
