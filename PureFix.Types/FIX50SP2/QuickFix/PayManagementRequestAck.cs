...
{
	[MessageType("DZ", FixVersion.FIX50SP2)]
	public sealed partial class PayManagementRequestAck : IFixMessage
	{
		...
		[TagDetails(Tag = 2813, Type = TagType.Int, Offset = 2, Required = true)]
