...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MassOrderAck : IFixMessage
	{
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 8, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 9, Required = false, LinksToTag = 1664)]
		...
		public OrderEntryAckGrpComponent? OrderEntryAckGrp {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& MassOrderRequestStatus is not null
				&& TradingCapacity is not null
