...
{
	[MessageType("Confirmation", FixVersion.FIX50SP2)]
	public sealed partial class Confirmation : IFixMessage
	{
		...
		public ConfirmationParties[]? Parties {get; set;}
		
		[TagDetails(Tag = 70, Type = TagType.String, Offset = 10, Required = false)]
		public string? AllocID {get; set;}
		
		[TagDetails(Tag = 793, Type = TagType.String, Offset = 11, Required = false)]
		public string? SecondaryAllocID {get; set;}
		
		[TagDetails(Tag = 467, Type = TagType.String, Offset = 12, Required = false)]
		public string? IndividualAllocID {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 13, Required = true)]
		public DateTime? TransactTime {get; set;}
		
		[TagDetails(Tag = 75, Type = TagType.LocalDate, Offset = 14, Required = true)]
		public DateOnly? TradeDate {get; set;}
		
		[Group(NoOfTag = 1020, Offset = 15, Required = false)]
		public ConfirmationTrdRegTimestamps[]? TrdRegTimestamps {get; set;}
		...
		[TagDetails(Tag = 80, Type = TagType.Float, Offset = 22, Required = true)]
		public double? AllocQty {get; set;}
		
		[TagDetails(Tag = 854, Type = TagType.Int, Offset = 23, Required = false)]
		public int? QtyType {get; set;}
		
		[TagDetails(Tag = 54, Type = TagType.String, Offset = 24, Required = true)]
		public string? Side {get; set;}
		
		[TagDetails(Tag = 15, Type = TagType.String, Offset = 25, Required = false)]
		public string? Currency {get; set;}
		
		[TagDetails(Tag = 30, Type = TagType.String, Offset = 26, Required = false)]
		public string? LastMkt {get; set;}
		
		[TagDetails(Tag = 79, Type = TagType.String, Offset = 27, Required = true)]
		public string? AllocAccount {get; set;}
		
		[TagDetails(Tag = 661, Type = TagType.Int, Offset = 28, Required = false)]
		public int? AllocAcctIDSource {get; set;}
		
		[TagDetails(Tag = 798, Type = TagType.Int, Offset = 29, Required = false)]
		public int? AllocAccountType {get; set;}
		
		[TagDetails(Tag = 6, Type = TagType.Float, Offset = 30, Required = true)]
		public double? AvgPx {get; set;}
		
		[TagDetails(Tag = 74, Type = TagType.Int, Offset = 31, Required = false)]
		public int? AvgPxPrecision {get; set;}
		
		[TagDetails(Tag = 423, Type = TagType.Int, Offset = 32, Required = false)]
		public int? PriceType {get; set;}
		
		[TagDetails(Tag = 860, Type = TagType.Float, Offset = 33, Required = false)]
		...
		[TagDetails(Tag = 861, Type = TagType.Float, Offset = 35, Required = false)]
		...
		[TagDetails(Tag = 81, Type = TagType.String, Offset = 39, Required = false)]
		public string? ProcessCode {get; set;}
		
		[TagDetails(Tag = 381, Type = TagType.Float, Offset = 40, Required = true)]
		public double? GrossTradeAmt {get; set;}
		
		[TagDetails(Tag = 157, Type = TagType.Int, Offset = 41, Required = false)]
		public int? NumDaysInterest {get; set;}
		
		[TagDetails(Tag = 230, Type = TagType.LocalDate, Offset = 42, Required = false)]
		public DateOnly? ExDate {get; set;}
		
		[TagDetails(Tag = 158, Type = TagType.Float, Offset = 43, Required = false)]
		public double? AccruedInterestRate {get; set;}
		
		[TagDetails(Tag = 159, Type = TagType.Float, Offset = 44, Required = false)]
		public double? AccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 738, Type = TagType.Float, Offset = 45, Required = false)]
		public double? InterestAtMaturity {get; set;}
		
		[TagDetails(Tag = 920, Type = TagType.Float, Offset = 46, Required = false)]
		public double? EndAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 921, Type = TagType.Float, Offset = 47, Required = false)]
		public double? StartCash {get; set;}
		
		[TagDetails(Tag = 922, Type = TagType.Float, Offset = 48, Required = false)]
		public double? EndCash {get; set;}
		
		[TagDetails(Tag = 238, Type = TagType.Float, Offset = 49, Required = false)]
		public double? Concession {get; set;}
		
		[TagDetails(Tag = 237, Type = TagType.Float, Offset = 50, Required = false)]
		public double? TotalTakedown {get; set;}
		
		[TagDetails(Tag = 118, Type = TagType.Float, Offset = 51, Required = true)]
		public double? NetMoney {get; set;}
		
		[TagDetails(Tag = 890, Type = TagType.Float, Offset = 52, Required = false)]
		public double? MaturityNetMoney {get; set;}
		
		[TagDetails(Tag = 119, Type = TagType.Float, Offset = 53, Required = false)]
		public double? SettlCurrAmt {get; set;}
		
		[TagDetails(Tag = 120, Type = TagType.String, Offset = 54, Required = false)]
		public string? SettlCurrency {get; set;}
		
		[TagDetails(Tag = 155, Type = TagType.Float, Offset = 55, Required = false)]
		public double? SettlCurrFxRate {get; set;}
		
		[TagDetails(Tag = 156, Type = TagType.String, Offset = 56, Required = false)]
		public string? SettlCurrFxRateCalc {get; set;}
		
		[TagDetails(Tag = 63, Type = TagType.String, Offset = 57, Required = false)]
		public string? SettlType {get; set;}
		
		[TagDetails(Tag = 64, Type = TagType.LocalDate, Offset = 58, Required = false)]
		...
		[TagDetails(Tag = 858, Type = TagType.Float, Offset = 61, Required = false)]
		public double? SharedCommission {get; set;}
		
		[Group(NoOfTag = 1019, Offset = 62, Required = false)]
		public ConfirmationStipulations[]? Stipulations {get; set;}
		
		[Component(Offset = 63, Required = true)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new ConfirmationParties[count];
			...
			if (view.GetView("TrdRegTimestamps") is IMessageView viewTrdRegTimestamps)
			{
				...
				TrdRegTimestamps = new ConfirmationTrdRegTimestamps[count];
				for (int i = 0; i < count; i++)
				{
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new ConfirmationStipulations[count];
				for (int i = 0; i < count; i++)
				{
					Stipulations[i] = new();
