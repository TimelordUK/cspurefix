...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class AllocationInstructionAck : IFixMessage
	{
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 20, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 21, Required = false, LinksToTag = 1664)]
