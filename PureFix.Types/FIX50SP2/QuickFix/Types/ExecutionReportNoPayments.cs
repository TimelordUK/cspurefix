...
{
	public sealed partial class ExecutionReportNoPayments : IFixGroup
	{
		...
		public PaymentBusinessCenterGrpComponent? PaymentBusinessCenterGrp {get; set;}
		...
		public PaymentSettlGrpComponent? PaymentSettlGrp {get; set;}
		...
		[TagDetails(Tag = 40984, Type = TagType.Length, Offset = 38, Required = false, LinksToTag = 40985)]
		public int? EncodedPaymentTextLen {get; set;}
		
		[TagDetails(Tag = 40985, Type = TagType.RawData, Offset = 39, Required = false, LinksToTag = 40984)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedPaymentText is not null)
			{
				writer.WriteWholeNumber(40984, EncodedPaymentText.Length);
				writer.WriteBuffer(40985, EncodedPaymentText);
			}
		}
