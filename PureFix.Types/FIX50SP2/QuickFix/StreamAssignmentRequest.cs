...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class StreamAssignmentRequest : IFixMessage
	{
		...
		public StrmAsgnReqGrpComponent? StrmAsgnReqGrp {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& StreamAsgnReqID is not null
				&& StreamAsgnReqType is not null
				&& StrmAsgnReqGrp is not null && ((IFixValidator)StrmAsgnReqGrp).IsValid(in config)
