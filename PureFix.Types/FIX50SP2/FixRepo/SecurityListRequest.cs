...
{
	[MessageType("SecurityListRequest", FixVersion.FIX50SP2)]
	public sealed partial class SecurityListRequest : IFixMessage
	{
		...
		[TagDetails(Tag = 263, Type = TagType.String, Offset = 16, Required = false)]
		public string? SubscriptionRequestType {get; set;}
		
		[Component(Offset = 17, Required = true)]
		public StandardTrailerComponent? StandardTrailer {get; set;}
		[TagDetails(Tag = 1465, Type = TagType.String, Offset = 18, Required = false)]
