...
namespace PureFix.Types.FIX44.QuickFix.Types
{
	public sealed partial class NstdPtys3SubGrpComponent : IFixComponent
	{
		...
		public NewOrderMultilegPreAllocMlegGrpNoAllocsNestedParties3NoNested3PartyIDsNstdPtys3SubGrpNoNested3PartySubIDs[]? NoNested3PartySubIDs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoNested3PartySubIDs") is IMessageView viewNoNested3PartySubIDs)
			{
				...
				NoNested3PartySubIDs = new NewOrderMultilegPreAllocMlegGrpNoAllocsNestedParties3NoNested3PartyIDsNstdPtys3SubGrpNoNested3PartySubIDs[count];
