...
{
	public sealed partial class IOINoLegAdditionalTermBondRefs : IFixGroup
	{
		...
		[TagDetails(Tag = 41320, Type = TagType.Length, Offset = 3, Required = false, LinksToTag = 41321)]
		public int? EncodedLegAdditionalTermBondDescLen {get; set;}
		
		[TagDetails(Tag = 41321, Type = TagType.RawData, Offset = 4, Required = false, LinksToTag = 41320)]
		...
		[TagDetails(Tag = 41324, Type = TagType.Length, Offset = 7, Required = false, LinksToTag = 41325)]
		public int? EncodedLegAdditionalTermBondIssuerLen {get; set;}
		
		[TagDetails(Tag = 41325, Type = TagType.RawData, Offset = 8, Required = false, LinksToTag = 41324)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedLegAdditionalTermBondDesc is not null)
			{
				writer.WriteWholeNumber(41320, EncodedLegAdditionalTermBondDesc.Length);
				writer.WriteBuffer(41321, EncodedLegAdditionalTermBondDesc);
			}
			...
			if (EncodedLegAdditionalTermBondIssuer is not null)
			{
				writer.WriteWholeNumber(41324, EncodedLegAdditionalTermBondIssuer.Length);
				writer.WriteBuffer(41325, EncodedLegAdditionalTermBondIssuer);
			}
