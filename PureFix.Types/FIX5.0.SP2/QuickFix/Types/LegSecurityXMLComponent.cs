...
{
	public sealed partial class LegSecurityXMLComponent : IFixComponent
	{
		...
		public string? LegSecurityXML {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (LegSecurityXML is not null) writer.WriteString(1872, LegSecurityXML);
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			LegSecurityXML = view.GetString(1872);
