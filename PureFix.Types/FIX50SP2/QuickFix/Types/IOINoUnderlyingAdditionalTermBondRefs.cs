...
{
	public sealed partial class IOINoUnderlyingAdditionalTermBondRefs : IFixGroup
	{
		...
		[TagDetails(Tag = 41710, Type = TagType.Length, Offset = 3, Required = false, LinksToTag = 41711)]
		public int? EncodedUnderlyingAdditionalTermBondDescLen {get; set;}
		
		[TagDetails(Tag = 41711, Type = TagType.RawData, Offset = 4, Required = false, LinksToTag = 41710)]
		...
		[TagDetails(Tag = 42025, Type = TagType.Length, Offset = 7, Required = false, LinksToTag = 42026)]
		public int? EncodedUnderlyingAdditionalTermBondIssuerLen {get; set;}
		
		[TagDetails(Tag = 42026, Type = TagType.RawData, Offset = 8, Required = false, LinksToTag = 42025)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedUnderlyingAdditionalTermBondDesc is not null)
			{
				writer.WriteWholeNumber(41710, EncodedUnderlyingAdditionalTermBondDesc.Length);
				writer.WriteBuffer(41711, EncodedUnderlyingAdditionalTermBondDesc);
			}
			...
			if (EncodedUnderlyingAdditionalTermBondIssuer is not null)
			{
				writer.WriteWholeNumber(42025, EncodedUnderlyingAdditionalTermBondIssuer.Length);
				writer.WriteBuffer(42026, EncodedUnderlyingAdditionalTermBondIssuer);
			}
