...
namespace PureFix.Types.FIX44.QuickFix.Types
{
	public sealed partial class SettlPartiesComponent : IFixComponent
	{
		...
		public AllocationInstructionAllocGrpNoAllocsSettlInstructionsDataDlvyInstGrpNoDlvyInstSettlPartiesNoSettlPartyIDs[]? NoSettlPartyIDs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoSettlPartyIDs") is IMessageView viewNoSettlPartyIDs)
			{
				...
				NoSettlPartyIDs = new AllocationInstructionAllocGrpNoAllocsSettlInstructionsDataDlvyInstGrpNoDlvyInstSettlPartiesNoSettlPartyIDs[count];
