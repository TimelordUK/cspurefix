...
{
	public sealed partial class SecLstUpdRelSymsLegGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 555, Offset = 0, Required = false)]
		public SecurityListUpdateReportNoLegs[]? NoLegs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegs") is IMessageView viewNoLegs)
			{
				...
				NoLegs = new SecurityListUpdateReportNoLegs[count];
