...
{
	public sealed partial class IOINoLegComplexEventCreditEvents : IFixGroup
	{
		...
		public LegComplexEventCreditEventQualifierGrpComponent? LegComplexEventCreditEventQualifierGrp {get; set;}
