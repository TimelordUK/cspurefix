...
{
	public static class MultilegOrderCancelReplaceRequestNoLegsExt
	{
		public static void Parse(this MultilegOrderCancelReplaceRequestNoLegs instance, MsgView? view)
		{
