...
{
	[MessageType("AssignmentReport", FixVersion.FIX50SP2)]
	public sealed partial class AssignmentReport : IFixMessage
	{
		...
		[TagDetails(Tag = 832, Type = TagType.Int, Offset = 3, Required = false)]
		public int? TotNumAssignmentReports {get; set;}
		
		[TagDetails(Tag = 912, Type = TagType.Boolean, Offset = 4, Required = false)]
		public bool? LastRptRequested {get; set;}
		
		[Group(NoOfTag = 1012, Offset = 5, Required = true)]
		public AssignmentReportParties[]? Parties {get; set;}
		...
		[Group(NoOfTag = 1015, Offset = 12, Required = false)]
		public AssignmentReportPositionQty[]? PositionQty {get; set;}
		
		[Group(NoOfTag = 1014, Offset = 13, Required = false)]
		public AssignmentReportPositionAmountData[]? PositionAmountData {get; set;}
		
		[TagDetails(Tag = 834, Type = TagType.Float, Offset = 14, Required = false)]
		public double? ThresholdAmount {get; set;}
		
		[TagDetails(Tag = 730, Type = TagType.Float, Offset = 15, Required = false)]
		public double? SettlPrice {get; set;}
		
		[TagDetails(Tag = 731, Type = TagType.Int, Offset = 16, Required = false)]
		public int? SettlPriceType {get; set;}
		
		[TagDetails(Tag = 732, Type = TagType.Float, Offset = 17, Required = false)]
		public double? UnderlyingSettlPrice {get; set;}
		
		[TagDetails(Tag = 734, Type = TagType.Float, Offset = 18, Required = false)]
		public double? PriorSettlPrice {get; set;}
		
		[TagDetails(Tag = 432, Type = TagType.LocalDate, Offset = 19, Required = false)]
		public DateOnly? ExpireDate {get; set;}
		
		[TagDetails(Tag = 744, Type = TagType.String, Offset = 20, Required = false)]
		public string? AssignmentMethod {get; set;}
		
		[TagDetails(Tag = 745, Type = TagType.Float, Offset = 21, Required = false)]
		public double? AssignmentUnit {get; set;}
		
		[TagDetails(Tag = 746, Type = TagType.Float, Offset = 22, Required = false)]
		public double? OpenInterest {get; set;}
		
		[TagDetails(Tag = 747, Type = TagType.String, Offset = 23, Required = false)]
		public string? ExerciseMethod {get; set;}
		
		[TagDetails(Tag = 716, Type = TagType.String, Offset = 24, Required = false)]
		public string? SettlSessID {get; set;}
		
		[TagDetails(Tag = 717, Type = TagType.String, Offset = 25, Required = false)]
		public string? SettlSessSubID {get; set;}
		
		[TagDetails(Tag = 715, Type = TagType.LocalDate, Offset = 26, Required = true)]
		...
		[TagDetails(Tag = 710, Type = TagType.String, Offset = 31, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new AssignmentReportParties[count];
			...
			if (view.GetView("PositionQty") is IMessageView viewPositionQty)
			{
				...
				PositionQty = new AssignmentReportPositionQty[count];
				for (int i = 0; i < count; i++)
				{
					PositionQty[i] = new();
			...
			if (view.GetView("PositionAmountData") is IMessageView viewPositionAmountData)
			{
				...
				PositionAmountData = new AssignmentReportPositionAmountData[count];
				for (int i = 0; i < count; i++)
				{
