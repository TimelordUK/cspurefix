...
{
	public static class MassQuoteAcknowledgementNoQuoteSetsNoQuoteEntriesExt
	{
		public static void Parse(this MassQuoteAcknowledgementNoQuoteSetsNoQuoteEntries instance, MsgView? view)
		{
			...
			instance.QuoteEntryRejectReason = view.GetInt32(368);
		}
	}
}
