...
{
	[MessageType("CrossOrderCancelRequest", FixVersion.FIX50SP2)]
	public sealed partial class CrossOrderCancelRequest : IFixMessage
	{
		...
		public CrossOrderCancelRequestRootParties[]? RootParties {get; set;}
		...
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 11, Required = true)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("RootParties") is IMessageView viewRootParties)
			{
				...
				RootParties = new CrossOrderCancelRequestRootParties[count];
