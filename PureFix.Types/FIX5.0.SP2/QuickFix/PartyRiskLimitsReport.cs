...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class PartyRiskLimitsReport : IFixMessage
	{
		...
		public PartyRiskLimitsGrpComponent? PartyRiskLimitsGrp {get; set;}
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 15, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 16, Required = false, LinksToTag = 1664)]
