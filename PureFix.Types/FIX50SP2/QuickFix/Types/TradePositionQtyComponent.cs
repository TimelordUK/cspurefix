...
{
	public sealed partial class TradePositionQtyComponent : IFixComponent
	{
		[Group(NoOfTag = 702, Offset = 0, Required = false)]
		public TradeCaptureReportNoPositions[]? NoPositions {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoPositions") is IMessageView viewNoPositions)
			{
				...
				NoPositions = new TradeCaptureReportNoPositions[count];
