...
{
	public sealed partial class StreamTerminationDateComponent : IFixComponent
	{
		...
		public StreamTerminationDateBusinessCenterGrpComponent? StreamTerminationDateBusinessCenterGrp {get; set;}
