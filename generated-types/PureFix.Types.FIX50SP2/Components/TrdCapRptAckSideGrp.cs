...
{
	public sealed partial class TrdCapRptAckSideGrp : IFixComponent
	{
		public sealed partial class NoSides : IFixGroup
		{
			...
			[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 19, Required = false)]
			public int? EncodedComplianceTextLen {get; set;}
			
			[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 20, Required = false)]
