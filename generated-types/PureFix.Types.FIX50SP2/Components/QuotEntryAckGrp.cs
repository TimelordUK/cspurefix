...
{
	public sealed partial class QuotEntryAckGrp : IFixComponent
	{
		public sealed partial class NoQuoteEntries : IFixGroup
		{
			...
			[TagDetails(Tag = 775, Type = TagType.Int, Offset = 27, Required = false)]
			public int? BookingType {get; set;}
			
			[TagDetails(Tag = 528, Type = TagType.String, Offset = 28, Required = false)]
			public string? OrderCapacity {get; set;}
			
			[TagDetails(Tag = 529, Type = TagType.String, Offset = 29, Required = false)]
			public string? OrderRestrictions {get; set;}
			
			[TagDetails(Tag = 1167, Type = TagType.Int, Offset = 30, Required = false)]
			public int? QuoteEntryStatus {get; set;}
			
			[TagDetails(Tag = 368, Type = TagType.Int, Offset = 31, Required = false)]
			...
			void IFixEncoder.Encode(IFixWriter writer)
			{
				...
				if (QuoteEntryStatus is not null) writer.WriteWholeNumber(1167, QuoteEntryStatus.Value);
			...
			void IFixParser.Parse(IMessageView? view)
			{
				...
				QuoteEntryStatus = view.GetInt32(1167);
