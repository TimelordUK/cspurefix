...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class ExecutionReport : IFixMessage
	{
		...
		public ContraGrpComponent? ContraGrp {get; set;}
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 40, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 41, Required = false, LinksToTag = 1664)]
		...
		public PaymentGrpComponent? PaymentGrp {get; set;}
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 102, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 103, Required = false, LinksToTag = 2351)]
		...
		public FillsGrpComponent? FillsGrp {get; set;}
		
		[Component(Offset = 157, Required = false)]
		public OrderEventGrpComponent? OrderEventGrp {get; set;}
		...
		public RelativeValueGrpComponent? RelativeValueGrp {get; set;}
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 209, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 210, Required = false, LinksToTag = 354)]
		...
		public InstrmtLegExecGrpComponent? InstrmtLegExecGrp {get; set;}
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 251, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 252, Required = false, LinksToTag = 2372)]
		...
		public ThrottleResponseComponent? ThrottleResponse {get; set;}
		...
		public RelatedOrderGrpComponent? RelatedOrderGrp {get; set;}
