...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class StreamCommoditySettlPeriodGrpComponent : IFixComponent
	{
		...
		public IOINoStreamCommoditySettlPeriods[]? NoStreamCommoditySettlPeriods {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoStreamCommoditySettlPeriods") is IMessageView viewNoStreamCommoditySettlPeriods)
			{
				...
				NoStreamCommoditySettlPeriods = new IOINoStreamCommoditySettlPeriods[count];
		...
		{
			NoStreamCommoditySettlPeriods = null;
		}
	}
}
