...
{
	public sealed partial class CrossOrderCancelReplaceRequestNoSides : IFixValidator, IFixEncoder
	{
		...
		public CrossOrderCancelReplaceRequestNoSidesNoAllocs[]? NoAllocs { get; set; }
