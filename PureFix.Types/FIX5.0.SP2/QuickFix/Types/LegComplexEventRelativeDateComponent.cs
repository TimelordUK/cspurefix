...
{
	public sealed partial class LegComplexEventRelativeDateComponent : IFixComponent
	{
		...
		public LegComplexEventDateBusinessCenterGrpComponent? LegComplexEventDateBusinessCenterGrp {get; set;}
