...
{
	public sealed partial class ListOrdGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 73, Offset = 0, Required = true)]
		public NewOrderListListOrdGrpNoOrders[]? NoOrders {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoOrders") is IMessageView viewNoOrders)
			{
				...
				NoOrders = new NewOrderListListOrdGrpNoOrders[count];
