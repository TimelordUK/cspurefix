...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MassQuote : IFixMessage
	{
		...
		public QuotSetGrpComponent? QuotSetGrp {get; set;}
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 18, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 19, Required = false, LinksToTag = 2351)]
