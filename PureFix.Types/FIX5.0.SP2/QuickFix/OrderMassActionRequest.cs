...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class OrderMassActionRequest : IFixMessage
	{
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 20, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 21, Required = false, LinksToTag = 2351)]
