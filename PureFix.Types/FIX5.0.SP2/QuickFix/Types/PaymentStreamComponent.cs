...
{
	public sealed partial class PaymentStreamComponent : IFixComponent
	{
		...
		public PaymentStreamPaymentDatesComponent? PaymentStreamPaymentDates {get; set;}
		
		[Component(Offset = 27, Required = false)]
		public PaymentStreamResetDatesComponent? PaymentStreamResetDates {get; set;}
		
		[Component(Offset = 28, Required = false)]
		public PaymentStreamFixedRateComponent? PaymentStreamFixedRate {get; set;}
		
		[Component(Offset = 29, Required = false)]
		public PaymentStreamFloatingRateComponent? PaymentStreamFloatingRate {get; set;}
		...
		public PaymentStreamCompoundingFloatingRateComponent? PaymentStreamCompoundingFloatingRate {get; set;}
		
		[Component(Offset = 32, Required = false)]
		public PaymentStreamCompoundingDatesComponent? PaymentStreamCompoundingDates {get; set;}
		
		[Component(Offset = 33, Required = false)]
		public PaymentStreamNonDeliverableSettlTermsComponent? PaymentStreamNonDeliverableSettlTerms {get; set;}
