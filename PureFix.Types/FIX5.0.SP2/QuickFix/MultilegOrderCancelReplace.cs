...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MultilegOrderCancelReplace : IFixMessage
	{
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 95, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 96, Required = false, LinksToTag = 354)]
