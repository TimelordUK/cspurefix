...
{
	public static class DerivativeSecurityListNoRelatedSymNoLegsExt
	{
		public static void Parse(this DerivativeSecurityListNoRelatedSymNoLegs instance, MsgView? view)
		{
