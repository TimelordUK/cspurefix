...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class EntitlementAttribGrpComponent : IFixComponent
	{
		...
		public PartyEntitlementsReportNoEntitlementAttrib[]? NoEntitlementAttrib {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoEntitlementAttrib") is IMessageView viewNoEntitlementAttrib)
			{
				...
				NoEntitlementAttrib = new PartyEntitlementsReportNoEntitlementAttrib[count];
