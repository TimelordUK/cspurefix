...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class SettlementObligationReport : IFixMessage
	{
		...
		public SettlObligationInstructionsComponent? SettlObligationInstructions {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& SettlObligMsgID is not null
				&& SettlObligMode is not null
				&& SettlObligationInstructions is not null && ((IFixValidator)SettlObligationInstructions).IsValid(in config)
