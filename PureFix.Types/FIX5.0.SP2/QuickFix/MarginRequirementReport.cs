...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MarginRequirementReport : IFixMessage
	{
		...
		public MarginAmountComponent? MarginAmount {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& MarginReqmtRptID is not null
				&& MarginReqmtRptType is not null
				&& MarginAmount is not null && ((IFixValidator)MarginAmount).IsValid(in config)
