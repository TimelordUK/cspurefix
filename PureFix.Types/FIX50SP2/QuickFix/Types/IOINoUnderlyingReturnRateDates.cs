...
{
	public sealed partial class IOINoUnderlyingReturnRateDates : IFixGroup
	{
		[TagDetails(Tag = 43009, Type = TagType.Int, Offset = 0, Required = false)]
		public int? UnderlyingReturnRateDateMode {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public UnderlyingReturnRateValuationDateGrpComponent? UnderlyingReturnRateValuationDateGrp {get; set;}
		...
		public UnderlyingReturnRateValuationDateBusinessCenterGrpComponent? UnderlyingReturnRateValuationDateBusinessCenterGrp {get; set;}
