...
{
	public sealed partial class PreAllocGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 78, Offset = 0, Required = false)]
		public NewOrderSinglePreAllocGrpNoAllocs[]? NoAllocs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoAllocs") is IMessageView viewNoAllocs)
			{
				...
				NoAllocs = new NewOrderSinglePreAllocGrpNoAllocs[count];
