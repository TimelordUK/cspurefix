...
{
	public sealed partial class ProvisionCashSettlQuoteSourceComponent : IFixComponent
	{
		[TagDetails(Tag = 40112, Type = TagType.Int, Offset = 0, Required = false)]
		public int? ProvisionCashSettlQuoteSource {get; set;}
		...
		{
			if (ProvisionCashSettlQuoteSource is not null) writer.WriteWholeNumber(40112, ProvisionCashSettlQuoteSource.Value);
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			ProvisionCashSettlQuoteSource = view.GetInt32(40112);
		...
		{
			ProvisionCashSettlQuoteSource = null;
