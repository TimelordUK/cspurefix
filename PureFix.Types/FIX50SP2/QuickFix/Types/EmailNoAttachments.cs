...
{
	public sealed partial class EmailNoAttachments : IFixGroup
	{
		...
		[TagDetails(Tag = 2111, Type = TagType.Length, Offset = 6, Required = false, LinksToTag = 2112)]
		public int? EncodedAttachmentLen {get; set;}
		
		[TagDetails(Tag = 2112, Type = TagType.RawData, Offset = 7, Required = false, LinksToTag = 2111)]
		public byte[]? EncodedAttachment {get; set;}
		
		[Component(Offset = 8, Required = false)]
		public AttachmentKeywordGrpComponent? AttachmentKeywordGrp {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedAttachment is not null)
			{
				writer.WriteWholeNumber(2111, EncodedAttachment.Length);
				writer.WriteBuffer(2112, EncodedAttachment);
			}
