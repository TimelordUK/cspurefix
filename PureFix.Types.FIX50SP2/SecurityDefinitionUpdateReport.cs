...
{
	[MessageType("BP", FixVersion.FIX50SP2)]
	public sealed partial class SecurityDefinitionUpdateReport : IFixMessage
	{
		...
		[TagDetails(Tag = 323, Type = TagType.Int, Offset = 5, Required = false)]
		public int? SecurityResponseType {get; set;}
		
		[TagDetails(Tag = 715, Type = TagType.LocalDate, Offset = 6, Required = false)]
		public DateOnly? ClearingBusinessDate {get; set;}
		
		[TagDetails(Tag = 980, Type = TagType.String, Offset = 7, Required = false)]
		public string? SecurityUpdateAction {get; set;}
		
		[TagDetails(Tag = 292, Type = TagType.String, Offset = 8, Required = false)]
		...
		[TagDetails(Tag = 2572, Type = TagType.Float, Offset = 16, Required = false)]
		public double? PreviousAdjustedOpenInterest {get; set;}
		
		[TagDetails(Tag = 2573, Type = TagType.Float, Offset = 17, Required = false)]
		...
		[TagDetails(Tag = 1606, Type = TagType.Int, Offset = 23, Required = false)]
		public int? NumOfSimpleInstruments {get; set;}
		
		[TagDetails(Tag = 2562, Type = TagType.Int, Offset = 24, Required = false)]
		...
		[TagDetails(Tag = 779, Type = TagType.UtcTimestamp, Offset = 29, Required = false)]
		public DateTime? LastUpdateTime {get; set;}
		
		[TagDetails(Tag = 2400, Type = TagType.LocalDate, Offset = 30, Required = false)]
		public DateOnly? EffectiveBusinessDate {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 31, Required = false)]
