...
{
	[MessageType("NewOrderList", FixVersion.FIX50SP2)]
	public sealed partial class NewOrderList : IFixMessage
	{
		...
		[TagDetails(Tag = 352, Type = TagType.Length, Offset = 13, Required = false, LinksToTag = 353)]
		public int? EncodedListExecInstLen {get; set;}
		
		[TagDetails(Tag = 353, Type = TagType.RawData, Offset = 14, Required = false, LinksToTag = 352)]
		...
		[TagDetails(Tag = 68, Type = TagType.Int, Offset = 18, Required = true)]
		public int? TotNoOrders {get; set;}
		
		[TagDetails(Tag = 893, Type = TagType.Boolean, Offset = 19, Required = false)]
		public bool? LastFragment {get; set;}
		
		[Group(NoOfTag = 1031, Offset = 20, Required = false)]
		public NewOrderListRootParties[]? RootParties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("RootParties") is IMessageView viewRootParties)
			{
				...
				RootParties = new NewOrderListRootParties[count];
