...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class UnderlyingStreamCalculationPeriodBusinessCenterGrpComponent : IFixComponent
	{
		...
		public IOINoUnderlyingStreamCalculationPeriodBusinessCenters[]? NoUnderlyingStreamCalculationPeriodBusinessCenters {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoUnderlyingStreamCalculationPeriodBusinessCenters") is IMessageView viewNoUnderlyingStreamCalculationPeriodBusinessCenters)
			{
				...
				NoUnderlyingStreamCalculationPeriodBusinessCenters = new IOINoUnderlyingStreamCalculationPeriodBusinessCenters[count];
		...
		{
			NoUnderlyingStreamCalculationPeriodBusinessCenters = null;
		}
	}
}
