...
{
	public sealed partial class IOINoUnderlyingProvisions : IFixGroup
	{
		...
		public UnderlyingProvisionDateBusinessCenterGrpComponent? UnderlyingProvisionDateBusinessCenterGrp {get; set;}
		...
		public UnderlyingProvisionCashSettlValueDatesComponent? UnderlyingProvisionCashSettlValueDates {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public UnderlyingProvisionOptionExerciseDatesComponent? UnderlyingProvisionOptionExerciseDates {get; set;}
		
		[Component(Offset = 14, Required = false)]
		public UnderlyingProvisionOptionExpirationDateComponent? UnderlyingProvisionOptionExpirationDate {get; set;}
		
		[Component(Offset = 15, Required = false)]
		public UnderlyingProvisionOptionRelevantUnderlyingDateComponent? UnderlyingProvisionOptionRelevantUnderlyingDate {get; set;}
		...
		public UnderlyingProvisionCashSettlPaymentDatesComponent? UnderlyingProvisionCashSettlPaymentDates {get; set;}
		...
		public UnderlyingProvisionCashSettlQuoteSourceComponent? UnderlyingProvisionCashSettlQuoteSource {get; set;}
		
		[TagDetails(Tag = 42170, Type = TagType.String, Offset = 29, Required = false)]
		public string? UnderlyingProvisionText {get; set;}
		
		[TagDetails(Tag = 42171, Type = TagType.Length, Offset = 30, Required = false, LinksToTag = 42172)]
		public int? EncodedUnderlyingProvisionTextLen {get; set;}
		
		[TagDetails(Tag = 42172, Type = TagType.RawData, Offset = 31, Required = false, LinksToTag = 42171)]
		public byte[]? EncodedUnderlyingProvisionText {get; set;}
		
		[Component(Offset = 32, Required = false)]
		public UnderlyingProvisionPartiesComponent? UnderlyingProvisionParties {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedUnderlyingProvisionText is not null)
			{
				writer.WriteWholeNumber(42171, EncodedUnderlyingProvisionText.Length);
				writer.WriteBuffer(42172, EncodedUnderlyingProvisionText);
			}
