...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class CollateralResponse : IFixMessage
	{
		...
		[TagDetails(Tag = 2522, Type = TagType.Length, Offset = 57, Required = false, LinksToTag = 2521)]
		public int? EncodedWarningTextLen {get; set;}
		
		[TagDetails(Tag = 2521, Type = TagType.RawData, Offset = 58, Required = false, LinksToTag = 2522)]
		public byte[]? EncodedWarningText {get; set;}
		
		[TagDetails(Tag = 1328, Type = TagType.String, Offset = 59, Required = false)]
		public string? RejectText {get; set;}
		
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 60, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 61, Required = false, LinksToTag = 1664)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedWarningText is not null)
			{
				writer.WriteWholeNumber(2522, EncodedWarningText.Length);
				writer.WriteBuffer(2521, EncodedWarningText);
			}
