...
{
	[MessageType("SecurityDefinitionRequest", FixVersion.FIX50SP2)]
	public sealed partial class SecurityDefinitionRequest : IFixMessage
	{
		...
		public SecurityDefinitionRequestStipulations[]? Stipulations {get; set;}
		...
		[TagDetails(Tag = 827, Type = TagType.Int, Offset = 18, Required = false)]
		public int? ExpirationCycle {get; set;}
		
		[TagDetails(Tag = 263, Type = TagType.String, Offset = 19, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new SecurityDefinitionRequestStipulations[count];
