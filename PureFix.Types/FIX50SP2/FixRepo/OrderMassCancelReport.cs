...
{
	[MessageType("OrderMassCancelReport", FixVersion.FIX50SP2)]
	public sealed partial class OrderMassCancelReport : IFixMessage
	{
		...
		public OrderMassCancelReportParties[]? Parties {get; set;}
		...
		[TagDetails(Tag = 1301, Type = TagType.String, Offset = 15, Required = false)]
		...
		[Group(NoOfTag = 1063, Offset = 23, Required = false)]
		public OrderMassCancelReportTargetParties[]? TargetParties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new OrderMassCancelReportParties[count];
			...
			if (view.GetView("TargetParties") is IMessageView viewTargetParties)
			{
				...
				TargetParties = new OrderMassCancelReportTargetParties[count];
				for (int i = 0; i < count; i++)
				{
					TargetParties[i] = new();
