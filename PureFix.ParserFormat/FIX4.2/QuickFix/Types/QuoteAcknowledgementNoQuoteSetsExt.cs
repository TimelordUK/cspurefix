...
{
	public static class QuoteAcknowledgementNoQuoteSetsExt
	{
		public static void Parse(this QuoteAcknowledgementNoQuoteSets instance, MsgView? view)
		{
			...
			instance.NoQuoteEntries = new QuoteAcknowledgementNoQuoteSetsNoQuoteEntries[countNoQuoteEntries];
