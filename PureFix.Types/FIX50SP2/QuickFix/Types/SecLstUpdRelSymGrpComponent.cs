...
{
	public sealed partial class SecLstUpdRelSymGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 146, Offset = 0, Required = false)]
		public SecurityListUpdateReportNoRelatedSym[]? NoRelatedSym {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoRelatedSym") is IMessageView viewNoRelatedSym)
			{
				...
				NoRelatedSym = new SecurityListUpdateReportNoRelatedSym[count];
