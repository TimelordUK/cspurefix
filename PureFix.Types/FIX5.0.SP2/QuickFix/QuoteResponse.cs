...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class QuoteResponse : IFixMessage
	{
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 76, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 77, Required = false, LinksToTag = 2372)]
