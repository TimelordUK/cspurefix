...
{
	public sealed partial class QuotEntryAckGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 295, Offset = 0, Required = false)]
		public MassQuoteAcknowledgementQuotSetAckGrpNoQuoteSetsQuotEntryAckGrpNoQuoteEntries[]? NoQuoteEntries {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoQuoteEntries") is IMessageView viewNoQuoteEntries)
			{
				...
				NoQuoteEntries = new MassQuoteAcknowledgementQuotSetAckGrpNoQuoteSetsQuotEntryAckGrpNoQuoteEntries[count];
