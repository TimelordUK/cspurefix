...
namespace PureFix.Types.FIX43.QuickFix
{
	...
	public static class MultilegOrderCancelReplaceRequestExt
	{
		public static void Parse(this MultilegOrderCancelReplaceRequest instance, MsgView? view)
		{
			...
			instance.NoAllocs = new MultilegOrderCancelReplaceRequestNoAllocs[countNoAllocs];
			...
			instance.NoTradingSessions = new MultilegOrderCancelReplaceRequestNoTradingSessions[countNoTradingSessions];
			...
			instance.NoLegs = new MultilegOrderCancelReplaceRequestNoLegs[countNoLegs];
