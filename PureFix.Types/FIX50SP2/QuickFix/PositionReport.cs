...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class PositionReport : IFixMessage
	{
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 35, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 36, Required = false, LinksToTag = 2372)]
		...
		public PosUndInstrmtGrpComponent? PosUndInstrmtGrp {get; set;}
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 78, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 79, Required = false, LinksToTag = 354)]
