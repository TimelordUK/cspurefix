...
{
	public sealed partial class UnderlyingStreamCommodityComponent : IFixComponent
	{
		...
		public UnderlyingStreamCommodityAltIDGrpComponent? UnderlyingStreamCommodityAltIDGrp {get; set;}
		
		[TagDetails(Tag = 41968, Type = TagType.String, Offset = 5, Required = false)]
		public string? UnderlyingStreamCommodityDesc {get; set;}
		
		[TagDetails(Tag = 41969, Type = TagType.Length, Offset = 6, Required = false, LinksToTag = 41970)]
		public int? EncodedUnderlyingStreamCommodityDescLen {get; set;}
		
		[TagDetails(Tag = 41970, Type = TagType.RawData, Offset = 7, Required = false, LinksToTag = 41969)]
		...
		public UnderlyingStreamAssetAttributeGrpComponent? UnderlyingStreamAssetAttributeGrp {get; set;}
		...
		public UnderlyingStreamCommodityDataSourceGrpComponent? UnderlyingStreamCommodityDataSourceGrp {get; set;}
		...
		public UnderlyingStreamCommoditySettlBusinessCenterGrpComponent? UnderlyingStreamCommoditySettlBusinessCenterGrp {get; set;}
		...
		public UnderlyingStreamCommoditySettlPeriodGrpComponent? UnderlyingStreamCommoditySettlPeriodGrp {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedUnderlyingStreamCommodityDesc is not null)
			{
				writer.WriteWholeNumber(41969, EncodedUnderlyingStreamCommodityDesc.Length);
				writer.WriteBuffer(41970, EncodedUnderlyingStreamCommodityDesc);
			}
