...
{
	public sealed partial class IOINoProtectionTermEvents : IFixGroup
	{
		...
		public ProtectionTermEventQualifierGrpComponent? ProtectionTermEventQualifierGrp {get; set;}
