...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class Confirmation : IFixMessage
	{
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 25, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 26, Required = false, LinksToTag = 2372)]
		...
		public MatchExceptionGrpComponent? MatchExceptionGrp {get; set;}
		
		[Component(Offset = 85, Required = false)]
		public MatchingDataPointGrpComponent? MatchingDataPointGrp {get; set;}
