...
{
	[MessageType("OrderMassCancelRequest", FixVersion.FIX50SP2)]
	public sealed partial class OrderMassCancelRequest : IFixMessage
	{
		...
		public OrderMassCancelRequestParties[]? Parties {get; set;}
		...
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 12, Required = true)]
		...
		[Group(NoOfTag = 1063, Offset = 17, Required = false)]
		public OrderMassCancelRequestTargetParties[]? TargetParties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new OrderMassCancelRequestParties[count];
			...
			if (view.GetView("TargetParties") is IMessageView viewTargetParties)
			{
				...
				TargetParties = new OrderMassCancelRequestTargetParties[count];
				for (int i = 0; i < count; i++)
				{
					TargetParties[i] = new();
