...
{
	[MessageType("RegistrationInstructions", FixVersion.FIX50SP2)]
	public sealed partial class RegistrationInstructions : IFixMessage
	{
		...
		public RegistrationInstructionsParties[]? Parties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new RegistrationInstructionsParties[count];
