...
{
	public sealed partial class IOINoStreams : IFixGroup
	{
		...
		public StreamCommodityComponent? StreamCommodity {get; set;}
		
		[Component(Offset = 19, Required = false)]
		public StreamEffectiveDateComponent? StreamEffectiveDate {get; set;}
		
		[Component(Offset = 20, Required = false)]
		public StreamTerminationDateComponent? StreamTerminationDate {get; set;}
		
		[Component(Offset = 21, Required = false)]
		public StreamCalculationPeriodDatesComponent? StreamCalculationPeriodDates {get; set;}
		
		[Component(Offset = 22, Required = false)]
		public PaymentStreamComponent? PaymentStream {get; set;}
		
		[Component(Offset = 23, Required = false)]
		public PaymentScheduleGrpComponent? PaymentScheduleGrp {get; set;}
		
		[Component(Offset = 24, Required = false)]
		public PaymentStubGrpComponent? PaymentStubGrp {get; set;}
		
		[Component(Offset = 25, Required = false)]
		public DeliveryStreamComponent? DeliveryStream {get; set;}
		
		[Component(Offset = 26, Required = false)]
		public DeliveryScheduleGrpComponent? DeliveryScheduleGrp {get; set;}
		
		[TagDetails(Tag = 40056, Type = TagType.String, Offset = 27, Required = false)]
		public string? StreamText {get; set;}
		
		[TagDetails(Tag = 40982, Type = TagType.Length, Offset = 28, Required = false, LinksToTag = 40983)]
		public int? EncodedStreamTextLen {get; set;}
		
		[TagDetails(Tag = 40983, Type = TagType.RawData, Offset = 29, Required = false, LinksToTag = 40982)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedStreamText is not null)
			{
				writer.WriteWholeNumber(40982, EncodedStreamText.Length);
				writer.WriteBuffer(40983, EncodedStreamText);
			}
		}
