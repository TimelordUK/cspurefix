...
{
	public sealed partial class TradeCaptureReportNoSideCollateralAmounts : IFixGroup
	{
		...
		public SideCollateralReinvestmentGrpComponent? SideCollateralReinvestmentGrp {get; set;}
