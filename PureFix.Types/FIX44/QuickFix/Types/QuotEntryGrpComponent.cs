...
{
	public sealed partial class QuotEntryGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 295, Offset = 0, Required = true)]
		public MassQuoteQuotSetGrpNoQuoteSetsQuotEntryGrpNoQuoteEntries[]? NoQuoteEntries {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoQuoteEntries") is IMessageView viewNoQuoteEntries)
			{
				...
				NoQuoteEntries = new MassQuoteQuotSetGrpNoQuoteSetsQuotEntryGrpNoQuoteEntries[count];
