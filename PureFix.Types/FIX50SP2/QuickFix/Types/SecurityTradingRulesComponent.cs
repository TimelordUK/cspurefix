...
{
	public sealed partial class SecurityTradingRulesComponent : IFixComponent
	{
		[Component(Offset = 0, Required = false)]
		public BaseTradingRulesComponent? BaseTradingRules {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public TradingSessionRulesGrpComponent? TradingSessionRulesGrp {get; set;}
		
		[Component(Offset = 2, Required = false)]
		public NestedInstrumentAttributeComponent? NestedInstrumentAttribute {get; set;}
