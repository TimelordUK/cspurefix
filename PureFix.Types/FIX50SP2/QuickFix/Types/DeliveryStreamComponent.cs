...
{
	public sealed partial class DeliveryStreamComponent : IFixComponent
	{
		[TagDetails(Tag = 41058, Type = TagType.Int, Offset = 0, Required = false)]
		public int? DeliveryStreamType {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public DeliveryStreamCommoditySourceGrpComponent? DeliveryStreamCommoditySourceGrp {get; set;}
		...
		public DeliveryStreamCycleGrpComponent? DeliveryStreamCycleGrp {get; set;}
