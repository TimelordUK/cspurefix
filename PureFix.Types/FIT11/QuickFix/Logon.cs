...
namespace PureFix.Types.FIXT11.QuickFix
{
	[MessageType("A", FixVersion.FIXT11)]
	public sealed partial class Logon : IFixMessage
	{
		...
		public MsgTypeGrpComponent? MsgTypeGrp {get; set;}
		...
		[TagDetails(Tag = 1401, Type = TagType.Length, Offset = 14, Required = false, LinksToTag = 1402)]
		public int? EncryptedPasswordLen {get; set;}
		
		[TagDetails(Tag = 1402, Type = TagType.RawData, Offset = 15, Required = false, LinksToTag = 1401)]
		public byte[]? EncryptedPassword {get; set;}
		
		[TagDetails(Tag = 1403, Type = TagType.Length, Offset = 16, Required = false, LinksToTag = 1404)]
		public int? EncryptedNewPasswordLen {get; set;}
		
		[TagDetails(Tag = 1404, Type = TagType.RawData, Offset = 17, Required = false, LinksToTag = 1403)]
		public byte[]? EncryptedNewPassword {get; set;}
		
		[TagDetails(Tag = 1409, Type = TagType.Int, Offset = 18, Required = false)]
		public int? SessionStatus {get; set;}
		
		[TagDetails(Tag = 1137, Type = TagType.String, Offset = 19, Required = true)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (MsgTypeGrp is not null) ((IFixEncoder)MsgTypeGrp).Encode(writer);
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("MsgTypeGrp") is IMessageView viewMsgTypeGrp)
			{
				MsgTypeGrp = new();
				((IFixParser)MsgTypeGrp).Parse(viewMsgTypeGrp);
			}
