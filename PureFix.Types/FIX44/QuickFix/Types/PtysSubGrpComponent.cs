...
namespace PureFix.Types.FIX44.QuickFix.Types
{
	public sealed partial class PtysSubGrpComponent : IFixComponent
	{
		...
		public ExecutionReportPartiesNoPartyIDsPtysSubGrpNoPartySubIDs[]? NoPartySubIDs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoPartySubIDs") is IMessageView viewNoPartySubIDs)
			{
				...
				NoPartySubIDs = new ExecutionReportPartiesNoPartyIDsPtysSubGrpNoPartySubIDs[count];
