...
{
	public sealed partial class PaymentStubStartDateComponent : IFixComponent
	{
		...
		public PaymentStubStartDateBusinessCenterGrpComponent? PaymentStubStartDateBusinessCenterGrp {get; set;}
