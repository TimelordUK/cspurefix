...
namespace PureFix.Types.FIX42
{
	...
	public sealed partial class OrderCancelRequest : IFixMessage
	{
		...
		[TagDetails(Tag = 348, Type = TagType.Length, Offset = 22, Required = false)]
		public int? EncodedIssuerLen {get; set;}
		
		[TagDetails(Tag = 349, Type = TagType.RawData, Offset = 23, Required = false)]
		public byte[]? EncodedIssuer {get; set;}
		
		[TagDetails(Tag = 107, Type = TagType.String, Offset = 24, Required = false)]
		public string? SecurityDesc {get; set;}
		
		[TagDetails(Tag = 350, Type = TagType.Length, Offset = 25, Required = false)]
		public int? EncodedSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 351, Type = TagType.RawData, Offset = 26, Required = false)]
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 34, Required = false)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 35, Required = false)]
