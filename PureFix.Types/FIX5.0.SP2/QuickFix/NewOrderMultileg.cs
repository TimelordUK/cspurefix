...
{
	[MessageType("AB", FixVersion.FIX50SP2)]
	public sealed partial class NewOrderMultileg : IFixMessage
	{
		...
		[TagDetails(Tag = 70, Type = TagType.String, Offset = 15, Required = false)]
		...
		[TagDetails(Tag = 1805, Type = TagType.Int, Offset = 23, Required = false)]
		public int? AuctionInstruction {get; set;}
		
		[TagDetails(Tag = 110, Type = TagType.Float, Offset = 24, Required = false)]
		public double? MinQty {get; set;}
		
		[TagDetails(Tag = 1822, Type = TagType.Int, Offset = 25, Required = false)]
		public int? MinQtyMethod {get; set;}
		
		[TagDetails(Tag = 1089, Type = TagType.Float, Offset = 26, Required = false)]
		public double? MatchIncrement {get; set;}
		
		[TagDetails(Tag = 1090, Type = TagType.Int, Offset = 27, Required = false)]
		public int? MaxPriceLevels {get; set;}
		
		[TagDetails(Tag = 2676, Type = TagType.Float, Offset = 28, Required = false)]
		...
		[TagDetails(Tag = 2362, Type = TagType.String, Offset = 31, Required = false)]
		public string? SelfMatchPreventionID {get; set;}
		
		[TagDetails(Tag = 2964, Type = TagType.Int, Offset = 32, Required = false)]
		...
		[TagDetails(Tag = 111, Type = TagType.Float, Offset = 35, Required = false)]
		public double? MaxFloor {get; set;}
		
		[TagDetails(Tag = 1300, Type = TagType.String, Offset = 36, Required = false)]
		public string? MarketSegmentID {get; set;}
		
		[TagDetails(Tag = 100, Type = TagType.String, Offset = 37, Required = false)]
		public string? ExDestination {get; set;}
		
		[TagDetails(Tag = 1133, Type = TagType.String, Offset = 38, Required = false)]
		public string? ExDestinationIDSource {get; set;}
		
		[TagDetails(Tag = 2704, Type = TagType.Int, Offset = 39, Required = false)]
		...
		[TagDetails(Tag = 54, Type = TagType.String, Offset = 42, Required = true)]
		public string? Side {get; set;}
		
		[TagDetails(Tag = 2102, Type = TagType.Boolean, Offset = 43, Required = false)]
		...
		[TagDetails(Tag = 1069, Type = TagType.Float, Offset = 47, Required = false)]
		public double? SwapPoints {get; set;}
		
		[Component(Offset = 48, Required = false)]
		public LegOrdGrpComponent? LegOrdGrp {get; set;}
		
		[TagDetails(Tag = 114, Type = TagType.Boolean, Offset = 49, Required = false)]
		public bool? LocateReqd {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 50, Required = true)]
		...
		[TagDetails(Tag = 40, Type = TagType.String, Offset = 53, Required = true)]
		public string? OrdType {get; set;}
		
		[TagDetails(Tag = 1377, Type = TagType.Int, Offset = 54, Required = false)]
		public int? MultilegModel {get; set;}
		
		[TagDetails(Tag = 1378, Type = TagType.Int, Offset = 55, Required = false)]
		...
		[TagDetails(Tag = 1092, Type = TagType.String, Offset = 58, Required = false)]
		public string? PriceProtectionScope {get; set;}
		
		[TagDetails(Tag = 99, Type = TagType.Float, Offset = 59, Required = false)]
		public double? StopPx {get; set;}
		
		[Component(Offset = 60, Required = false)]
		public TriggeringInstructionComponent? TriggeringInstruction {get; set;}
		
		[TagDetails(Tag = 15, Type = TagType.String, Offset = 61, Required = false)]
		public string? Currency {get; set;}
		
		[TagDetails(Tag = 2897, Type = TagType.String, Offset = 62, Required = false)]
		public string? CurrencyCodeSource {get; set;}
		
		[TagDetails(Tag = 1740, Type = TagType.Int, Offset = 63, Required = false)]
		public int? TradePriceNegotiationMethod {get; set;}
		
		[TagDetails(Tag = 1741, Type = TagType.Int, Offset = 64, Required = false)]
		public int? UpfrontPriceType {get; set;}
		
		[TagDetails(Tag = 1742, Type = TagType.Float, Offset = 65, Required = false)]
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 68, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 69, Required = false, LinksToTag = 2351)]
		...
		[TagDetails(Tag = 1080, Type = TagType.String, Offset = 73, Required = false)]
		public string? RefOrderID {get; set;}
		
		[TagDetails(Tag = 1081, Type = TagType.String, Offset = 74, Required = false)]
		public string? RefOrderIDSource {get; set;}
		
		[TagDetails(Tag = 1806, Type = TagType.String, Offset = 75, Required = false)]
		public string? RefClOrdID {get; set;}
		
		[TagDetails(Tag = 59, Type = TagType.String, Offset = 76, Required = false)]
		public string? TimeInForce {get; set;}
		
		[TagDetails(Tag = 168, Type = TagType.UtcTimestamp, Offset = 77, Required = false)]
		public DateTime? EffectiveTime {get; set;}
		
		[TagDetails(Tag = 432, Type = TagType.LocalDate, Offset = 78, Required = false)]
		public DateOnly? ExpireDate {get; set;}
		
		[TagDetails(Tag = 126, Type = TagType.UtcTimestamp, Offset = 79, Required = false)]
		public DateTime? ExpireTime {get; set;}
		
		[TagDetails(Tag = 427, Type = TagType.Int, Offset = 80, Required = false)]
		public int? GTBookingInst {get; set;}
		
		[TagDetails(Tag = 1629, Type = TagType.Int, Offset = 81, Required = false)]
		public int? ExposureDuration {get; set;}
		
		[TagDetails(Tag = 1916, Type = TagType.Int, Offset = 82, Required = false)]
		...
		[TagDetails(Tag = 528, Type = TagType.String, Offset = 85, Required = false)]
		public string? OrderCapacity {get; set;}
		
		[TagDetails(Tag = 529, Type = TagType.String, Offset = 86, Required = false)]
		public string? OrderRestrictions {get; set;}
		
		[TagDetails(Tag = 1815, Type = TagType.Int, Offset = 87, Required = false)]
		public int? TradingCapacity {get; set;}
		
		[TagDetails(Tag = 1091, Type = TagType.Boolean, Offset = 88, Required = false)]
		public bool? PreTradeAnonymity {get; set;}
		
		[TagDetails(Tag = 1390, Type = TagType.Int, Offset = 89, Required = false)]
		public int? TradePublishIndicator {get; set;}
		
		[TagDetails(Tag = 582, Type = TagType.Int, Offset = 90, Required = false)]
		public int? CustOrderCapacity {get; set;}
		
		[TagDetails(Tag = 1724, Type = TagType.Int, Offset = 91, Required = false)]
		...
		[TagDetails(Tag = 121, Type = TagType.Boolean, Offset = 93, Required = false)]
		public bool? ForexReq {get; set;}
		
		[TagDetails(Tag = 120, Type = TagType.String, Offset = 94, Required = false)]
		public string? SettlCurrency {get; set;}
		
		[TagDetails(Tag = 2899, Type = TagType.String, Offset = 95, Required = false)]
		public string? SettlCurrencyCodeSource {get; set;}
		
		[TagDetails(Tag = 775, Type = TagType.Int, Offset = 96, Required = false)]
		public int? BookingType {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 97, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 98, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 99, Required = false, LinksToTag = 354)]
		public byte[]? EncodedText {get; set;}
		
		[TagDetails(Tag = 1816, Type = TagType.Int, Offset = 100, Required = false)]
		public int? ClearingAccountType {get; set;}
		
		[TagDetails(Tag = 77, Type = TagType.String, Offset = 101, Required = false)]
		public string? PositionEffect {get; set;}
		
		[TagDetails(Tag = 203, Type = TagType.Int, Offset = 102, Required = false)]
		public int? CoveredOrUncovered {get; set;}
		
		[TagDetails(Tag = 210, Type = TagType.Float, Offset = 103, Required = false)]
		...
		[TagDetails(Tag = 847, Type = TagType.Int, Offset = 106, Required = false)]
		...
		[TagDetails(Tag = 848, Type = TagType.String, Offset = 108, Required = false)]
		public string? TargetStrategyParameters {get; set;}
		
		[TagDetails(Tag = 1190, Type = TagType.Float, Offset = 109, Required = false)]
		public double? RiskFreeRate {get; set;}
		
		[TagDetails(Tag = 849, Type = TagType.Float, Offset = 110, Required = false)]
		...
		[TagDetails(Tag = 563, Type = TagType.Int, Offset = 115, Required = false)]
		public int? MultiLegRptTypeReq {get; set;}
		
		[TagDetails(Tag = 1685, Type = TagType.Int, Offset = 116, Required = false)]
		public int? ThrottleInst {get; set;}
		
		[TagDetails(Tag = 1803, Type = TagType.Int, Offset = 117, Required = false)]
		public int? AuctionType {get; set;}
		
		[TagDetails(Tag = 1804, Type = TagType.Float, Offset = 118, Required = false)]
		public double? AuctionAllocationPct {get; set;}
		
		[TagDetails(Tag = 1819, Type = TagType.Float, Offset = 119, Required = false)]
		public double? RelatedHighPrice {get; set;}
		
		[TagDetails(Tag = 1820, Type = TagType.Float, Offset = 120, Required = false)]
		public double? RelatedLowPrice {get; set;}
		
		[TagDetails(Tag = 1821, Type = TagType.Int, Offset = 121, Required = false)]
		public int? RelatedPriceSource {get; set;}
		
		[Component(Offset = 122, Required = true)]
