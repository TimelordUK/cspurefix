...
{
	public sealed partial class TradeMatchReportNoTrdMatchSides : IFixGroup
	{
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 24, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 25, Required = false, LinksToTag = 2351)]
		...
		public TrdInstrmtLegExecGrpComponent? TrdInstrmtLegExecGrp {get; set;}
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 50, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 51, Required = false, LinksToTag = 354)]
