...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class UnderlyingProvisionOptionExpirationDateBusinessCenterGrpComponent : IFixComponent
	{
		...
		public IOINoUnderlyingProvisionOptionExpirationDateBusinessCenters[]? NoUnderlyingProvisionOptionExpirationDateBusinessCenters {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoUnderlyingProvisionOptionExpirationDateBusinessCenters") is IMessageView viewNoUnderlyingProvisionOptionExpirationDateBusinessCenters)
			{
				...
				NoUnderlyingProvisionOptionExpirationDateBusinessCenters = new IOINoUnderlyingProvisionOptionExpirationDateBusinessCenters[count];
