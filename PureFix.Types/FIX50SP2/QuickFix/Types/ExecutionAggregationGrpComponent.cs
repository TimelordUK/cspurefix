...
{
	public sealed partial class ExecutionAggregationGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 124, Offset = 0, Required = false)]
		public TradeAggregationRequestNoExecs[]? NoExecs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoExecs") is IMessageView viewNoExecs)
			{
				...
				NoExecs = new TradeAggregationRequestNoExecs[count];
