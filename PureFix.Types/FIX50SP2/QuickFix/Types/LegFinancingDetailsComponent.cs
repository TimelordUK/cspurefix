...
{
	public sealed partial class LegFinancingDetailsComponent : IFixComponent
	{
		...
		public LegFinancingContractualDefinitionsGrpComponent? LegFinancingContractualDefinitionsGrp {get; set;}
		
		[Component(Offset = 12, Required = false)]
		public LegFinancingTermSupplementGrpComponent? LegFinancingTermSupplementGrp {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public LegFinancingContractualMatrixGrpComponent? LegFinancingContractualMatrixGrp {get; set;}
		...
		[TagDetails(Tag = 2494, Type = TagType.Length, Offset = 19, Required = false, LinksToTag = 2493)]
		public int? EncodedLegDocumentationTextLen {get; set;}
		
		[TagDetails(Tag = 2493, Type = TagType.RawData, Offset = 20, Required = false, LinksToTag = 2494)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedLegDocumentationText is not null)
			{
				writer.WriteWholeNumber(2494, EncodedLegDocumentationText.Length);
				writer.WriteBuffer(2493, EncodedLegDocumentationText);
			}
