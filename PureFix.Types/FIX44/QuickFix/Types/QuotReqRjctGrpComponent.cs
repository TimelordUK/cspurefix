...
{
	public sealed partial class QuotReqRjctGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 146, Offset = 0, Required = true)]
		public QuoteRequestRejectQuotReqRjctGrpNoRelatedSym[]? NoRelatedSym {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoRelatedSym") is IMessageView viewNoRelatedSym)
			{
				...
				NoRelatedSym = new QuoteRequestRejectQuotReqRjctGrpNoRelatedSym[count];
