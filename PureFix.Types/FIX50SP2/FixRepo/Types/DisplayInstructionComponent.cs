...
{
	public sealed partial class DisplayInstructionComponent : IFixComponent
	{
		...
		[TagDetails(Tag = 1083, Type = TagType.String, Offset = 2, Required = false)]
		public string? DisplayWhen {get; set;}
		
		[TagDetails(Tag = 1084, Type = TagType.String, Offset = 3, Required = false)]
		public string? DisplayMethod {get; set;}
		
		[TagDetails(Tag = 1085, Type = TagType.Float, Offset = 4, Required = false)]
		public double? DisplayLowQty {get; set;}
		
		[TagDetails(Tag = 1086, Type = TagType.Float, Offset = 5, Required = false)]
		public double? DisplayHighQty {get; set;}
		
		[TagDetails(Tag = 1087, Type = TagType.Float, Offset = 6, Required = false)]
		public double? DisplayMinIncr {get; set;}
		
		[TagDetails(Tag = 1088, Type = TagType.Float, Offset = 7, Required = false)]
