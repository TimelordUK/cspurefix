...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class SecurityListUpdateReport : IFixMessage
	{
		...
		[TagDetails(Tag = 1468, Type = TagType.Length, Offset = 6, Required = false, LinksToTag = 1469)]
		public int? EncodedSecurityListDescLen {get; set;}
		
		[TagDetails(Tag = 1469, Type = TagType.RawData, Offset = 7, Required = false, LinksToTag = 1468)]
		...
		public SecLstUpdRelSymGrpComponent? SecLstUpdRelSymGrp {get; set;}
