...
{
	public sealed partial class IOINoProvisions : IFixGroup
	{
		...
		public ProvisionDateBusinessCenterGrpComponent? ProvisionDateBusinessCenterGrp {get; set;}
		...
		public ProvisionCashSettlValueDatesComponent? ProvisionCashSettlValueDates {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public ProvisionOptionExerciseDatesComponent? ProvisionOptionExerciseDates {get; set;}
		
		[Component(Offset = 14, Required = false)]
		public ProvisionOptionExpirationDateComponent? ProvisionOptionExpirationDate {get; set;}
		
		[Component(Offset = 15, Required = false)]
		public ProvisionOptionRelevantUnderlyingDateComponent? ProvisionOptionRelevantUnderlyingDate {get; set;}
		...
		public ProvisionCashSettlPaymentDatesComponent? ProvisionCashSettlPaymentDates {get; set;}
		...
		public ProvisionCashSettlQuoteSourceComponent? ProvisionCashSettlQuoteSource {get; set;}
		
		[TagDetails(Tag = 40113, Type = TagType.String, Offset = 29, Required = false)]
		public string? ProvisionText {get; set;}
		
		[TagDetails(Tag = 40986, Type = TagType.Length, Offset = 30, Required = false, LinksToTag = 40987)]
		public int? EncodedProvisionTextLen {get; set;}
		
		[TagDetails(Tag = 40987, Type = TagType.RawData, Offset = 31, Required = false, LinksToTag = 40986)]
		public byte[]? EncodedProvisionText {get; set;}
		
		[Component(Offset = 32, Required = false)]
		public ProvisionPartiesComponent? ProvisionParties {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedProvisionText is not null)
			{
				writer.WriteWholeNumber(40986, EncodedProvisionText.Length);
				writer.WriteBuffer(40987, EncodedProvisionText);
			}
