...
{
	public sealed partial class MassQuoteAcknowledgementNoQuoteSets : IFixValidator, IFixEncoder
	{
		...
		public MassQuoteAcknowledgementNoQuoteSetsNoQuoteEntries[]? NoQuoteEntries { get; set; }
