...
{
	[MessageType("SecurityDefinitionUpdateReport", FixVersion.FIX50SP2)]
	public sealed partial class SecurityDefinitionUpdateReport : IFixMessage
	{
		...
		[Group(NoOfTag = 1019, Offset = 16, Required = false)]
		public SecurityDefinitionUpdateReportStipulations[]? Stipulations {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new SecurityDefinitionUpdateReportStipulations[count];
