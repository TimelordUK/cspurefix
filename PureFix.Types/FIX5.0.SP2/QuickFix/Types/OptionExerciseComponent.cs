...
{
	public sealed partial class OptionExerciseComponent : IFixComponent
	{
		[TagDetails(Tag = 41106, Type = TagType.String, Offset = 0, Required = false)]
		public string? ExerciseDesc {get; set;}
		
		[TagDetails(Tag = 41107, Type = TagType.Length, Offset = 1, Required = false, LinksToTag = 41108)]
		public int? EncodedExerciseDescLen {get; set;}
		
		[TagDetails(Tag = 41108, Type = TagType.RawData, Offset = 2, Required = false, LinksToTag = 41107)]
		...
		public SettlMethodElectionDateComponent? SettlMethodElectionDate {get; set;}
		
		[Component(Offset = 12, Required = false)]
		public OptionExerciseDatesComponent? OptionExerciseDates {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public OptionExerciseExpirationComponent? OptionExerciseExpiration {get; set;}
		
		[Component(Offset = 14, Required = false)]
		public OptionExerciseMakeWholeProvisionComponent? OptionExerciseMakeWholeProvision {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedExerciseDesc is not null)
			{
				writer.WriteWholeNumber(41107, EncodedExerciseDesc.Length);
				writer.WriteBuffer(41108, EncodedExerciseDesc);
			}
