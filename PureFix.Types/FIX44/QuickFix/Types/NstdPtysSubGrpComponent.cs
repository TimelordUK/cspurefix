...
namespace PureFix.Types.FIX44.QuickFix.Types
{
	public sealed partial class NstdPtysSubGrpComponent : IFixComponent
	{
		...
		public ExecutionReportInstrmtLegExecGrpNoLegsNestedPartiesNoNestedPartyIDsNstdPtysSubGrpNoNestedPartySubIDs[]? NoNestedPartySubIDs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoNestedPartySubIDs") is IMessageView viewNoNestedPartySubIDs)
			{
				...
				NoNestedPartySubIDs = new ExecutionReportInstrmtLegExecGrpNoLegsNestedPartiesNoNestedPartyIDsNstdPtysSubGrpNoNestedPartySubIDs[count];
