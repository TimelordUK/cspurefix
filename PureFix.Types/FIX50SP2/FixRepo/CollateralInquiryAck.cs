...
{
	[MessageType("CollateralInquiryAck", FixVersion.FIX50SP2)]
	public sealed partial class CollateralInquiryAck : IFixMessage
	{
		...
		public CollateralInquiryAckParties[]? Parties {get; set;}
		...
		[TagDetails(Tag = 716, Type = TagType.String, Offset = 22, Required = false)]
		public string? SettlSessID {get; set;}
		
		[TagDetails(Tag = 717, Type = TagType.String, Offset = 23, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new CollateralInquiryAckParties[count];
