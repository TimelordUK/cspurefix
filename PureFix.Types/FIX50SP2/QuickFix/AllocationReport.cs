...
{
	[MessageType("AS", FixVersion.FIX50SP2)]
	public sealed partial class AllocationReport : IFixMessage
	{
		...
		[TagDetails(Tag = 71, Type = TagType.String, Offset = 4, Required = true)]
		public string? AllocTransType {get; set;}
		
		[TagDetails(Tag = 795, Type = TagType.String, Offset = 5, Required = false)]
		...
		[TagDetails(Tag = 793, Type = TagType.String, Offset = 7, Required = false)]
		public string? SecondaryAllocID {get; set;}
		
		[TagDetails(Tag = 1730, Type = TagType.String, Offset = 8, Required = false)]
		public string? AllocGroupID {get; set;}
		
		[TagDetails(Tag = 2771, Type = TagType.String, Offset = 9, Required = false)]
		public string? PreviousAllocGroupID {get; set;}
		
		[TagDetails(Tag = 2759, Type = TagType.Float, Offset = 10, Required = false)]
		public double? GroupAmount {get; set;}
		
		[TagDetails(Tag = 2767, Type = TagType.Int, Offset = 11, Required = false)]
		...
		[TagDetails(Tag = 794, Type = TagType.Int, Offset = 13, Required = true)]
		public int? AllocReportType {get; set;}
		
		[TagDetails(Tag = 87, Type = TagType.Int, Offset = 14, Required = true)]
		public int? AllocStatus {get; set;}
		
		[TagDetails(Tag = 88, Type = TagType.Int, Offset = 15, Required = false)]
		public int? AllocRejCode {get; set;}
		
		[TagDetails(Tag = 72, Type = TagType.String, Offset = 16, Required = false)]
		public string? RefAllocID {get; set;}
		
		[TagDetails(Tag = 1738, Type = TagType.Int, Offset = 17, Required = false)]
		public int? AllocReversalStatus {get; set;}
		
		[TagDetails(Tag = 808, Type = TagType.Int, Offset = 18, Required = false)]
		public int? AllocIntermedReqType {get; set;}
		
		[TagDetails(Tag = 196, Type = TagType.String, Offset = 19, Required = false)]
		public string? AllocLinkID {get; set;}
		
		[TagDetails(Tag = 197, Type = TagType.Int, Offset = 20, Required = false)]
		public int? AllocLinkType {get; set;}
		
		[TagDetails(Tag = 466, Type = TagType.String, Offset = 21, Required = false)]
		public string? BookingRefID {get; set;}
		
		[TagDetails(Tag = 715, Type = TagType.LocalDate, Offset = 22, Required = false)]
		public DateOnly? ClearingBusinessDate {get; set;}
		
		[TagDetails(Tag = 828, Type = TagType.Int, Offset = 23, Required = false)]
		public int? TrdType {get; set;}
		
		[TagDetails(Tag = 829, Type = TagType.Int, Offset = 24, Required = false)]
		public int? TrdSubType {get; set;}
		
		[TagDetails(Tag = 855, Type = TagType.Int, Offset = 25, Required = false)]
		public int? SecondaryTrdType {get; set;}
		
		[TagDetails(Tag = 1937, Type = TagType.Int, Offset = 26, Required = false)]
		public int? TradeContinuation {get; set;}
		
		[TagDetails(Tag = 2374, Type = TagType.String, Offset = 27, Required = false)]
		public string? TradeContinuationText {get; set;}
		
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 28, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 29, Required = false, LinksToTag = 2372)]
		public byte[]? EncodedTradeContinuationText {get; set;}
		
		[TagDetails(Tag = 442, Type = TagType.String, Offset = 30, Required = false)]
		public string? MultiLegReportingType {get; set;}
		
		[TagDetails(Tag = 582, Type = TagType.Int, Offset = 31, Required = false)]
		public int? CustOrderCapacity {get; set;}
		
		[TagDetails(Tag = 578, Type = TagType.String, Offset = 32, Required = false)]
		public string? TradeInputSource {get; set;}
		
		[TagDetails(Tag = 991, Type = TagType.Float, Offset = 33, Required = false)]
		public double? RndPx {get; set;}
		
		[TagDetails(Tag = 1011, Type = TagType.String, Offset = 34, Required = false)]
		...
		[TagDetails(Tag = 819, Type = TagType.Int, Offset = 36, Required = false)]
		public int? AvgPxIndicator {get; set;}
		
		[TagDetails(Tag = 1731, Type = TagType.String, Offset = 37, Required = false)]
		public string? AvgPxGroupID {get; set;}
		
		[TagDetails(Tag = 857, Type = TagType.Int, Offset = 38, Required = false)]
		...
		[TagDetails(Tag = 570, Type = TagType.Boolean, Offset = 41, Required = false)]
		public bool? PreviouslyReported {get; set;}
		
		[TagDetails(Tag = 700, Type = TagType.Boolean, Offset = 42, Required = false)]
		public bool? ReversalIndicator {get; set;}
		
		[TagDetails(Tag = 574, Type = TagType.String, Offset = 43, Required = false)]
		public string? MatchType {get; set;}
		
		[TagDetails(Tag = 54, Type = TagType.String, Offset = 44, Required = true)]
		...
		[TagDetails(Tag = 53, Type = TagType.Float, Offset = 50, Required = true)]
		public double? Quantity {get; set;}
		
		[TagDetails(Tag = 854, Type = TagType.Int, Offset = 51, Required = false)]
		public int? QtyType {get; set;}
		
		[TagDetails(Tag = 1736, Type = TagType.Float, Offset = 52, Required = false)]
		public double? AllocGroupQuantity {get; set;}
		
		[TagDetails(Tag = 1737, Type = TagType.Float, Offset = 53, Required = false)]
		public double? AllocGroupRemainingQuantity {get; set;}
		
		[TagDetails(Tag = 30, Type = TagType.String, Offset = 54, Required = false)]
		public string? LastMkt {get; set;}
		
		[TagDetails(Tag = 229, Type = TagType.LocalDate, Offset = 55, Required = false)]
		public DateOnly? TradeOriginationDate {get; set;}
		
		[TagDetails(Tag = 336, Type = TagType.String, Offset = 56, Required = false)]
		public string? TradingSessionID {get; set;}
		
		[TagDetails(Tag = 625, Type = TagType.String, Offset = 57, Required = false)]
		...
		public PriceQualifierGrpComponent? PriceQualifierGrp {get; set;}
		
		[TagDetails(Tag = 6, Type = TagType.Float, Offset = 60, Required = true)]
		public double? AvgPx {get; set;}
		
		[TagDetails(Tag = 860, Type = TagType.Float, Offset = 61, Required = false)]
		...
		[TagDetails(Tag = 15, Type = TagType.String, Offset = 63, Required = false)]
		public string? Currency {get; set;}
		
		[TagDetails(Tag = 2897, Type = TagType.String, Offset = 64, Required = false)]
		public string? CurrencyCodeSource {get; set;}
		
		[TagDetails(Tag = 74, Type = TagType.Int, Offset = 65, Required = false)]
		public int? AvgPxPrecision {get; set;}
		
		[Component(Offset = 66, Required = false)]
		public PartiesComponent? Parties {get; set;}
		
		[TagDetails(Tag = 75, Type = TagType.LocalDate, Offset = 67, Required = true)]
		public DateOnly? TradeDate {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 68, Required = false)]
		public DateTime? TransactTime {get; set;}
		
		[TagDetails(Tag = 63, Type = TagType.String, Offset = 69, Required = false)]
		public string? SettlType {get; set;}
		
		[TagDetails(Tag = 64, Type = TagType.LocalDate, Offset = 70, Required = false)]
		public DateOnly? SettlDate {get; set;}
		
		[TagDetails(Tag = 775, Type = TagType.Int, Offset = 71, Required = false)]
		public int? BookingType {get; set;}
		
		[TagDetails(Tag = 381, Type = TagType.Float, Offset = 72, Required = false)]
		public double? GrossTradeAmt {get; set;}
		
		[TagDetails(Tag = 238, Type = TagType.Float, Offset = 73, Required = false)]
		public double? Concession {get; set;}
		
		[TagDetails(Tag = 237, Type = TagType.Float, Offset = 74, Required = false)]
		public double? TotalTakedown {get; set;}
		
		[TagDetails(Tag = 118, Type = TagType.Float, Offset = 75, Required = false)]
		public double? NetMoney {get; set;}
		
		[TagDetails(Tag = 77, Type = TagType.String, Offset = 76, Required = false)]
		public string? PositionEffect {get; set;}
		
		[TagDetails(Tag = 754, Type = TagType.Boolean, Offset = 77, Required = false)]
		public bool? AutoAcceptIndicator {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 78, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 79, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 80, Required = false, LinksToTag = 354)]
		public byte[]? EncodedText {get; set;}
		
		[TagDetails(Tag = 157, Type = TagType.Int, Offset = 81, Required = false)]
		public int? NumDaysInterest {get; set;}
		
		[TagDetails(Tag = 158, Type = TagType.Float, Offset = 82, Required = false)]
		public double? AccruedInterestRate {get; set;}
		
		[TagDetails(Tag = 159, Type = TagType.Float, Offset = 83, Required = false)]
		public double? AccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 540, Type = TagType.Float, Offset = 84, Required = false)]
		public double? TotalAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 738, Type = TagType.Float, Offset = 85, Required = false)]
		public double? InterestAtMaturity {get; set;}
		
		[TagDetails(Tag = 920, Type = TagType.Float, Offset = 86, Required = false)]
		public double? EndAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 921, Type = TagType.Float, Offset = 87, Required = false)]
		public double? StartCash {get; set;}
		
		[TagDetails(Tag = 922, Type = TagType.Float, Offset = 88, Required = false)]
		public double? EndCash {get; set;}
		
		[TagDetails(Tag = 650, Type = TagType.Boolean, Offset = 89, Required = false)]
		...
		public RegulatoryTradeIDGrpComponent? RegulatoryTradeIDGrp {get; set;}
		...
		[TagDetails(Tag = 892, Type = TagType.Int, Offset = 96, Required = false)]
		public int? TotNoAllocs {get; set;}
		
		[TagDetails(Tag = 893, Type = TagType.Boolean, Offset = 97, Required = false)]
		public bool? LastFragment {get; set;}
		
		[Component(Offset = 98, Required = false)]
		public AllocGrpComponent? AllocGrp {get; set;}
		
		[Component(Offset = 99, Required = false)]
		public RateSourceComponent? RateSource {get; set;}
		
		[TagDetails(Tag = 1430, Type = TagType.String, Offset = 100, Required = false)]
		public string? VenueType {get; set;}
		
		[TagDetails(Tag = 2334, Type = TagType.String, Offset = 101, Required = false)]
		public string? RefRiskLimitCheckID {get; set;}
		
		[TagDetails(Tag = 2335, Type = TagType.Int, Offset = 102, Required = false)]
		public int? RefRiskLimitCheckIDType {get; set;}
		
		[TagDetails(Tag = 2343, Type = TagType.Int, Offset = 103, Required = false)]
		public int? RiskLimitCheckStatus {get; set;}
		
		[Component(Offset = 104, Required = true)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (AllocReversalStatus is not null) writer.WriteWholeNumber(1738, AllocReversalStatus.Value);
			...
			if (EncodedTradeContinuationText is not null)
			{
				writer.WriteWholeNumber(2372, EncodedTradeContinuationText.Length);
				writer.WriteBuffer(2371, EncodedTradeContinuationText);
			}
			...
			if (AllocGroupQuantity is not null) writer.WriteNumber(1736, AllocGroupQuantity.Value);
			if (AllocGroupRemainingQuantity is not null) writer.WriteNumber(1737, AllocGroupRemainingQuantity.Value);
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			AllocReversalStatus = view.GetInt32(1738);
			...
			AllocGroupQuantity = view.GetDouble(1736);
			AllocGroupRemainingQuantity = view.GetDouble(1737);
		...
		bool IFixLookup.TryGetByTag(string name, out object? value)
		{
			...
			switch (name)
			{
				...
				case "RefAllocID":
					value = RefAllocID;
					break;
				case "AllocReversalStatus":
					value = AllocReversalStatus;
					break;
				...
				case "QtyType":
					value = QtyType;
					break;
				case "AllocGroupQuantity":
					value = AllocGroupQuantity;
					break;
				case "AllocGroupRemainingQuantity":
					value = AllocGroupRemainingQuantity;
					break;
				case "LastMkt":
					value = LastMkt;
					break;
		...
		void IFixReset.Reset()
		{
			...
			Quantity = null;
			QtyType = null;
			AllocGroupQuantity = null;
			AllocGroupRemainingQuantity = null;
			LastMkt = null;
