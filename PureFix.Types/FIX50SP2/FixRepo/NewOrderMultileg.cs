...
{
	[MessageType("NewOrderMultileg", FixVersion.FIX50SP2)]
	public sealed partial class NewOrderMultileg : IFixMessage
	{
		...
		public NewOrderMultilegParties[]? Parties {get; set;}
		...
		[TagDetails(Tag = 54, Type = TagType.String, Offset = 28, Required = true)]
		...
		[TagDetails(Tag = 1069, Type = TagType.Float, Offset = 32, Required = false)]
		...
		[TagDetails(Tag = 40, Type = TagType.String, Offset = 37, Required = true)]
		public string? OrdType {get; set;}
		
		[TagDetails(Tag = 1377, Type = TagType.Int, Offset = 38, Required = false)]
		public int? MultilegModel {get; set;}
		
		[TagDetails(Tag = 1378, Type = TagType.Int, Offset = 39, Required = false)]
		public int? MultilegPriceMethod {get; set;}
		
		[TagDetails(Tag = 423, Type = TagType.Int, Offset = 40, Required = false)]
		public int? PriceType {get; set;}
		
		[TagDetails(Tag = 44, Type = TagType.Float, Offset = 41, Required = false)]
		public double? Price {get; set;}
		
		[TagDetails(Tag = 1092, Type = TagType.String, Offset = 42, Required = false)]
		...
		[TagDetails(Tag = 1080, Type = TagType.String, Offset = 50, Required = false)]
		public string? RefOrderID {get; set;}
		
		[TagDetails(Tag = 1081, Type = TagType.String, Offset = 51, Required = false)]
		public string? RefOrderIDSource {get; set;}
		
		[TagDetails(Tag = 59, Type = TagType.String, Offset = 52, Required = false)]
		public string? TimeInForce {get; set;}
		
		[TagDetails(Tag = 168, Type = TagType.UtcTimestamp, Offset = 53, Required = false)]
		public DateTime? EffectiveTime {get; set;}
		
		[TagDetails(Tag = 432, Type = TagType.LocalDate, Offset = 54, Required = false)]
		public DateOnly? ExpireDate {get; set;}
		
		[TagDetails(Tag = 126, Type = TagType.UtcTimestamp, Offset = 55, Required = false)]
		public DateTime? ExpireTime {get; set;}
		
		[TagDetails(Tag = 427, Type = TagType.Int, Offset = 56, Required = false)]
		public int? GTBookingInst {get; set;}
		
		[Component(Offset = 57, Required = false)]
		public CommissionDataComponent? CommissionData {get; set;}
		
		[TagDetails(Tag = 528, Type = TagType.String, Offset = 58, Required = false)]
		public string? OrderCapacity {get; set;}
		
		[TagDetails(Tag = 529, Type = TagType.String, Offset = 59, Required = false)]
		public string? OrderRestrictions {get; set;}
		
		[TagDetails(Tag = 1091, Type = TagType.Boolean, Offset = 60, Required = false)]
		public bool? PreTradeAnonymity {get; set;}
		
		[TagDetails(Tag = 582, Type = TagType.Int, Offset = 61, Required = false)]
		public int? CustOrderCapacity {get; set;}
		
		[TagDetails(Tag = 121, Type = TagType.Boolean, Offset = 62, Required = false)]
		public bool? ForexReq {get; set;}
		
		[TagDetails(Tag = 120, Type = TagType.String, Offset = 63, Required = false)]
		public string? SettlCurrency {get; set;}
		
		[TagDetails(Tag = 775, Type = TagType.Int, Offset = 64, Required = false)]
		public int? BookingType {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 65, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 66, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 67, Required = false, LinksToTag = 354)]
		...
		[TagDetails(Tag = 847, Type = TagType.Int, Offset = 73, Required = false)]
		public int? TargetStrategy {get; set;}
		
		[TagDetails(Tag = 848, Type = TagType.String, Offset = 74, Required = false)]
		public string? TargetStrategyParameters {get; set;}
		
		[TagDetails(Tag = 1190, Type = TagType.Float, Offset = 75, Required = false)]
		public double? RiskFreeRate {get; set;}
		
		[TagDetails(Tag = 849, Type = TagType.Float, Offset = 76, Required = false)]
		...
		[TagDetails(Tag = 563, Type = TagType.Int, Offset = 81, Required = false)]
		public int? MultiLegRptTypeReq {get; set;}
		
		[Component(Offset = 82, Required = true)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new NewOrderMultilegParties[count];
