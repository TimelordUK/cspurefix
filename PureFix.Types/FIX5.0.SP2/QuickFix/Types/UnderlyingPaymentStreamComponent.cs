...
{
	public sealed partial class UnderlyingPaymentStreamComponent : IFixComponent
	{
		...
		public UnderlyingPaymentStreamPaymentDatesComponent? UnderlyingPaymentStreamPaymentDates {get; set;}
		
		[Component(Offset = 27, Required = false)]
		public UnderlyingPaymentStreamResetDatesComponent? UnderlyingPaymentStreamResetDates {get; set;}
		
		[Component(Offset = 28, Required = false)]
		public UnderlyingPaymentStreamFixedRateComponent? UnderlyingPaymentStreamFixedRate {get; set;}
		
		[Component(Offset = 29, Required = false)]
		public UnderlyingPaymentStreamFloatingRateComponent? UnderlyingPaymentStreamFloatingRate {get; set;}
		...
		public UnderlyingPaymentStreamCompoundingFloatingRateComponent? UnderlyingPaymentStreamCompoundingFloatingRate {get; set;}
		
		[Component(Offset = 32, Required = false)]
		public UnderlyingPaymentStreamCompoundingDatesComponent? UnderlyingPaymentStreamCompoundingDates {get; set;}
		
		[Component(Offset = 33, Required = false)]
		public UnderlyingPaymentStreamNonDeliverableSettlTermsComponent? UnderlyingPaymentStreamNonDeliverableSettlTerms {get; set;}
