...
{
	public sealed partial class UnderlyingComplexEventRelativeDateComponent : IFixComponent
	{
		...
		public UnderlyingComplexEventDateBusinessCenterGrpComponent? UnderlyingComplexEventDateBusinessCenterGrp {get; set;}
