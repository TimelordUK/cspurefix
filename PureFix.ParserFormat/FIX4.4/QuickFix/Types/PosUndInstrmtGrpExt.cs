...
{
	public static class PosUndInstrmtGrpExt
	{
		public static void Parse(this PosUndInstrmtGrp instance, MsgView? view)
		{
			...
			instance.NoUnderlyings = new PosUndInstrmtGrpNoUnderlyings[countNoUnderlyings];
