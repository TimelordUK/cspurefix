...
namespace PureFix.Types.FIX43
{
	...
	public sealed partial class NewOrderList : IFixMessage
	{
		...
		[TagDetails(Tag = 68, Type = TagType.Int, Offset = 14, Required = true)]
		...
		public sealed partial class NoOrders : IFixGroup
		{
			...
			[TagDetails(Tag = 354, Type = TagType.Length, Offset = 57, Required = false)]
			public int? EncodedTextLen {get; set;}
			
			[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 58, Required = false)]
		...
		[Group(NoOfTag = 73, Offset = 15, Required = true)]
