...
{
	public static class TrdInstrmtLegGrpExt
	{
		public static void Parse(this TrdInstrmtLegGrp instance, MsgView? view)
		{
			...
			instance.NoLegs = new TrdInstrmtLegGrpNoLegs[countNoLegs];
