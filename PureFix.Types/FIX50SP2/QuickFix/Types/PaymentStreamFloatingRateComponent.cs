...
{
	public sealed partial class PaymentStreamFloatingRateComponent : IFixComponent
	{
		...
		public PaymentStreamPricingBusinessCenterGrpComponent? PaymentStreamPricingBusinessCenterGrp {get; set;}
		
		[Component(Offset = 54, Required = false)]
		public PaymentStreamPricingDayGrpComponent? PaymentStreamPricingDayGrp {get; set;}
		
		[Component(Offset = 55, Required = false)]
		public PaymentStreamPricingDateGrpComponent? PaymentStreamPricingDateGrp {get; set;}
		...
		public PaymentStreamFormulaComponent? PaymentStreamFormula {get; set;}
		
		[Component(Offset = 67, Required = false)]
		public DividendConditionsComponent? DividendConditions {get; set;}
		...
		public ReturnRateGrpComponent? ReturnRateGrp {get; set;}
