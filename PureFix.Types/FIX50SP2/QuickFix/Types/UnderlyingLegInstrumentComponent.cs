...
{
	public sealed partial class UnderlyingLegInstrumentComponent : IFixComponent
	{
		...
		public UnderlyingLegSecurityAltIDGrpComponent? UnderlyingLegSecurityAltIDGrp {get; set;}
