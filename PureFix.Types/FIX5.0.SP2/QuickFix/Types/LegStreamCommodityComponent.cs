...
{
	public sealed partial class LegStreamCommodityComponent : IFixComponent
	{
		...
		public LegStreamCommodityAltIDGrpComponent? LegStreamCommodityAltIDGrp {get; set;}
		
		[TagDetails(Tag = 41652, Type = TagType.String, Offset = 5, Required = false)]
		public string? LegStreamCommodityDesc {get; set;}
		
		[TagDetails(Tag = 41653, Type = TagType.Length, Offset = 6, Required = false, LinksToTag = 41654)]
		public int? EncodedLegStreamCommodityDescLen {get; set;}
		
		[TagDetails(Tag = 41654, Type = TagType.RawData, Offset = 7, Required = false, LinksToTag = 41653)]
		...
		public LegStreamAssetAttributeGrpComponent? LegStreamAssetAttributeGrp {get; set;}
		...
		public LegStreamCommodityDataSourceGrpComponent? LegStreamCommodityDataSourceGrp {get; set;}
		...
		public LegStreamCommoditySettlBusinessCenterGrpComponent? LegStreamCommoditySettlBusinessCenterGrp {get; set;}
		...
		public LegStreamCommoditySettlPeriodGrpComponent? LegStreamCommoditySettlPeriodGrp {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedLegStreamCommodityDesc is not null)
			{
				writer.WriteWholeNumber(41653, EncodedLegStreamCommodityDesc.Length);
				writer.WriteBuffer(41654, EncodedLegStreamCommodityDesc);
			}
