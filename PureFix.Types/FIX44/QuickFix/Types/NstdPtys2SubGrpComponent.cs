...
namespace PureFix.Types.FIX44.QuickFix.Types
{
	public sealed partial class NstdPtys2SubGrpComponent : IFixComponent
	{
		...
		public AllocationInstructionOrdAllocGrpNoOrdersNestedParties2NoNested2PartyIDsNstdPtys2SubGrpNoNested2PartySubIDs[]? NoNested2PartySubIDs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoNested2PartySubIDs") is IMessageView viewNoNested2PartySubIDs)
			{
				...
				NoNested2PartySubIDs = new AllocationInstructionOrdAllocGrpNoOrdersNestedParties2NoNested2PartyIDsNstdPtys2SubGrpNoNested2PartySubIDs[count];
