...
{
	public sealed partial class StrmAsgnReqInstrmtGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 146, Offset = 0, Required = false)]
		public StreamAssignmentRequestNoRelatedSym[]? NoRelatedSym {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoRelatedSym") is IMessageView viewNoRelatedSym)
			{
				...
				NoRelatedSym = new StreamAssignmentRequestNoRelatedSym[count];
