...
{
	public sealed partial class DerivativeSecurityListRequestNoDerivativeInstrumentParties : IFixGroup
	{
		...
		public DerivativeInstrumentPartySubIDsGrpComponent? DerivativeInstrumentPartySubIDsGrp {get; set;}
