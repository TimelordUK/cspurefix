...
{
	[MessageType("y", FixVersion.FIX50SP2)]
	public sealed partial class SecurityList : IFixMessage
	{
		...
		[TagDetails(Tag = 1466, Type = TagType.String, Offset = 5, Required = false)]
		public string? SecurityListRefID {get; set;}
		
		[TagDetails(Tag = 1467, Type = TagType.String, Offset = 6, Required = false)]
		public string? SecurityListDesc {get; set;}
		
		[TagDetails(Tag = 1468, Type = TagType.Length, Offset = 7, Required = false, LinksToTag = 1469)]
		public int? EncodedSecurityListDescLen {get; set;}
		
		[TagDetails(Tag = 1469, Type = TagType.RawData, Offset = 8, Required = false, LinksToTag = 1468)]
		public byte[]? EncodedSecurityListDesc {get; set;}
		
		[TagDetails(Tag = 1470, Type = TagType.Int, Offset = 9, Required = false)]
		public int? SecurityListType {get; set;}
		
		[TagDetails(Tag = 1471, Type = TagType.Int, Offset = 10, Required = false)]
		public int? SecurityListTypeSource {get; set;}
		
		[TagDetails(Tag = 320, Type = TagType.String, Offset = 11, Required = false)]
		public string? SecurityReqID {get; set;}
		
		[TagDetails(Tag = 322, Type = TagType.String, Offset = 12, Required = false)]
		public string? SecurityResponseID {get; set;}
		
		[TagDetails(Tag = 560, Type = TagType.Int, Offset = 13, Required = false)]
		public int? SecurityRequestResult {get; set;}
		
		[TagDetails(Tag = 1607, Type = TagType.Int, Offset = 14, Required = false)]
		public int? SecurityRejectReason {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 15, Required = false)]
		public DateTime? TransactTime {get; set;}
		
		[TagDetails(Tag = 393, Type = TagType.Int, Offset = 16, Required = false)]
		...
		[TagDetails(Tag = 893, Type = TagType.Boolean, Offset = 19, Required = false)]
