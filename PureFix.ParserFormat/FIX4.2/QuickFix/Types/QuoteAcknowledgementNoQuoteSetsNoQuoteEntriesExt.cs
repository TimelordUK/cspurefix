...
{
	public static class QuoteAcknowledgementNoQuoteSetsNoQuoteEntriesExt
	{
		public static void Parse(this QuoteAcknowledgementNoQuoteSetsNoQuoteEntries instance, MsgView? view)
		{
