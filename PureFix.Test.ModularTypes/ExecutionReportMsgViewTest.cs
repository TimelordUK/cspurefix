...
// Legacy types (for reference/comparison)
...
namespace PureFix.Test.ModularTypes
{
    internal class ExecutionReportMsgViewTest
    {
        ...
        public void CheckData()
        {
            ...
            var parties = QuickLookup.On(message)["Parties"]["NoPartyIDs"].As<Parties.NoPartyIDs[]>();
 ...
 */
        ...
        public void View_Parse_Parties_To_Type_Test()
        {
            ...
            var instance = JsonHelper.FromJson<Parties.NoPartyIDs>(expected);
        ...
        public void View_UndInstrmtGrp_Component_Decode_Test()
        {
            ...
            var u0 = uig.Underlyings?[0];
            var underlying0 = u0?.UnderlyingInstrument;

            Assert.Multiple(() =>
            {
                Assert.That(uig.Underlyings, Is.Not.Null);
                Assert.That(uig.Underlyings, Has.Length.EqualTo(2));
                Assert.That(u0, Is.Not.Null);
                Assert.That(underlying0, Is.Not.Null);
                // Assert.That(underlying0.UnderlyingSymbol, Is.EqualTo("massa."));  // UnderlyingInstrument is empty in FIX44-Core
            });
          ...
          "UndSecAltIDGrp": {
            ...
            Assert.Multiple(() =>
            {
                ...
                var u1 = uig.Underlyings?[1].UnderlyingInstrument;
                Assert.Multiple(() =>
                {
                    Assert.That(underlying0, Is.Not.Null);
