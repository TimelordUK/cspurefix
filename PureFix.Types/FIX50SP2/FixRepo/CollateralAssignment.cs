...
{
	[MessageType("CollateralAssignment", FixVersion.FIX50SP2)]
	public sealed partial class CollateralAssignment : IFixMessage
	{
		...
		public CollateralAssignmentParties[]? Parties {get; set;}
		...
		[Group(NoOfTag = 1020, Offset = 25, Required = false)]
		public CollateralAssignmentTrdRegTimestamps[]? TrdRegTimestamps {get; set;}
		...
		[TagDetails(Tag = 159, Type = TagType.Float, Offset = 29, Required = false)]
		public double? AccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 920, Type = TagType.Float, Offset = 30, Required = false)]
		public double? EndAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 921, Type = TagType.Float, Offset = 31, Required = false)]
		public double? StartCash {get; set;}
		
		[TagDetails(Tag = 922, Type = TagType.Float, Offset = 32, Required = false)]
		...
		[Group(NoOfTag = 1019, Offset = 34, Required = false)]
		public CollateralAssignmentStipulations[]? Stipulations {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new CollateralAssignmentParties[count];
			...
			if (view.GetView("TrdRegTimestamps") is IMessageView viewTrdRegTimestamps)
			{
				...
				TrdRegTimestamps = new CollateralAssignmentTrdRegTimestamps[count];
				for (int i = 0; i < count; i++)
				{
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new CollateralAssignmentStipulations[count];
				for (int i = 0; i < count; i++)
				{
					Stipulations[i] = new();
