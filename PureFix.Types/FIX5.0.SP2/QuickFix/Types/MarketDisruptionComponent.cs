...
{
	public sealed partial class MarketDisruptionComponent : IFixComponent
	{
		[TagDetails(Tag = 41087, Type = TagType.Int, Offset = 0, Required = false)]
		public int? MarketDisruptionProvision {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public MarketDisruptionEventGrpComponent? MarketDisruptionEventGrp {get; set;}
		
		[TagDetails(Tag = 41088, Type = TagType.Int, Offset = 2, Required = false)]
		public int? MarketDisruptionFallbackProvision {get; set;}
		
		[Component(Offset = 3, Required = false)]
		public MarketDisruptionFallbackGrpComponent? MarketDisruptionFallbackGrp {get; set;}
		
		[Component(Offset = 4, Required = false)]
		public MarketDisruptionFallbackReferencePriceGrpComponent? MarketDisruptionFallbackReferencePriceGrp {get; set;}
