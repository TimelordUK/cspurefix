...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class News : IFixMessage
	{
		...
		public NewsRefGrpComponent? NewsRefGrp {get; set;}
		...
		[TagDetails(Tag = 358, Type = TagType.Length, Offset = 9, Required = false, LinksToTag = 359)]
		public int? EncodedHeadlineLen {get; set;}
		
		[TagDetails(Tag = 359, Type = TagType.RawData, Offset = 10, Required = false, LinksToTag = 358)]
		...
		[TagDetails(Tag = 95, Type = TagType.Length, Offset = 19, Required = false, LinksToTag = 96)]
		public int? RawDataLength {get; set;}
		
		[TagDetails(Tag = 96, Type = TagType.RawData, Offset = 20, Required = false, LinksToTag = 95)]
