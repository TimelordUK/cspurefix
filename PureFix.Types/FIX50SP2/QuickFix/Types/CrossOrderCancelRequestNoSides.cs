...
{
	public sealed partial class CrossOrderCancelRequestNoSides : IFixGroup
	{
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 12, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 13, Required = false, LinksToTag = 2351)]
