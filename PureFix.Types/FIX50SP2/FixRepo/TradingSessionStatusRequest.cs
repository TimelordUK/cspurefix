...
{
	[MessageType("TradingSessionStatusRequest", FixVersion.FIX50SP2)]
	public sealed partial class TradingSessionStatusRequest : IFixMessage
	{
		...
		[TagDetails(Tag = 338, Type = TagType.Int, Offset = 6, Required = false)]
		public int? TradSesMethod {get; set;}
		
		[TagDetails(Tag = 339, Type = TagType.Int, Offset = 7, Required = false)]
		public int? TradSesMode {get; set;}
		
		[TagDetails(Tag = 263, Type = TagType.String, Offset = 8, Required = true)]
		public string? SubscriptionRequestType {get; set;}
		
		[TagDetails(Tag = 207, Type = TagType.String, Offset = 9, Required = false)]
