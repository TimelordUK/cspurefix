...
namespace PureFix.Types.FIX43.QuickFix.Types
{
	public static class InstrumentLegExt
	{
		public static void Parse(this InstrumentLeg instance, MsgView? view)
		{
			...
			instance.NoLegSecurityAltID = new InstrumentLegNoLegSecurityAltID[countNoLegSecurityAltID];
			...
			instance.LegCouponPaymentDate = view.GetString(248);
			instance.LegIssueDate = view.GetString(249);
			...
			instance.LegRedemptionDate = view.GetString(254);
