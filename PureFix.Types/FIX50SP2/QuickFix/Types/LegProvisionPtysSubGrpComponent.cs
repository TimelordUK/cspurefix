...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class LegProvisionPtysSubGrpComponent : IFixComponent
	{
		...
		public IOINoLegProvisionPartySubIDs[]? NoLegProvisionPartySubIDs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegProvisionPartySubIDs") is IMessageView viewNoLegProvisionPartySubIDs)
			{
				...
				NoLegProvisionPartySubIDs = new IOINoLegProvisionPartySubIDs[count];
		...
		{
			NoLegProvisionPartySubIDs = null;
		}
	}
}
