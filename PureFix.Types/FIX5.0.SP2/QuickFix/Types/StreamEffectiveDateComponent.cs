...
{
	public sealed partial class StreamEffectiveDateComponent : IFixComponent
	{
		...
		public StreamEffectiveDateBusinessCenterGrpComponent? StreamEffectiveDateBusinessCenterGrp {get; set;}
