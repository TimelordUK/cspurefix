...
{
	public sealed partial class LegPaymentStreamComponent : IFixComponent
	{
		...
		public LegPaymentStreamPaymentDatesComponent? LegPaymentStreamPaymentDates {get; set;}
		
		[Component(Offset = 27, Required = false)]
		public LegPaymentStreamResetDatesComponent? LegPaymentStreamResetDates {get; set;}
		
		[Component(Offset = 28, Required = false)]
		public LegPaymentStreamFixedRateComponent? LegPaymentStreamFixedRate {get; set;}
		
		[Component(Offset = 29, Required = false)]
		public LegPaymentStreamFloatingRateComponent? LegPaymentStreamFloatingRate {get; set;}
		...
		public LegPaymentStreamCompoundingFloatingRateComponent? LegPaymentStreamCompoundingFloatingRate {get; set;}
		
		[Component(Offset = 32, Required = false)]
		public LegPaymentStreamCompoundingDatesComponent? LegPaymentStreamCompoundingDates {get; set;}
		
		[Component(Offset = 33, Required = false)]
		public LegPaymentStreamNonDeliverableSettlTermsComponent? LegPaymentStreamNonDeliverableSettlTerms {get; set;}
