...
namespace PureFix.Types.FIX43.QuickFix
{
	...
	public sealed partial class Quote : IFixMessage
	{
		...
		[TagDetails(Tag = 63, Type = TagType.String, Offset = 29, Required = false)]
		public string? SettlmntTyp {get; set;}
		
		[TagDetails(Tag = 64, Type = TagType.LocalDate, Offset = 30, Required = false)]
		public DateOnly? FutSettDate {get; set;}
		
		[TagDetails(Tag = 40, Type = TagType.String, Offset = 31, Required = false)]
		public string? OrdType {get; set;}
		
		[TagDetails(Tag = 193, Type = TagType.LocalDate, Offset = 32, Required = false)]
		public DateOnly? FutSettDate2 {get; set;}
		
		[TagDetails(Tag = 192, Type = TagType.Float, Offset = 33, Required = false)]
		public double? OrderQty2 {get; set;}
		
		[TagDetails(Tag = 642, Type = TagType.Float, Offset = 34, Required = false)]
		public double? BidForwardPoints2 {get; set;}
		
		[TagDetails(Tag = 643, Type = TagType.Float, Offset = 35, Required = false)]
		public double? OfferForwardPoints2 {get; set;}
		
		[TagDetails(Tag = 15, Type = TagType.String, Offset = 36, Required = false)]
		public string? Currency {get; set;}
		
		[TagDetails(Tag = 656, Type = TagType.Float, Offset = 37, Required = false)]
		public double? SettlCurrBidFxRate {get; set;}
		
		[TagDetails(Tag = 657, Type = TagType.Float, Offset = 38, Required = false)]
		public double? SettlCurrOfferFxRate {get; set;}
		
		[TagDetails(Tag = 156, Type = TagType.String, Offset = 39, Required = false)]
		public string? SettlCurrFxRateCalc {get; set;}
		
		[TagDetails(Tag = 12, Type = TagType.Float, Offset = 40, Required = false)]
		public double? Commission {get; set;}
		
		[TagDetails(Tag = 13, Type = TagType.String, Offset = 41, Required = false)]
		public string? CommType {get; set;}
		
		[TagDetails(Tag = 582, Type = TagType.Int, Offset = 42, Required = false)]
		public int? CustOrderCapacity {get; set;}
		
		[TagDetails(Tag = 100, Type = TagType.String, Offset = 43, Required = false)]
		public string? ExDestination {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 44, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 45, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 46, Required = false, LinksToTag = 354)]
