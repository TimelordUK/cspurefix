...
{
	[MessageType("RegistrationInstructionsResponse", FixVersion.FIX50SP2)]
	public sealed partial class RegistrationInstructionsResponse : IFixMessage
	{
		...
		public RegistrationInstructionsResponseParties[]? Parties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new RegistrationInstructionsResponseParties[count];
