...
{
	public sealed partial class IOINoAdditionalTermBondRefs : IFixGroup
	{
		...
		[TagDetails(Tag = 40004, Type = TagType.Length, Offset = 3, Required = false, LinksToTag = 40005)]
		public int? EncodedAdditionalTermBondDescLen {get; set;}
		
		[TagDetails(Tag = 40005, Type = TagType.RawData, Offset = 4, Required = false, LinksToTag = 40004)]
		...
		[TagDetails(Tag = 40008, Type = TagType.Length, Offset = 7, Required = false, LinksToTag = 40009)]
		public int? EncodedAdditionalTermBondIssuerLen {get; set;}
		
		[TagDetails(Tag = 40009, Type = TagType.RawData, Offset = 8, Required = false, LinksToTag = 40008)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedAdditionalTermBondDesc is not null)
			{
				writer.WriteWholeNumber(40004, EncodedAdditionalTermBondDesc.Length);
				writer.WriteBuffer(40005, EncodedAdditionalTermBondDesc);
			}
			...
			if (EncodedAdditionalTermBondIssuer is not null)
			{
				writer.WriteWholeNumber(40008, EncodedAdditionalTermBondIssuer.Length);
				writer.WriteBuffer(40009, EncodedAdditionalTermBondIssuer);
			}
