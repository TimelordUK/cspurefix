...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MassOrder : IFixMessage
	{
		...
		public OrderEntryGrpComponent? OrderEntryGrp {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& MassOrderRequestID is not null
				&& OrderEntryGrp is not null && ((IFixValidator)OrderEntryGrp).IsValid(in config)
