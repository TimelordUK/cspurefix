...
{
	public sealed partial class TradeCaptureReportNoAllocs : IFixGroup
	{
		...
		[TagDetails(Tag = 360, Type = TagType.Length, Offset = 25, Required = false, LinksToTag = 361)]
		public int? EncodedAllocTextLen {get; set;}
		
		[TagDetails(Tag = 361, Type = TagType.RawData, Offset = 26, Required = false, LinksToTag = 360)]
		...
		[TagDetails(Tag = 1733, Type = TagType.Length, Offset = 28, Required = false, LinksToTag = 1734)]
		public int? EncodedFirmAllocTextLen {get; set;}
		
		[TagDetails(Tag = 1734, Type = TagType.RawData, Offset = 29, Required = false, LinksToTag = 1733)]
