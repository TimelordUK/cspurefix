...
{
	public static class CrossOrderCancelReplaceRequestNoSidesExt
	{
		public static void Parse(this CrossOrderCancelReplaceRequestNoSides instance, MsgView? view)
		{
			...
			instance.NoAllocs = new CrossOrderCancelReplaceRequestNoSidesNoAllocs[countNoAllocs];
