...
{
	public static class TrdCapRptSideGrpExt
	{
		public static void Parse(this TrdCapRptSideGrp instance, MsgView? view)
		{
			...
			instance.NoSides = new TrdCapRptSideGrpNoSides[countNoSides];
