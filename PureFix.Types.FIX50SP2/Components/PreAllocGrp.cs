...
{
	public sealed partial class PreAllocGrp : IFixComponent
	{
		public sealed partial class NoAllocs : IFixGroup
		{
			...
			[TagDetails(Tag = 80, Type = TagType.Float, Offset = 8, Required = false)]
			public double? AllocQty {get; set;}
			
			[TagDetails(Tag = 1752, Type = TagType.String, Offset = 9, Required = false)]
			public string? CustodialLotID {get; set;}
			
			[TagDetails(Tag = 1753, Type = TagType.LocalDate, Offset = 10, Required = false)]
			public DateOnly? VersusPurchaseDate {get; set;}
			
			[TagDetails(Tag = 1754, Type = TagType.Float, Offset = 11, Required = false)]
			public double? VersusPurchasePrice {get; set;}
			
			[TagDetails(Tag = 1755, Type = TagType.Float, Offset = 12, Required = false)]
