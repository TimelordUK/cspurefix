...
{
	public sealed partial class PreAllocMlegGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 78, Offset = 0, Required = false)]
		public NewOrderMultilegPreAllocMlegGrpNoAllocs[]? NoAllocs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoAllocs") is IMessageView viewNoAllocs)
			{
				...
				NoAllocs = new NewOrderMultilegPreAllocMlegGrpNoAllocs[count];
