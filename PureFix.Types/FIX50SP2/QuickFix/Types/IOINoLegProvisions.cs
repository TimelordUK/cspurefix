...
{
	public sealed partial class IOINoLegProvisions : IFixGroup
	{
		...
		public LegProvisionDateBusinessCenterGrpComponent? LegProvisionDateBusinessCenterGrp {get; set;}
		...
		public LegProvisionCashSettlValueDatesComponent? LegProvisionCashSettlValueDates {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public LegProvisionOptionExerciseDatesComponent? LegProvisionOptionExerciseDates {get; set;}
		
		[Component(Offset = 14, Required = false)]
		public LegProvisionOptionExpirationDateComponent? LegProvisionOptionExpirationDate {get; set;}
		
		[Component(Offset = 15, Required = false)]
		public LegProvisionOptionRelevantUnderlyingDateComponent? LegProvisionOptionRelevantUnderlyingDate {get; set;}
		...
		public LegProvisionCashSettlPaymentDatesComponent? LegProvisionCashSettlPaymentDates {get; set;}
		...
		public LegProvisionCashSettlQuoteSourceComponent? LegProvisionCashSettlQuoteSource {get; set;}
		
		[TagDetails(Tag = 40472, Type = TagType.String, Offset = 29, Required = false)]
		public string? LegProvisionText {get; set;}
		
		[TagDetails(Tag = 40980, Type = TagType.Length, Offset = 30, Required = false, LinksToTag = 40981)]
		public int? EncodedLegProvisionTextLen {get; set;}
		
		[TagDetails(Tag = 40981, Type = TagType.RawData, Offset = 31, Required = false, LinksToTag = 40980)]
		public byte[]? EncodedLegProvisionText {get; set;}
		
		[Component(Offset = 32, Required = false)]
		public LegProvisionPartiesComponent? LegProvisionParties {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedLegProvisionText is not null)
			{
				writer.WriteWholeNumber(40980, EncodedLegProvisionText.Length);
				writer.WriteBuffer(40981, EncodedLegProvisionText);
			}
