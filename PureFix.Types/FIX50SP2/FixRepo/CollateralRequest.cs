...
{
	[MessageType("CollateralRequest", FixVersion.FIX50SP2)]
	public sealed partial class CollateralRequest : IFixMessage
	{
		...
		[Group(NoOfTag = 1012, Offset = 5, Required = false)]
		public CollateralRequestParties[]? Parties {get; set;}
		...
		[TagDetails(Tag = 53, Type = TagType.Float, Offset = 15, Required = false)]
		public double? Quantity {get; set;}
		
		[TagDetails(Tag = 854, Type = TagType.Int, Offset = 16, Required = false)]
		...
		[TagDetails(Tag = 899, Type = TagType.Float, Offset = 19, Required = false)]
		public double? MarginExcess {get; set;}
		
		[TagDetails(Tag = 900, Type = TagType.Float, Offset = 20, Required = false)]
		public double? TotalNetValue {get; set;}
		
		[TagDetails(Tag = 901, Type = TagType.Float, Offset = 21, Required = false)]
		public double? CashOutstanding {get; set;}
		
		[Group(NoOfTag = 1020, Offset = 22, Required = false)]
		public CollateralRequestTrdRegTimestamps[]? TrdRegTimestamps {get; set;}
		
		[TagDetails(Tag = 54, Type = TagType.String, Offset = 23, Required = false)]
		public string? Side {get; set;}
		
		[TagDetails(Tag = 44, Type = TagType.Float, Offset = 24, Required = false)]
		public double? Price {get; set;}
		
		[TagDetails(Tag = 423, Type = TagType.Int, Offset = 25, Required = false)]
		public int? PriceType {get; set;}
		
		[TagDetails(Tag = 159, Type = TagType.Float, Offset = 26, Required = false)]
		public double? AccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 920, Type = TagType.Float, Offset = 27, Required = false)]
		public double? EndAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 921, Type = TagType.Float, Offset = 28, Required = false)]
		public double? StartCash {get; set;}
		
		[TagDetails(Tag = 922, Type = TagType.Float, Offset = 29, Required = false)]
		...
		[Group(NoOfTag = 1019, Offset = 31, Required = false)]
		public CollateralRequestStipulations[]? Stipulations {get; set;}
		...
		[TagDetails(Tag = 715, Type = TagType.LocalDate, Offset = 36, Required = false)]
		public DateOnly? ClearingBusinessDate {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 37, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 38, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 39, Required = false, LinksToTag = 354)]
		public byte[]? EncodedText {get; set;}
		
		[Component(Offset = 40, Required = true)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new CollateralRequestParties[count];
			...
			if (view.GetView("TrdRegTimestamps") is IMessageView viewTrdRegTimestamps)
			{
				...
				TrdRegTimestamps = new CollateralRequestTrdRegTimestamps[count];
				for (int i = 0; i < count; i++)
				{
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new CollateralRequestStipulations[count];
				for (int i = 0; i < count; i++)
				{
					Stipulations[i] = new();
