...
namespace PureFix.Types.FIX43.QuickFix
{
	...
	public static class NewOrderCrossExt
	{
		public static void Parse(this NewOrderCross instance, MsgView? view)
		{
			...
			instance.NoSides = new NewOrderCrossNoSides[countNoSides];
			...
			instance.NoTradingSessions = new NewOrderCrossNoTradingSessions[countNoTradingSessions];
