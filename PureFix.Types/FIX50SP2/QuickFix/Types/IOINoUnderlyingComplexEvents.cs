...
{
	public sealed partial class IOINoUnderlyingComplexEvents : IFixGroup
	{
		...
		public UnderlyingComplexEventDatesComponent? UnderlyingComplexEventDates {get; set;}
		...
		public UnderlyingComplexEventRateSourceGrpComponent? UnderlyingComplexEventRateSourceGrp {get; set;}
		
		[Component(Offset = 30, Required = false)]
		public UnderlyingComplexEventRelativeDateComponent? UnderlyingComplexEventRelativeDate {get; set;}
		
		[Component(Offset = 31, Required = false)]
		public UnderlyingComplexEventPeriodGrpComponent? UnderlyingComplexEventPeriodGrp {get; set;}
		...
		public UnderlyingComplexEventCreditEventSourceGrpComponent? UnderlyingComplexEventCreditEventSourceGrp {get; set;}
		
		[Component(Offset = 38, Required = false)]
		public UnderlyingComplexEventCreditEventGrpComponent? UnderlyingComplexEventCreditEventGrp {get; set;}
