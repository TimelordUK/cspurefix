...
{
	public sealed partial class PositionMaintenanceRequestPositionQty : IFixGroup
	{
		...
		public PositionMaintenanceRequestNestedParties[]? NestedParties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NestedParties") is IMessageView viewNestedParties)
			{
				...
				NestedParties = new PositionMaintenanceRequestNestedParties[count];
