...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class InstrumentLegComponent : IFixComponent
	{
		...
		public LegSecAltIDGrpComponent? LegSecAltIDGrp {get; set;}
		...
		public LegSecondaryAssetGrpComponent? LegSecondaryAssetGrp {get; set;}
		
		[Component(Offset = 32, Required = false)]
		public LegAssetAttributeGrpComponent? LegAssetAttributeGrp {get; set;}
		...
		[TagDetails(Tag = 2179, Type = TagType.Length, Offset = 58, Required = false, LinksToTag = 2180)]
		public int? EncodedLegOptionExpirationDescLen {get; set;}
		
		[TagDetails(Tag = 2180, Type = TagType.RawData, Offset = 59, Required = false, LinksToTag = 2179)]
		...
		[TagDetails(Tag = 618, Type = TagType.Length, Offset = 122, Required = false, LinksToTag = 619)]
		public int? EncodedLegIssuerLen {get; set;}
		
		[TagDetails(Tag = 619, Type = TagType.RawData, Offset = 123, Required = false, LinksToTag = 618)]
		...
		[TagDetails(Tag = 2718, Type = TagType.Length, Offset = 126, Required = false, LinksToTag = 2719)]
		public int? EncodedLegFinancialInstrumentFullNameLen {get; set;}
		
		[TagDetails(Tag = 2719, Type = TagType.RawData, Offset = 127, Required = false, LinksToTag = 2718)]
		...
		[TagDetails(Tag = 621, Type = TagType.Length, Offset = 129, Required = false, LinksToTag = 622)]
		public int? EncodedLegSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 622, Type = TagType.RawData, Offset = 130, Required = false, LinksToTag = 621)]
		public byte[]? EncodedLegSecurityDesc {get; set;}
		
		[Component(Offset = 131, Required = false)]
		public LegSecurityXMLComponent? LegSecurityXML {get; set;}
		...
		public LegEvntGrpComponent? LegEvntGrp {get; set;}
		
		[Component(Offset = 148, Required = false)]
		public LegInstrumentPartiesComponent? LegInstrumentParties {get; set;}
		...
		public LegComplexEventsComponent? LegComplexEvents {get; set;}
		...
		public LegDateAdjustmentComponent? LegDateAdjustment {get; set;}
		
		[Component(Offset = 158, Required = false)]
		public LegPricingDateTimeComponent? LegPricingDateTime {get; set;}
		
		[Component(Offset = 159, Required = false)]
		public LegMarketDisruptionComponent? LegMarketDisruption {get; set;}
		
		[Component(Offset = 160, Required = false)]
		public LegOptionExerciseComponent? LegOptionExercise {get; set;}
		
		[Component(Offset = 161, Required = false)]
		public LegStreamGrpComponent? LegStreamGrp {get; set;}
		
		[Component(Offset = 162, Required = false)]
		public LegProvisionGrpComponent? LegProvisionGrp {get; set;}
		
		[Component(Offset = 163, Required = false)]
		public LegAdditionalTermGrpComponent? LegAdditionalTermGrp {get; set;}
		
		[Component(Offset = 164, Required = false)]
		public LegProtectionTermGrpComponent? LegProtectionTermGrp {get; set;}
		
		[Component(Offset = 165, Required = false)]
		public LegCashSettlTermGrpComponent? LegCashSettlTermGrp {get; set;}
		
		[Component(Offset = 166, Required = false)]
		public LegPhysicalSettlTermGrpComponent? LegPhysicalSettlTermGrp {get; set;}
		
		[Component(Offset = 167, Required = false)]
		public LegExtraordinaryEventGrpComponent? LegExtraordinaryEventGrp {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedLegOptionExpirationDesc is not null)
			{
				writer.WriteWholeNumber(2179, EncodedLegOptionExpirationDesc.Length);
				writer.WriteBuffer(2180, EncodedLegOptionExpirationDesc);
			}
			...
			if (EncodedLegFinancialInstrumentFullName is not null)
			{
				writer.WriteWholeNumber(2718, EncodedLegFinancialInstrumentFullName.Length);
				writer.WriteBuffer(2719, EncodedLegFinancialInstrumentFullName);
			}
