...
{
	public sealed partial class LegMarketDisruptionComponent : IFixComponent
	{
		[TagDetails(Tag = 41462, Type = TagType.Int, Offset = 0, Required = false)]
		public int? LegMarketDisruptionProvision {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public LegMarketDisruptionEventGrpComponent? LegMarketDisruptionEventGrp {get; set;}
		...
		public LegMarketDisruptionFallbackGrpComponent? LegMarketDisruptionFallbackGrp {get; set;}
		
		[Component(Offset = 4, Required = false)]
		public LegMarketDisruptionFallbackReferencePriceGrpComponent? LegMarketDisruptionFallbackReferencePriceGrp {get; set;}
