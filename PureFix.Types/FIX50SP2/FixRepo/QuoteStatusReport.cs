...
{
	[MessageType("QuoteStatusReport", FixVersion.FIX50SP2)]
	public sealed partial class QuoteStatusReport : IFixMessage
	{
		...
		[TagDetails(Tag = 693, Type = TagType.String, Offset = 5, Required = false)]
		...
		public QuoteStatusReportParties[]? Parties {get; set;}
		...
		public QuoteStatusReportStipulations[]? Stipulations {get; set;}
		...
		[TagDetails(Tag = 110, Type = TagType.Float, Offset = 38, Required = false)]
		public double? MinQty {get; set;}
		
		[TagDetails(Tag = 62, Type = TagType.UtcTimestamp, Offset = 39, Required = false)]
		public DateTime? ValidUntilTime {get; set;}
		
		[TagDetails(Tag = 188, Type = TagType.Float, Offset = 40, Required = false)]
		public double? BidSpotRate {get; set;}
		
		[TagDetails(Tag = 190, Type = TagType.Float, Offset = 41, Required = false)]
		public double? OfferSpotRate {get; set;}
		
		[TagDetails(Tag = 189, Type = TagType.Float, Offset = 42, Required = false)]
		public double? BidForwardPoints {get; set;}
		
		[TagDetails(Tag = 191, Type = TagType.Float, Offset = 43, Required = false)]
		public double? OfferForwardPoints {get; set;}
		
		[TagDetails(Tag = 631, Type = TagType.Float, Offset = 44, Required = false)]
		public double? MidPx {get; set;}
		
		[TagDetails(Tag = 632, Type = TagType.Float, Offset = 45, Required = false)]
		public double? BidYield {get; set;}
		
		[TagDetails(Tag = 633, Type = TagType.Float, Offset = 46, Required = false)]
		public double? MidYield {get; set;}
		
		[TagDetails(Tag = 634, Type = TagType.Float, Offset = 47, Required = false)]
		public double? OfferYield {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 48, Required = false)]
		public DateTime? TransactTime {get; set;}
		
		[TagDetails(Tag = 40, Type = TagType.String, Offset = 49, Required = false)]
		public string? OrdType {get; set;}
		
		[TagDetails(Tag = 642, Type = TagType.Float, Offset = 50, Required = false)]
		public double? BidForwardPoints2 {get; set;}
		
		[TagDetails(Tag = 643, Type = TagType.Float, Offset = 51, Required = false)]
		public double? OfferForwardPoints2 {get; set;}
		
		[TagDetails(Tag = 656, Type = TagType.Float, Offset = 52, Required = false)]
		public double? SettlCurrBidFxRate {get; set;}
		
		[TagDetails(Tag = 657, Type = TagType.Float, Offset = 53, Required = false)]
		public double? SettlCurrOfferFxRate {get; set;}
		
		[TagDetails(Tag = 156, Type = TagType.String, Offset = 54, Required = false)]
		public string? SettlCurrFxRateCalc {get; set;}
		
		[TagDetails(Tag = 13, Type = TagType.String, Offset = 55, Required = false)]
		public string? CommType {get; set;}
		
		[TagDetails(Tag = 12, Type = TagType.Float, Offset = 56, Required = false)]
		public double? Commission {get; set;}
		
		[TagDetails(Tag = 582, Type = TagType.Int, Offset = 57, Required = false)]
		public int? CustOrderCapacity {get; set;}
		
		[TagDetails(Tag = 100, Type = TagType.String, Offset = 58, Required = false)]
		public string? ExDestination {get; set;}
		
		[TagDetails(Tag = 1133, Type = TagType.String, Offset = 59, Required = false)]
		public string? ExDestinationIDSource {get; set;}
		
		[TagDetails(Tag = 297, Type = TagType.Int, Offset = 60, Required = false)]
		public int? QuoteStatus {get; set;}
		
		[TagDetails(Tag = 300, Type = TagType.Int, Offset = 61, Required = false)]
		...
		[TagDetails(Tag = 528, Type = TagType.String, Offset = 67, Required = false)]
		public string? OrderCapacity {get; set;}
		
		[TagDetails(Tag = 529, Type = TagType.String, Offset = 68, Required = false)]
		public string? OrderRestrictions {get; set;}
		
		[Group(NoOfTag = 1063, Offset = 69, Required = false)]
		public QuoteStatusReportTargetParties[]? TargetParties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new QuoteStatusReportParties[count];
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new QuoteStatusReportStipulations[count];
				for (int i = 0; i < count; i++)
				{
					Stipulations[i] = new();
			...
			if (view.GetView("TargetParties") is IMessageView viewTargetParties)
			{
				...
				TargetParties = new QuoteStatusReportTargetParties[count];
				for (int i = 0; i < count; i++)
				{
					TargetParties[i] = new();
