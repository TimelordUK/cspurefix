...
{
	public sealed partial class NewOrderListNoOrders : IFixGroup
	{
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 55, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 56, Required = false, LinksToTag = 2351)]
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 81, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 82, Required = false, LinksToTag = 354)]
