...
{
	public sealed partial class IOINoLegComplexEvents : IFixGroup
	{
		...
		public LegComplexEventDatesComponent? LegComplexEventDates {get; set;}
		...
		public LegComplexEventRateSourceGrpComponent? LegComplexEventRateSourceGrp {get; set;}
		
		[Component(Offset = 30, Required = false)]
		public LegComplexEventRelativeDateComponent? LegComplexEventRelativeDate {get; set;}
		
		[Component(Offset = 31, Required = false)]
		public LegComplexEventPeriodGrpComponent? LegComplexEventPeriodGrp {get; set;}
		...
		public LegComplexEventCreditEventSourceGrpComponent? LegComplexEventCreditEventSourceGrp {get; set;}
		
		[Component(Offset = 38, Required = false)]
		public LegComplexEventCreditEventGrpComponent? LegComplexEventCreditEventGrp {get; set;}
