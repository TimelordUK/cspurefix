...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class LegPaymentStreamPaymentDateBusinessCenterGrpComponent : IFixComponent
	{
		...
		public IOINoLegPaymentStreamPaymentDateBusinessCenters[]? NoLegPaymentStreamPaymentDateBusinessCenters {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegPaymentStreamPaymentDateBusinessCenters") is IMessageView viewNoLegPaymentStreamPaymentDateBusinessCenters)
			{
				...
				NoLegPaymentStreamPaymentDateBusinessCenters = new IOINoLegPaymentStreamPaymentDateBusinessCenters[count];
		...
		{
			NoLegPaymentStreamPaymentDateBusinessCenters = null;
		}
	}
}
