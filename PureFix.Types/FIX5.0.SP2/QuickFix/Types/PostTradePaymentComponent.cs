...
{
	public sealed partial class PostTradePaymentComponent : IFixComponent
	{
		...
		[TagDetails(Tag = 2815, Type = TagType.Length, Offset = 11, Required = false, LinksToTag = 2814)]
		public int? EncodedPostTradePaymentDescLen {get; set;}
		
		[TagDetails(Tag = 2814, Type = TagType.RawData, Offset = 12, Required = false, LinksToTag = 2815)]
		...
		{
			return
				PostTradePaymentType is not null
				&& PostTradePaymentAmount is not null
				&& PostTradePaymentCalculationDate is not null
				&& PostTradePaymentValueDate is not null
				&& PostTradePaymentDebitOrCredit is not null
				&& PostTradePaymentAccount is not null;
		}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedPostTradePaymentDesc is not null)
			{
				writer.WriteWholeNumber(2815, EncodedPostTradePaymentDesc.Length);
				writer.WriteBuffer(2814, EncodedPostTradePaymentDesc);
			}
