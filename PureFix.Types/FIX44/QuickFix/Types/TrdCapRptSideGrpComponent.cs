...
{
	public sealed partial class TrdCapRptSideGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 552, Offset = 0, Required = true)]
		public TradeCaptureReportTrdCapRptSideGrpNoSides[]? NoSides {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoSides") is IMessageView viewNoSides)
			{
				...
				NoSides = new TradeCaptureReportTrdCapRptSideGrpNoSides[count];
