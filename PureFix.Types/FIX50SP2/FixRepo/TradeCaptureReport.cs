...
{
	[MessageType("TradeCaptureReport", FixVersion.FIX50SP2)]
	public sealed partial class TradeCaptureReport : IFixMessage
	{
		...
		[TagDetails(Tag = 487, Type = TagType.Int, Offset = 7, Required = false)]
		public int? TradeReportTransType {get; set;}
		
		[TagDetails(Tag = 856, Type = TagType.Int, Offset = 8, Required = false)]
		public int? TradeReportType {get; set;}
		
		[TagDetails(Tag = 939, Type = TagType.Int, Offset = 9, Required = false)]
		public int? TrdRptStatus {get; set;}
		
		[TagDetails(Tag = 568, Type = TagType.String, Offset = 10, Required = false)]
		...
		[TagDetails(Tag = 855, Type = TagType.Int, Offset = 13, Required = false)]
		public int? SecondaryTrdType {get; set;}
		
		[TagDetails(Tag = 1123, Type = TagType.String, Offset = 14, Required = false)]
		public string? TradeHandlingInstr {get; set;}
		
		[TagDetails(Tag = 1124, Type = TagType.String, Offset = 15, Required = false)]
		public string? OrigTradeHandlingInstr {get; set;}
		
		[TagDetails(Tag = 1125, Type = TagType.LocalDate, Offset = 16, Required = false)]
		public DateOnly? OrigTradeDate {get; set;}
		
		[TagDetails(Tag = 1126, Type = TagType.String, Offset = 17, Required = false)]
		public string? OrigTradeID {get; set;}
		
		[TagDetails(Tag = 1127, Type = TagType.String, Offset = 18, Required = false)]
		public string? OrigSecondaryTradeID {get; set;}
		
		[TagDetails(Tag = 830, Type = TagType.String, Offset = 19, Required = false)]
		public string? TransferReason {get; set;}
		
		[TagDetails(Tag = 150, Type = TagType.String, Offset = 20, Required = false)]
		public string? ExecType {get; set;}
		
		[TagDetails(Tag = 748, Type = TagType.Int, Offset = 21, Required = false)]
		public int? TotNumTradeReports {get; set;}
		
		[TagDetails(Tag = 912, Type = TagType.Boolean, Offset = 22, Required = false)]
		...
		[TagDetails(Tag = 572, Type = TagType.String, Offset = 25, Required = false)]
		public string? TradeReportRefID {get; set;}
		
		[TagDetails(Tag = 881, Type = TagType.String, Offset = 26, Required = false)]
		public string? SecondaryTradeReportRefID {get; set;}
		
		[TagDetails(Tag = 818, Type = TagType.String, Offset = 27, Required = false)]
		public string? SecondaryTradeReportID {get; set;}
		
		[TagDetails(Tag = 820, Type = TagType.String, Offset = 28, Required = false)]
		public string? TradeLinkID {get; set;}
		
		[TagDetails(Tag = 880, Type = TagType.String, Offset = 29, Required = false)]
		public string? TrdMatchID {get; set;}
		
		[TagDetails(Tag = 17, Type = TagType.String, Offset = 30, Required = false)]
		public string? ExecID {get; set;}
		
		[TagDetails(Tag = 527, Type = TagType.String, Offset = 31, Required = false)]
		public string? SecondaryExecID {get; set;}
		
		[TagDetails(Tag = 378, Type = TagType.Int, Offset = 32, Required = false)]
		public int? ExecRestatementReason {get; set;}
		
		[TagDetails(Tag = 570, Type = TagType.Boolean, Offset = 33, Required = false)]
		public bool? PreviouslyReported {get; set;}
		
		[TagDetails(Tag = 423, Type = TagType.Int, Offset = 34, Required = false)]
		public int? PriceType {get; set;}
		
		[Group(NoOfTag = 1031, Offset = 35, Required = false)]
		public TradeCaptureReportRootParties[]? RootParties {get; set;}
		
		[TagDetails(Tag = 1015, Type = TagType.String, Offset = 36, Required = false)]
		public string? AsOfIndicator {get; set;}
		
		[TagDetails(Tag = 716, Type = TagType.String, Offset = 37, Required = false)]
		public string? SettlSessID {get; set;}
		
		[TagDetails(Tag = 717, Type = TagType.String, Offset = 38, Required = false)]
		...
		[TagDetails(Tag = 822, Type = TagType.String, Offset = 44, Required = false)]
		public string? UnderlyingTradingSessionID {get; set;}
		
		[TagDetails(Tag = 823, Type = TagType.String, Offset = 45, Required = false)]
		public string? UnderlyingTradingSessionSubID {get; set;}
		
		[TagDetails(Tag = 32, Type = TagType.Float, Offset = 46, Required = true)]
		public double? LastQty {get; set;}
		
		[TagDetails(Tag = 31, Type = TagType.Float, Offset = 47, Required = true)]
		public double? LastPx {get; set;}
		
		[TagDetails(Tag = 1056, Type = TagType.Float, Offset = 48, Required = false)]
		public double? CalculatedCcyLastQty {get; set;}
		
		[TagDetails(Tag = 15, Type = TagType.String, Offset = 49, Required = false)]
		public string? Currency {get; set;}
		
		[TagDetails(Tag = 120, Type = TagType.String, Offset = 50, Required = false)]
		public string? SettlCurrency {get; set;}
		
		[TagDetails(Tag = 669, Type = TagType.Float, Offset = 51, Required = false)]
		public double? LastParPx {get; set;}
		
		[TagDetails(Tag = 194, Type = TagType.Float, Offset = 52, Required = false)]
		public double? LastSpotRate {get; set;}
		
		[TagDetails(Tag = 195, Type = TagType.Float, Offset = 53, Required = false)]
		...
		[TagDetails(Tag = 30, Type = TagType.String, Offset = 55, Required = false)]
		public string? LastMkt {get; set;}
		
		[TagDetails(Tag = 75, Type = TagType.LocalDate, Offset = 56, Required = false)]
		public DateOnly? TradeDate {get; set;}
		
		[TagDetails(Tag = 715, Type = TagType.LocalDate, Offset = 57, Required = false)]
		public DateOnly? ClearingBusinessDate {get; set;}
		
		[TagDetails(Tag = 6, Type = TagType.Float, Offset = 58, Required = false)]
		public double? AvgPx {get; set;}
		
		[Component(Offset = 59, Required = false)]
		public SpreadOrBenchmarkCurveDataComponent? SpreadOrBenchmarkCurveData {get; set;}
		
		[TagDetails(Tag = 819, Type = TagType.Int, Offset = 60, Required = false)]
		public int? AvgPxIndicator {get; set;}
		
		[Group(NoOfTag = 1014, Offset = 61, Required = false)]
		public TradeCaptureReportPositionAmountData[]? PositionAmountData {get; set;}
		
		[TagDetails(Tag = 442, Type = TagType.String, Offset = 62, Required = false)]
		public string? MultiLegReportingType {get; set;}
		
		[TagDetails(Tag = 824, Type = TagType.String, Offset = 63, Required = false)]
		public string? TradeLegRefID {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 64, Required = false)]
		public DateTime? TransactTime {get; set;}
		
		[Group(NoOfTag = 1020, Offset = 65, Required = false)]
		public TradeCaptureReportTrdRegTimestamps[]? TrdRegTimestamps {get; set;}
		
		[TagDetails(Tag = 63, Type = TagType.String, Offset = 66, Required = false)]
		public string? SettlType {get; set;}
		
		[TagDetails(Tag = 64, Type = TagType.LocalDate, Offset = 67, Required = false)]
		public DateOnly? SettlDate {get; set;}
		
		[TagDetails(Tag = 987, Type = TagType.LocalDate, Offset = 68, Required = false)]
		public DateOnly? UnderlyingSettlementDate {get; set;}
		
		[TagDetails(Tag = 573, Type = TagType.String, Offset = 69, Required = false)]
		public string? MatchStatus {get; set;}
		
		[TagDetails(Tag = 574, Type = TagType.String, Offset = 70, Required = false)]
		public string? MatchType {get; set;}
		
		[TagDetails(Tag = 1188, Type = TagType.Float, Offset = 71, Required = false)]
		public double? Volatility {get; set;}
		
		[TagDetails(Tag = 1380, Type = TagType.Float, Offset = 72, Required = false)]
		public double? DividendYield {get; set;}
		
		[TagDetails(Tag = 1190, Type = TagType.Float, Offset = 73, Required = false)]
		public double? RiskFreeRate {get; set;}
		
		[TagDetails(Tag = 1382, Type = TagType.Float, Offset = 74, Required = false)]
		public double? CurrencyRatio {get; set;}
		
		[TagDetails(Tag = 797, Type = TagType.Boolean, Offset = 75, Required = false)]
		public bool? CopyMsgIndicator {get; set;}
		
		[TagDetails(Tag = 852, Type = TagType.Boolean, Offset = 76, Required = false)]
		public bool? PublishTrdIndicator {get; set;}
		
		[TagDetails(Tag = 1390, Type = TagType.Int, Offset = 77, Required = false)]
		public int? TradePublishIndicator {get; set;}
		
		[TagDetails(Tag = 853, Type = TagType.Int, Offset = 78, Required = false)]
		public int? ShortSaleReason {get; set;}
		
		[TagDetails(Tag = 994, Type = TagType.String, Offset = 79, Required = false)]
		public string? TierCode {get; set;}
		
		[TagDetails(Tag = 1011, Type = TagType.String, Offset = 80, Required = false)]
		public string? MessageEventSource {get; set;}
		
		[TagDetails(Tag = 779, Type = TagType.UtcTimestamp, Offset = 81, Required = false)]
		public DateTime? LastUpdateTime {get; set;}
		
		[TagDetails(Tag = 991, Type = TagType.Float, Offset = 82, Required = false)]
		public double? RndPx {get; set;}
		
		[TagDetails(Tag = 1132, Type = TagType.String, Offset = 83, Required = false)]
		public string? TZTransactTime {get; set;}
		
		[TagDetails(Tag = 1134, Type = TagType.Boolean, Offset = 84, Required = false)]
		public bool? ReportedPxDiff {get; set;}
		
		[TagDetails(Tag = 381, Type = TagType.Float, Offset = 85, Required = false)]
		public double? GrossTradeAmt {get; set;}
		
		[TagDetails(Tag = 1328, Type = TagType.String, Offset = 86, Required = false)]
		public string? RejectText {get; set;}
		
		[TagDetails(Tag = 1329, Type = TagType.Float, Offset = 87, Required = false)]
		public double? FeeMultiplier {get; set;}
		
		[Component(Offset = 88, Required = true)]
		public StandardTrailerComponent? StandardTrailer {get; set;}
		[TagDetails(Tag = 1430, Type = TagType.String, Offset = 89, Required = false)]
		public string? VenueType {get; set;}
		
		[TagDetails(Tag = 1300, Type = TagType.String, Offset = 90, Required = false)]
		public string? MarketSegmentID {get; set;}
		
		[TagDetails(Tag = 1301, Type = TagType.String, Offset = 91, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("RootParties") is IMessageView viewRootParties)
			{
				...
				RootParties = new TradeCaptureReportRootParties[count];
			...
			if (view.GetView("PositionAmountData") is IMessageView viewPositionAmountData)
			{
				...
				PositionAmountData = new TradeCaptureReportPositionAmountData[count];
				for (int i = 0; i < count; i++)
				{
			...
			if (view.GetView("TrdRegTimestamps") is IMessageView viewTrdRegTimestamps)
			{
				...
				TrdRegTimestamps = new TradeCaptureReportTrdRegTimestamps[count];
				for (int i = 0; i < count; i++)
				{
