...
{
	[MessageType("DerivativeSecurityListUpdateReport", FixVersion.FIX50SP2)]
	public sealed partial class DerivativeSecurityListUpdateReport : IFixMessage
	{
		...
		[TagDetails(Tag = 393, Type = TagType.Int, Offset = 8, Required = false)]
		public int? TotNoRelatedSym {get; set;}
		
		[TagDetails(Tag = 893, Type = TagType.Boolean, Offset = 9, Required = false)]
