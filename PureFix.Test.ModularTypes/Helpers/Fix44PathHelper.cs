...
namespace PureFix.Test.ModularTypes.Helpers
{
    public static class Fix44PathHelper
    {
        ...
        public static readonly string FixSimExamplePath = Path.Join(ExampleRootPath, "fixsim-examples.txt");
        ...
        public static readonly string ReplayPreamblePath = Path.Join(ExampleRootPath, "fix-preamble.txt");
