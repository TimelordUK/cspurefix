...
{
	public sealed partial class QuoteAcknowledgementNoQuoteSets : IFixGroup
	{
		...
		public QuoteAcknowledgementNoQuoteEntries[]? NoQuoteEntries {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoQuoteEntries") is IMessageView viewNoQuoteEntries)
			{
				...
				NoQuoteEntries = new QuoteAcknowledgementNoQuoteEntries[count];
