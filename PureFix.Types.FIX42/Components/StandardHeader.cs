...
namespace PureFix.Types.FIX42.Components
{
	public sealed partial class StandardHeader : IFixComponent, IStandardHeader
	{
		...
		[TagDetails(Tag = 9, Type = TagType.Int, Offset = 1, Required = true)]
		...
		[TagDetails(Tag = 370, Type = TagType.UtcTimestamp, Offset = 26, Required = false)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (XmlData is not null) writer.WriteBuffer(213, XmlData);
			...
			if (OnBehalfOfSendingTime is not null) writer.WriteUtcTimeStamp(370, OnBehalfOfSendingTime.Value);
		}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			OnBehalfOfSendingTime = view.GetDateTime(370);
		}
