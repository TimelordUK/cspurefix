...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MarketDataStatisticsRequest : IFixMessage
	{
		...
		public MDStatisticReqGrpComponent? MDStatisticReqGrp {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& MDStatisticReqID is not null
				&& SubscriptionRequestType is not null
				&& MDStatisticReqGrp is not null && ((IFixValidator)MDStatisticReqGrp).IsValid(in config)
