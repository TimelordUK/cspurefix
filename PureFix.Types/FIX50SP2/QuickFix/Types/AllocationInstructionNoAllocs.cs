...
{
	public sealed partial class AllocationInstructionNoAllocs : IFixGroup
	{
		...
		public AllocRegulatoryTradeIDGrpComponent? AllocRegulatoryTradeIDGrp {get; set;}
		...
		[TagDetails(Tag = 360, Type = TagType.Length, Offset = 26, Required = false, LinksToTag = 361)]
		public int? EncodedAllocTextLen {get; set;}
		
		[TagDetails(Tag = 361, Type = TagType.RawData, Offset = 27, Required = false, LinksToTag = 360)]
		...
		[TagDetails(Tag = 1733, Type = TagType.Length, Offset = 29, Required = false, LinksToTag = 1734)]
		public int? EncodedFirmAllocTextLen {get; set;}
		
		[TagDetails(Tag = 1734, Type = TagType.RawData, Offset = 30, Required = false, LinksToTag = 1733)]
		...
		public AllocCommissionDataGrpComponent? AllocCommissionDataGrp {get; set;}
		...
		public TradeAllocAmtGrpComponent? TradeAllocAmtGrp {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedFirmAllocText is not null)
			{
				writer.WriteWholeNumber(1733, EncodedFirmAllocText.Length);
				writer.WriteBuffer(1734, EncodedFirmAllocText);
			}
