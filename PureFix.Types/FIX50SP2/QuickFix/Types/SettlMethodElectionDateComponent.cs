...
{
	public sealed partial class SettlMethodElectionDateComponent : IFixComponent
	{
		...
		public SettlMethodElectionDateBusinessCenterGrpComponent? SettlMethodElectionDateBusinessCenterGrp {get; set;}
