...
namespace PureFix.Types.FIX50SP2.FixRepo.Types
{
	public sealed partial class InstrumentLegComponent : IFixComponent
	{
		...
		[TagDetails(Tag = 607, Type = TagType.Int, Offset = 4, Required = false)]
		public int? LegProduct {get; set;}
		
		[TagDetails(Tag = 608, Type = TagType.String, Offset = 5, Required = false)]
		public string? LegCFICode {get; set;}
		
		[TagDetails(Tag = 609, Type = TagType.String, Offset = 6, Required = false)]
		public string? LegSecurityType {get; set;}
		
		[TagDetails(Tag = 764, Type = TagType.String, Offset = 7, Required = false)]
		...
		[TagDetails(Tag = 1212, Type = TagType.String, Offset = 10, Required = false)]
		...
		[TagDetails(Tag = 999, Type = TagType.String, Offset = 27, Required = false)]
		public string? LegUnitOfMeasure {get; set;}
		
		[TagDetails(Tag = 1224, Type = TagType.Float, Offset = 28, Required = false)]
		public double? LegUnitOfMeasureQty {get; set;}
		
		[TagDetails(Tag = 1421, Type = TagType.String, Offset = 29, Required = false)]
		public string? LegPriceUnitOfMeasure {get; set;}
		
		[TagDetails(Tag = 1422, Type = TagType.Float, Offset = 30, Required = false)]
		public double? LegPriceUnitOfMeasureQty {get; set;}
		
		[TagDetails(Tag = 1001, Type = TagType.String, Offset = 31, Required = false)]
		public string? LegTimeUnit {get; set;}
		
		[TagDetails(Tag = 1420, Type = TagType.Int, Offset = 32, Required = false)]
		public int? LegExerciseStyle {get; set;}
		
		[TagDetails(Tag = 615, Type = TagType.Float, Offset = 33, Required = false)]
		public double? LegCouponRate {get; set;}
		
		[TagDetails(Tag = 616, Type = TagType.String, Offset = 34, Required = false)]
		public string? LegSecurityExchange {get; set;}
		
		[TagDetails(Tag = 617, Type = TagType.String, Offset = 35, Required = false)]
		public string? LegIssuer {get; set;}
		
		[TagDetails(Tag = 618, Type = TagType.Length, Offset = 36, Required = false, LinksToTag = 619)]
		public int? EncodedLegIssuerLen {get; set;}
		
		[TagDetails(Tag = 619, Type = TagType.RawData, Offset = 37, Required = false, LinksToTag = 618)]
		public byte[]? EncodedLegIssuer {get; set;}
		
		[TagDetails(Tag = 620, Type = TagType.String, Offset = 38, Required = false)]
		public string? LegSecurityDesc {get; set;}
		
		[TagDetails(Tag = 621, Type = TagType.Length, Offset = 39, Required = false, LinksToTag = 622)]
		public int? EncodedLegSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 622, Type = TagType.RawData, Offset = 40, Required = false, LinksToTag = 621)]
		public byte[]? EncodedLegSecurityDesc {get; set;}
		
		[TagDetails(Tag = 623, Type = TagType.Float, Offset = 41, Required = false)]
		public double? LegRatioQty {get; set;}
		
		[TagDetails(Tag = 624, Type = TagType.String, Offset = 42, Required = false)]
		public string? LegSide {get; set;}
		
		[TagDetails(Tag = 556, Type = TagType.String, Offset = 43, Required = false)]
		public string? LegCurrency {get; set;}
		
		[TagDetails(Tag = 740, Type = TagType.String, Offset = 44, Required = false)]
		public string? LegPool {get; set;}
		
		[TagDetails(Tag = 739, Type = TagType.LocalDate, Offset = 45, Required = false)]
		public DateOnly? LegDatedDate {get; set;}
		
		[TagDetails(Tag = 955, Type = TagType.MonthYear, Offset = 46, Required = false)]
		public MonthYear? LegContractSettlMonth {get; set;}
		
		[TagDetails(Tag = 956, Type = TagType.LocalDate, Offset = 47, Required = false)]
		public DateOnly? LegInterestAccrualDate {get; set;}
		
		[TagDetails(Tag = 1358, Type = TagType.Int, Offset = 48, Required = false)]
		public int? LegPutOrCall {get; set;}
		
		[TagDetails(Tag = 1017, Type = TagType.Float, Offset = 49, Required = false)]
		public double? LegOptionRatio {get; set;}
		
		[TagDetails(Tag = 566, Type = TagType.Float, Offset = 50, Required = false)]
		public double? LegPrice {get; set;}
		
		[TagDetails(Tag = 1436, Type = TagType.Int, Offset = 51, Required = false)]
		public int? LegContractMultiplierUnit {get; set;}
		
		[TagDetails(Tag = 1440, Type = TagType.Int, Offset = 52, Required = false)]
