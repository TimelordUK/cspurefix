...
{
	public sealed partial class LegPaymentStreamFloatingRateComponent : IFixComponent
	{
		...
		public LegPaymentStreamPricingBusinessCenterGrpComponent? LegPaymentStreamPricingBusinessCenterGrp {get; set;}
		
		[Component(Offset = 54, Required = false)]
		public LegPaymentStreamPricingDayGrpComponent? LegPaymentStreamPricingDayGrp {get; set;}
		
		[Component(Offset = 55, Required = false)]
		public LegPaymentStreamPricingDateGrpComponent? LegPaymentStreamPricingDateGrp {get; set;}
		...
		public LegPaymentStreamFormulaComponent? LegPaymentStreamFormula {get; set;}
		
		[Component(Offset = 67, Required = false)]
		public LegDividendConditionsComponent? LegDividendConditions {get; set;}
		...
		public LegReturnRateGrpComponent? LegReturnRateGrp {get; set;}
