...
{
	public sealed partial class FinancingDetailsComponent : IFixComponent
	{
		...
		public FinancingContractualDefinitionGrpComponent? FinancingContractualDefinitionGrp {get; set;}
		
		[Component(Offset = 12, Required = false)]
		public FinancingTermSupplementGrpComponent? FinancingTermSupplementGrp {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public FinancingContractualMatrixGrpComponent? FinancingContractualMatrixGrp {get; set;}
		...
		[TagDetails(Tag = 1525, Type = TagType.Length, Offset = 19, Required = false, LinksToTag = 1527)]
		public int? EncodedDocumentationTextLen {get; set;}
		
		[TagDetails(Tag = 1527, Type = TagType.RawData, Offset = 20, Required = false, LinksToTag = 1525)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedDocumentationText is not null)
			{
				writer.WriteWholeNumber(1525, EncodedDocumentationText.Length);
				writer.WriteBuffer(1527, EncodedDocumentationText);
			}
