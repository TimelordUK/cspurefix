...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class InstrumentComponent : IFixComponent
	{
		...
		public SecAltIDGrpComponent? SecAltIDGrp {get; set;}
		...
		public SecondaryAssetGrpComponent? SecondaryAssetGrp {get; set;}
		
		[Component(Offset = 34, Required = false)]
		public AssetAttributeGrpComponent? AssetAttributeGrp {get; set;}
		...
		[TagDetails(Tag = 1678, Type = TagType.Length, Offset = 60, Required = false, LinksToTag = 1697)]
		public int? EncodedOptionExpirationDescLen {get; set;}
		
		[TagDetails(Tag = 1697, Type = TagType.RawData, Offset = 61, Required = false, LinksToTag = 1678)]
		...
		[TagDetails(Tag = 348, Type = TagType.Length, Offset = 132, Required = false, LinksToTag = 349)]
		public int? EncodedIssuerLen {get; set;}
		
		[TagDetails(Tag = 349, Type = TagType.RawData, Offset = 133, Required = false, LinksToTag = 348)]
		...
		[TagDetails(Tag = 2715, Type = TagType.Length, Offset = 136, Required = false, LinksToTag = 2716)]
		public int? EncodedFinancialInstrumentFullNameLen {get; set;}
		
		[TagDetails(Tag = 2716, Type = TagType.RawData, Offset = 137, Required = false, LinksToTag = 2715)]
		...
		[TagDetails(Tag = 350, Type = TagType.Length, Offset = 139, Required = false, LinksToTag = 351)]
		public int? EncodedSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 351, Type = TagType.RawData, Offset = 140, Required = false, LinksToTag = 350)]
		...
		public EvntGrpComponent? EvntGrp {get; set;}
		...
		public InstrumentPartiesComponent? InstrumentParties {get; set;}
		...
		public ComplexEventsComponent? ComplexEvents {get; set;}
		...
		public DateAdjustmentComponent? DateAdjustment {get; set;}
		
		[Component(Offset = 162, Required = false)]
		public PricingDateTimeComponent? PricingDateTime {get; set;}
		
		[Component(Offset = 163, Required = false)]
		public MarketDisruptionComponent? MarketDisruption {get; set;}
		
		[Component(Offset = 164, Required = false)]
		public OptionExerciseComponent? OptionExercise {get; set;}
		
		[Component(Offset = 165, Required = false)]
		public StreamGrpComponent? StreamGrp {get; set;}
		
		[Component(Offset = 166, Required = false)]
		public ProvisionGrpComponent? ProvisionGrp {get; set;}
		
		[Component(Offset = 167, Required = false)]
		public AdditionalTermGrpComponent? AdditionalTermGrp {get; set;}
		
		[Component(Offset = 168, Required = false)]
		public ProtectionTermGrpComponent? ProtectionTermGrp {get; set;}
		
		[Component(Offset = 169, Required = false)]
		public CashSettlTermGrpComponent? CashSettlTermGrp {get; set;}
		
		[Component(Offset = 170, Required = false)]
		public PhysicalSettlTermGrpComponent? PhysicalSettlTermGrp {get; set;}
		
		[Component(Offset = 171, Required = false)]
		public ExtraordinaryEventGrpComponent? ExtraordinaryEventGrp {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedOptionExpirationDesc is not null)
			{
				writer.WriteWholeNumber(1678, EncodedOptionExpirationDesc.Length);
				writer.WriteBuffer(1697, EncodedOptionExpirationDesc);
			}
			...
			if (EncodedFinancialInstrumentFullName is not null)
			{
				writer.WriteWholeNumber(2715, EncodedFinancialInstrumentFullName.Length);
				writer.WriteBuffer(2716, EncodedFinancialInstrumentFullName);
			}
