...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class PartyRiskLimitCheckRequestAck : IFixMessage
	{
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 9, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 10, Required = false, LinksToTag = 1664)]
		...
		public RelatedPartyDetailGrpComponent? RelatedPartyDetailGrp {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& RiskLimitCheckRequestStatus is not null
				&& RiskLimitCheckTransType is not null
				&& RiskLimitCheckType is not null
