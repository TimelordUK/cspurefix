...
namespace PureFix.Types.FIX43.Components
{
	public sealed partial class UnderlyingInstrument : IFixComponent
	{
		...
		[TagDetails(Tag = 362, Type = TagType.Length, Offset = 29, Required = false)]
		public int? EncodedUnderlyingIssuerLen {get; set;}
		
		[TagDetails(Tag = 363, Type = TagType.RawData, Offset = 30, Required = false)]
		...
		[TagDetails(Tag = 364, Type = TagType.Length, Offset = 32, Required = false)]
		public int? EncodedUnderlyingSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 365, Type = TagType.RawData, Offset = 33, Required = false)]
