...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class UnderlyingProvisionOptionExerciseFixedDateGrpComponent : IFixComponent
	{
		...
		public IOINoUnderlyingProvisionOptionExerciseFixedDates[]? NoUnderlyingProvisionOptionExerciseFixedDates {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoUnderlyingProvisionOptionExerciseFixedDates") is IMessageView viewNoUnderlyingProvisionOptionExerciseFixedDates)
			{
				...
				NoUnderlyingProvisionOptionExerciseFixedDates = new IOINoUnderlyingProvisionOptionExerciseFixedDates[count];
		...
		{
			NoUnderlyingProvisionOptionExerciseFixedDates = null;
		}
	}
}
