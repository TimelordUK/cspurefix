...
{
	[MessageType("UserRequest", FixVersion.FIX50SP2)]
	public sealed partial class UserRequest : IFixMessage
	{
		...
		[TagDetails(Tag = 1401, Type = TagType.Length, Offset = 7, Required = false, LinksToTag = 1402)]
		public int? EncryptedPasswordLen {get; set;}
		
		[TagDetails(Tag = 1402, Type = TagType.RawData, Offset = 8, Required = false, LinksToTag = 1401)]
		public byte[]? EncryptedPassword {get; set;}
		
		[TagDetails(Tag = 1403, Type = TagType.Length, Offset = 9, Required = false, LinksToTag = 1404)]
		public int? EncryptedNewPasswordLen {get; set;}
		
		[TagDetails(Tag = 1404, Type = TagType.RawData, Offset = 10, Required = false, LinksToTag = 1403)]
		public byte[]? EncryptedNewPassword {get; set;}
		
		[TagDetails(Tag = 95, Type = TagType.Length, Offset = 11, Required = false, LinksToTag = 96)]
		public int? RawDataLength {get; set;}
		
		[TagDetails(Tag = 96, Type = TagType.RawData, Offset = 12, Required = false, LinksToTag = 95)]
