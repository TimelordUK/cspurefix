...
{
	public sealed partial class CrossOrderCancelReplaceRequestNoSides : IFixGroup
	{
		...
		public CrossOrderCancelReplaceRequestNoAllocs[]? NoAllocs {get; set;}
		
		[TagDetails(Tag = 465, Type = TagType.Int, Offset = 14, Required = false)]
		...
		[TagDetails(Tag = 528, Type = TagType.String, Offset = 17, Required = false)]
		public string? OrderCapacity {get; set;}
		
		[TagDetails(Tag = 529, Type = TagType.String, Offset = 18, Required = false)]
		public string? OrderRestrictions {get; set;}
		
		[TagDetails(Tag = 582, Type = TagType.Int, Offset = 19, Required = false)]
		public int? CustOrderCapacity {get; set;}
		
		[TagDetails(Tag = 121, Type = TagType.Boolean, Offset = 20, Required = false)]
		public bool? ForexReq {get; set;}
		
		[TagDetails(Tag = 120, Type = TagType.String, Offset = 21, Required = false)]
		public string? SettlCurrency {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 22, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 23, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 24, Required = false, LinksToTag = 354)]
		public byte[]? EncodedText {get; set;}
		
		[TagDetails(Tag = 77, Type = TagType.String, Offset = 25, Required = false)]
		public string? PositionEffect {get; set;}
		
		[TagDetails(Tag = 203, Type = TagType.Int, Offset = 26, Required = false)]
		public int? CoveredOrUncovered {get; set;}
		
		[TagDetails(Tag = 544, Type = TagType.String, Offset = 27, Required = false)]
		...
		[TagDetails(Tag = 377, Type = TagType.Boolean, Offset = 29, Required = false)]
		public bool? SolicitedFlag {get; set;}
		
		[TagDetails(Tag = 659, Type = TagType.String, Offset = 30, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoAllocs") is IMessageView viewNoAllocs)
			{
				...
				NoAllocs = new CrossOrderCancelReplaceRequestNoAllocs[count];
