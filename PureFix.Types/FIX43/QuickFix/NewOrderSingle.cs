...
namespace PureFix.Types.FIX43.QuickFix
{
	...
	public sealed partial class NewOrderSingle : IFixMessage
	{
		...
		public NewOrderSingleNoAllocs[]? NoAllocs {get; set;}
		...
		[TagDetails(Tag = 544, Type = TagType.String, Offset = 14, Required = false)]
		public string? CashMargin {get; set;}
		
		[TagDetails(Tag = 635, Type = TagType.String, Offset = 15, Required = false)]
		public string? ClearingFeeIndicator {get; set;}
		
		[TagDetails(Tag = 21, Type = TagType.String, Offset = 16, Required = true)]
		public string? HandlInst {get; set;}
		
		[TagDetails(Tag = 18, Type = TagType.String, Offset = 17, Required = false)]
		...
		[Group(NoOfTag = 386, Offset = 21, Required = false)]
		public NewOrderSingleNoTradingSessions[]? NoTradingSessions {get; set;}
		...
		[TagDetails(Tag = 47, Type = TagType.String, Offset = 51, Required = false)]
		public string? Rule80A {get; set;}
		
		[TagDetails(Tag = 121, Type = TagType.Boolean, Offset = 52, Required = false)]
		public bool? ForexReq {get; set;}
		
		[TagDetails(Tag = 120, Type = TagType.String, Offset = 53, Required = false)]
		public string? SettlCurrency {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 54, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 55, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 56, Required = false, LinksToTag = 354)]
		public byte[]? EncodedText {get; set;}
		
		[TagDetails(Tag = 193, Type = TagType.LocalDate, Offset = 57, Required = false)]
		public DateOnly? FutSettDate2 {get; set;}
		
		[TagDetails(Tag = 192, Type = TagType.Float, Offset = 58, Required = false)]
		public double? OrderQty2 {get; set;}
		
		[TagDetails(Tag = 640, Type = TagType.Float, Offset = 59, Required = false)]
		public double? Price2 {get; set;}
		
		[TagDetails(Tag = 77, Type = TagType.String, Offset = 60, Required = false)]
		public string? PositionEffect {get; set;}
		
		[TagDetails(Tag = 203, Type = TagType.Int, Offset = 61, Required = false)]
		public int? CoveredOrUncovered {get; set;}
		
		[TagDetails(Tag = 210, Type = TagType.Float, Offset = 62, Required = false)]
		public double? MaxShow {get; set;}
		
		[TagDetails(Tag = 211, Type = TagType.Float, Offset = 63, Required = false)]
		public double? PegDifference {get; set;}
		
		[TagDetails(Tag = 388, Type = TagType.String, Offset = 64, Required = false)]
		public string? DiscretionInst {get; set;}
		
		[TagDetails(Tag = 389, Type = TagType.Float, Offset = 65, Required = false)]
		public double? DiscretionOffset {get; set;}
		
		[TagDetails(Tag = 480, Type = TagType.String, Offset = 66, Required = false)]
		public string? CancellationRights {get; set;}
		
		[TagDetails(Tag = 481, Type = TagType.String, Offset = 67, Required = false)]
		public string? MoneyLaunderingStatus {get; set;}
		
		[TagDetails(Tag = 513, Type = TagType.String, Offset = 68, Required = false)]
		public string? RegistID {get; set;}
		
		[TagDetails(Tag = 494, Type = TagType.String, Offset = 69, Required = false)]
		public string? Designation {get; set;}
		
		[TagDetails(Tag = 158, Type = TagType.Float, Offset = 70, Required = false)]
		public double? AccruedInterestRate {get; set;}
		
		[TagDetails(Tag = 159, Type = TagType.Float, Offset = 71, Required = false)]
		public double? AccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 118, Type = TagType.Float, Offset = 72, Required = false)]
		public double? NetMoney {get; set;}
		
		[Component(Offset = 73, Required = true)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoAllocs") is IMessageView viewNoAllocs)
			{
				...
				NoAllocs = new NewOrderSingleNoAllocs[count];
			...
			if (view.GetView("NoTradingSessions") is IMessageView viewNoTradingSessions)
			{
				...
				NoTradingSessions = new NewOrderSingleNoTradingSessions[count];
				for (int i = 0; i < count; i++)
				{
