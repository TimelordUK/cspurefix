...
{
	public sealed partial class UnderlyingPaymentStreamFloatingRateComponent : IFixComponent
	{
		...
		public UnderlyingPaymentStreamPricingBusinessCenterGrpComponent? UnderlyingPaymentStreamPricingBusinessCenterGrp {get; set;}
		
		[Component(Offset = 54, Required = false)]
		public UnderlyingPaymentStreamPricingDayGrpComponent? UnderlyingPaymentStreamPricingDayGrp {get; set;}
		
		[Component(Offset = 55, Required = false)]
		public UnderlyingPaymentStreamPricingDateGrpComponent? UnderlyingPaymentStreamPricingDateGrp {get; set;}
		...
		public UnderlyingPaymentStreamFormulaComponent? UnderlyingPaymentStreamFormula {get; set;}
		
		[Component(Offset = 67, Required = false)]
		public UnderlyingDividendConditionsComponent? UnderlyingDividendConditions {get; set;}
		...
		public UnderlyingReturnRateGrpComponent? UnderlyingReturnRateGrp {get; set;}
