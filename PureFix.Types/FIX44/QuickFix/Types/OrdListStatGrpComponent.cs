...
{
	public sealed partial class OrdListStatGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 73, Offset = 0, Required = true)]
		public ListStatusOrdListStatGrpNoOrders[]? NoOrders {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoOrders") is IMessageView viewNoOrders)
			{
				...
				NoOrders = new ListStatusOrdListStatGrpNoOrders[count];
