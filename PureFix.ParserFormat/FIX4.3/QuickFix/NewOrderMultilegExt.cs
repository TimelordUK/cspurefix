...
namespace PureFix.Types.FIX43.QuickFix
{
	...
	public static class NewOrderMultilegExt
	{
		public static void Parse(this NewOrderMultileg instance, MsgView? view)
		{
			...
			instance.NoAllocs = new NewOrderMultilegNoAllocs[countNoAllocs];
			...
			instance.NoTradingSessions = new NewOrderMultilegNoTradingSessions[countNoTradingSessions];
			...
			instance.NoLegs = new NewOrderMultilegNoLegs[countNoLegs];
