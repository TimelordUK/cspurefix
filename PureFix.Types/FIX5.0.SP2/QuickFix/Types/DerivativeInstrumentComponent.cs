...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class DerivativeInstrumentComponent : IFixComponent
	{
		...
		public DerivativeSecurityAltIDGrpComponent? DerivativeSecurityAltIDGrp {get; set;}
		...
		[TagDetails(Tag = 1277, Type = TagType.Length, Offset = 61, Required = false, LinksToTag = 1278)]
		public int? DerivativeEncodedIssuerLen {get; set;}
		
		[TagDetails(Tag = 1278, Type = TagType.RawData, Offset = 62, Required = false, LinksToTag = 1277)]
		...
		[TagDetails(Tag = 1280, Type = TagType.Length, Offset = 64, Required = false, LinksToTag = 1281)]
		public int? DerivativeEncodedSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 1281, Type = TagType.RawData, Offset = 65, Required = false, LinksToTag = 1280)]
		...
		public DerivativeEventsGrpComponent? DerivativeEventsGrp {get; set;}
		
		[Component(Offset = 69, Required = false)]
		public DerivativeInstrumentPartiesComponent? DerivativeInstrumentParties {get; set;}
