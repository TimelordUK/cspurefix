...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class UnderlyingProvisionCashSettlPaymentDateBusinessCenterGrpComponent : IFixComponent
	{
		...
		public IOINoUnderlyingProvisionCashSettlPaymentDateBusinessCenters[]? NoUnderlyingProvisionCashSettlPaymentDateBusinessCenters {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoUnderlyingProvisionCashSettlPaymentDateBusinessCenters") is IMessageView viewNoUnderlyingProvisionCashSettlPaymentDateBusinessCenters)
			{
				...
				NoUnderlyingProvisionCashSettlPaymentDateBusinessCenters = new IOINoUnderlyingProvisionCashSettlPaymentDateBusinessCenters[count];
		...
		{
			NoUnderlyingProvisionCashSettlPaymentDateBusinessCenters = null;
		}
	}
}
