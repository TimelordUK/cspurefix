...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MarketDataStatisticsReport : IFixMessage
	{
		...
		[TagDetails(Tag = 1397, Type = TagType.Length, Offset = 12, Required = false, LinksToTag = 1398)]
		public int? EncodedMktSegmDescLen {get; set;}
		
		[TagDetails(Tag = 1398, Type = TagType.RawData, Offset = 13, Required = false, LinksToTag = 1397)]
		...
		public MDStatisticRptGrpComponent? MDStatisticRptGrp {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& MDStatisticRptID is not null
				&& MDStatisticRptGrp is not null && ((IFixValidator)MDStatisticRptGrp).IsValid(in config)
