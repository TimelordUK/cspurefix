...
{
	public sealed partial class MarketDataSnapshotFullRefreshNoMDEntries : IFixGroup
	{
		[TagDetails(Tag = 269, Type = TagType.String, Offset = 0, Required = true)]
		public string? MDEntryType {get; set;}
		
		[TagDetails(Tag = 278, Type = TagType.String, Offset = 1, Required = false)]
		public string? MDEntryID {get; set;}
		
		[TagDetails(Tag = 270, Type = TagType.Float, Offset = 2, Required = false)]
		public double? MDEntryPx {get; set;}
		
		[TagDetails(Tag = 423, Type = TagType.Int, Offset = 3, Required = false)]
		...
		[TagDetails(Tag = 40, Type = TagType.String, Offset = 8, Required = false)]
		...
		[TagDetails(Tag = 271, Type = TagType.Float, Offset = 14, Required = false)]
		public double? MDEntrySize {get; set;}
		
		[Component(Offset = 15, Required = false)]
		public SecSizesGrpComponent? SecSizesGrp {get; set;}
		
		[TagDetails(Tag = 1093, Type = TagType.String, Offset = 16, Required = false)]
		public string? LotType {get; set;}
		
		[TagDetails(Tag = 272, Type = TagType.UtcDateOnly, Offset = 17, Required = false)]
		public DateOnly? MDEntryDate {get; set;}
		
		[TagDetails(Tag = 273, Type = TagType.UtcTimeOnly, Offset = 18, Required = false)]
		public TimeOnly? MDEntryTime {get; set;}
		
		[TagDetails(Tag = 274, Type = TagType.String, Offset = 19, Required = false)]
		public string? TickDirection {get; set;}
		
		[TagDetails(Tag = 275, Type = TagType.String, Offset = 20, Required = false)]
		...
		[TagDetails(Tag = 326, Type = TagType.Int, Offset = 23, Required = false)]
		...
		[TagDetails(Tag = 2447, Type = TagType.Boolean, Offset = 25, Required = false)]
		public bool? FastMarketIndicator {get; set;}
		
		[TagDetails(Tag = 2705, Type = TagType.Int, Offset = 26, Required = false)]
		...
		public TradePriceConditionGrpComponent? TradePriceConditionGrp {get; set;}
		
		[TagDetails(Tag = 2961, Type = TagType.Boolean, Offset = 30, Required = false)]
		public bool? AnonymousTradeIndicator {get; set;}
		
		[TagDetails(Tag = 2667, Type = TagType.Int, Offset = 31, Required = false)]
		public int? AlgorithmicTradeIndicator {get; set;}
		
		[TagDetails(Tag = 282, Type = TagType.String, Offset = 32, Required = false)]
		public string? MDEntryOriginator {get; set;}
		
		[TagDetails(Tag = 283, Type = TagType.String, Offset = 33, Required = false)]
		public string? LocationID {get; set;}
		
		[TagDetails(Tag = 284, Type = TagType.String, Offset = 34, Required = false)]
		public string? DeskID {get; set;}
		
		[TagDetails(Tag = 286, Type = TagType.String, Offset = 35, Required = false)]
		public string? OpenCloseSettlFlag {get; set;}
		
		[TagDetails(Tag = 59, Type = TagType.String, Offset = 36, Required = false)]
		public string? TimeInForce {get; set;}
		
		[TagDetails(Tag = 432, Type = TagType.LocalDate, Offset = 37, Required = false)]
		public DateOnly? ExpireDate {get; set;}
		
		[TagDetails(Tag = 126, Type = TagType.UtcTimestamp, Offset = 38, Required = false)]
		public DateTime? ExpireTime {get; set;}
		
		[TagDetails(Tag = 1629, Type = TagType.Int, Offset = 39, Required = false)]
		public int? ExposureDuration {get; set;}
		
		[TagDetails(Tag = 1916, Type = TagType.Int, Offset = 40, Required = false)]
		public int? ExposureDurationUnit {get; set;}
		
		[TagDetails(Tag = 110, Type = TagType.Float, Offset = 41, Required = false)]
		public double? MinQty {get; set;}
		
		[TagDetails(Tag = 18, Type = TagType.String, Offset = 42, Required = false)]
		public string? ExecInst {get; set;}
		
		[TagDetails(Tag = 287, Type = TagType.Int, Offset = 43, Required = false)]
		public int? SellerDays {get; set;}
		
		[TagDetails(Tag = 37, Type = TagType.String, Offset = 44, Required = false)]
		public string? OrderID {get; set;}
		
		[TagDetails(Tag = 198, Type = TagType.String, Offset = 45, Required = false)]
		public string? SecondaryOrderID {get; set;}
		
		[TagDetails(Tag = 299, Type = TagType.String, Offset = 46, Required = false)]
		public string? QuoteEntryID {get; set;}
		
		[TagDetails(Tag = 1003, Type = TagType.String, Offset = 47, Required = false)]
		public string? TradeID {get; set;}
		
		[TagDetails(Tag = 1851, Type = TagType.String, Offset = 48, Required = false)]
		public string? StrategyLinkID {get; set;}
		
		[TagDetails(Tag = 288, Type = TagType.String, Offset = 49, Required = false)]
		public string? MDEntryBuyer {get; set;}
		
		[TagDetails(Tag = 289, Type = TagType.String, Offset = 50, Required = false)]
		public string? MDEntrySeller {get; set;}
		
		[TagDetails(Tag = 2449, Type = TagType.Int, Offset = 51, Required = false)]
		public int? NumberOfBuyOrders {get; set;}
		
		[TagDetails(Tag = 2450, Type = TagType.Int, Offset = 52, Required = false)]
		public int? NumberOfSellOrders {get; set;}
		
		[TagDetails(Tag = 346, Type = TagType.Int, Offset = 53, Required = false)]
		public int? NumberOfOrders {get; set;}
		
		[TagDetails(Tag = 290, Type = TagType.Int, Offset = 54, Required = false)]
		public int? MDEntryPositionNo {get; set;}
		
		[TagDetails(Tag = 546, Type = TagType.String, Offset = 55, Required = false)]
		public string? Scope {get; set;}
		
		[TagDetails(Tag = 811, Type = TagType.Float, Offset = 56, Required = false)]
		public double? PriceDelta {get; set;}
		
		[TagDetails(Tag = 828, Type = TagType.Int, Offset = 57, Required = false)]
		public int? TrdType {get; set;}
		
		[TagDetails(Tag = 829, Type = TagType.Int, Offset = 58, Required = false)]
		public int? TrdSubType {get; set;}
		
		[TagDetails(Tag = 855, Type = TagType.Int, Offset = 59, Required = false)]
		public int? SecondaryTrdType {get; set;}
		
		[TagDetails(Tag = 2896, Type = TagType.Int, Offset = 60, Required = false)]
		public int? TertiaryTrdType {get; set;}
		
		[TagDetails(Tag = 1934, Type = TagType.Int, Offset = 61, Required = false)]
		public int? RegulatoryReportType {get; set;}
		
		[TagDetails(Tag = 2963, Type = TagType.Int, Offset = 62, Required = false)]
		public int? MultiJurisdictionReportingIndicator {get; set;}
		
		[TagDetails(Tag = 2405, Type = TagType.Int, Offset = 63, Required = false)]
		public int? ExecMethod {get; set;}
		
		[TagDetails(Tag = 574, Type = TagType.String, Offset = 64, Required = false)]
		public string? MatchType {get; set;}
		
		[TagDetails(Tag = 1115, Type = TagType.String, Offset = 65, Required = false)]
		public string? OrderCategory {get; set;}
		
		[TagDetails(Tag = 1390, Type = TagType.Int, Offset = 66, Required = false)]
		...
		[TagDetails(Tag = 2373, Type = TagType.Boolean, Offset = 68, Required = false)]
		public bool? IntraFirmTradeIndicator {get; set;}
		
		[TagDetails(Tag = 570, Type = TagType.Boolean, Offset = 69, Required = false)]
		public bool? PreviouslyReported {get; set;}
		
		[Component(Offset = 70, Required = false)]
		public RelatedTradeGrpComponent? RelatedTradeGrp {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 71, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 72, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 73, Required = false, LinksToTag = 354)]
		public byte[]? EncodedText {get; set;}
		
		[TagDetails(Tag = 1023, Type = TagType.Int, Offset = 74, Required = false)]
		public int? MDPriceLevel {get; set;}
		
		[TagDetails(Tag = 528, Type = TagType.String, Offset = 75, Required = false)]
		public string? OrderCapacity {get; set;}
		
		[TagDetails(Tag = 1024, Type = TagType.Int, Offset = 76, Required = false)]
		public int? MDOriginType {get; set;}
		
		[TagDetails(Tag = 332, Type = TagType.Float, Offset = 77, Required = false)]
		public double? HighPx {get; set;}
		
		[TagDetails(Tag = 333, Type = TagType.Float, Offset = 78, Required = false)]
		public double? LowPx {get; set;}
		
		[TagDetails(Tag = 1025, Type = TagType.Float, Offset = 79, Required = false)]
		public double? FirstPx {get; set;}
		
		[TagDetails(Tag = 31, Type = TagType.Float, Offset = 80, Required = false)]
		public double? LastPx {get; set;}
		
		[TagDetails(Tag = 1592, Type = TagType.Float, Offset = 81, Required = false)]
		public double? DiscountFactor {get; set;}
		
		[TagDetails(Tag = 1020, Type = TagType.Float, Offset = 82, Required = false)]
		public double? TradeVolume {get; set;}
		
		[Component(Offset = 83, Required = false)]
		public PriceLimitsComponent? PriceLimits {get; set;}
		
		[TagDetails(Tag = 1143, Type = TagType.Float, Offset = 84, Required = false)]
		public double? MaxPriceVariation {get; set;}
		
		[TagDetails(Tag = 731, Type = TagType.Int, Offset = 85, Required = false)]
		public int? SettlPriceType {get; set;}
		
		[TagDetails(Tag = 2451, Type = TagType.Int, Offset = 86, Required = false)]
		public int? SettlPriceDeterminationMethod {get; set;}
		
		[TagDetails(Tag = 63, Type = TagType.String, Offset = 87, Required = false)]
		public string? SettlType {get; set;}
		
		[TagDetails(Tag = 64, Type = TagType.LocalDate, Offset = 88, Required = false)]
		public DateOnly? SettlDate {get; set;}
		
		[TagDetails(Tag = 1070, Type = TagType.Int, Offset = 89, Required = false)]
		public int? MDQuoteType {get; set;}
		
		[TagDetails(Tag = 83, Type = TagType.Int, Offset = 90, Required = false)]
		public int? RptSeq {get; set;}
		
		[TagDetails(Tag = 1048, Type = TagType.String, Offset = 91, Required = false)]
		public string? DealingCapacity {get; set;}
		
		[TagDetails(Tag = 1026, Type = TagType.Float, Offset = 92, Required = false)]
		public double? MDEntrySpotRate {get; set;}
		
		[TagDetails(Tag = 1027, Type = TagType.Float, Offset = 93, Required = false)]
		public double? MDEntryForwardPoints {get; set;}
		
		[Component(Offset = 94, Required = false)]
		public PartiesComponent? Parties {get; set;}
		
		[TagDetails(Tag = 2445, Type = TagType.UtcTimestamp, Offset = 95, Required = false)]
		public DateTime? AggressorTime {get; set;}
		
		[TagDetails(Tag = 2446, Type = TagType.String, Offset = 96, Required = false)]
		public string? AggressorSide {get; set;}
		
		[TagDetails(Tag = 654, Type = TagType.String, Offset = 97, Required = false)]
