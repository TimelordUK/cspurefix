...
{
	public sealed partial class AssignmentReportPositionQty : IFixGroup
	{
		...
		public AssignmentReportNestedParties[]? NestedParties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NestedParties") is IMessageView viewNestedParties)
			{
				...
				NestedParties = new AssignmentReportNestedParties[count];
