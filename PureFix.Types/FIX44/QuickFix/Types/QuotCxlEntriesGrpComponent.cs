...
{
	public sealed partial class QuotCxlEntriesGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 295, Offset = 0, Required = false)]
		public QuoteCancelQuotCxlEntriesGrpNoQuoteEntries[]? NoQuoteEntries {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoQuoteEntries") is IMessageView viewNoQuoteEntries)
			{
				...
				NoQuoteEntries = new QuoteCancelQuotCxlEntriesGrpNoQuoteEntries[count];
