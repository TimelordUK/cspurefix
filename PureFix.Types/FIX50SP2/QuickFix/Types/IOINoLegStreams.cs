...
{
	public sealed partial class IOINoLegStreams : IFixGroup
	{
		...
		public LegStreamCommodityComponent? LegStreamCommodity {get; set;}
		
		[Component(Offset = 19, Required = false)]
		public LegStreamEffectiveDateComponent? LegStreamEffectiveDate {get; set;}
		
		[Component(Offset = 20, Required = false)]
		public LegStreamTerminationDateComponent? LegStreamTerminationDate {get; set;}
		
		[Component(Offset = 21, Required = false)]
		public LegStreamCalculationPeriodDatesComponent? LegStreamCalculationPeriodDates {get; set;}
		
		[Component(Offset = 22, Required = false)]
		public LegPaymentStreamComponent? LegPaymentStream {get; set;}
		
		[Component(Offset = 23, Required = false)]
		public LegPaymentScheduleGrpComponent? LegPaymentScheduleGrp {get; set;}
		
		[Component(Offset = 24, Required = false)]
		public LegPaymentStubGrpComponent? LegPaymentStubGrp {get; set;}
		
		[Component(Offset = 25, Required = false)]
		public LegDeliveryStreamComponent? LegDeliveryStream {get; set;}
		
		[Component(Offset = 26, Required = false)]
		public LegDeliveryScheduleGrpComponent? LegDeliveryScheduleGrp {get; set;}
		
		[TagDetails(Tag = 40248, Type = TagType.String, Offset = 27, Required = false)]
		public string? LegStreamText {get; set;}
		
		[TagDetails(Tag = 40978, Type = TagType.Length, Offset = 28, Required = false, LinksToTag = 40979)]
		public int? EncodedLegStreamTextLen {get; set;}
		
		[TagDetails(Tag = 40979, Type = TagType.RawData, Offset = 29, Required = false, LinksToTag = 40978)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedLegStreamText is not null)
			{
				writer.WriteWholeNumber(40978, EncodedLegStreamText.Length);
				writer.WriteBuffer(40979, EncodedLegStreamText);
			}
		}
