...
namespace PureFix.Types.FIX50SP2.Components
{
	public sealed partial class MDFullGrp : IFixComponent
	{
		public sealed partial class NoMDEntries : IFixGroup
		{
			...
			[TagDetails(Tag = 354, Type = TagType.Length, Offset = 72, Required = false)]
			public int? EncodedTextLen {get; set;}
			
			[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 73, Required = false)]
