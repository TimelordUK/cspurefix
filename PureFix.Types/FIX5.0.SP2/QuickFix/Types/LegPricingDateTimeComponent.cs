...
{
	public sealed partial class LegPricingDateTimeComponent : IFixComponent
	{
		...
		public LegPricingDateBusinessCenterGrpComponent? LegPricingDateBusinessCenterGrp {get; set;}
