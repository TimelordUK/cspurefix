...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class TradeCaptureReportAck : IFixMessage
	{
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 26, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 27, Required = false, LinksToTag = 1664)]
		...
		public TrdCapRptAckSideGrpComponent? TrdCapRptAckSideGrp {get; set;}
