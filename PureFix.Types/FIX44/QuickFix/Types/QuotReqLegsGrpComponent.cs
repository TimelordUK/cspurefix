...
{
	public sealed partial class QuotReqLegsGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 555, Offset = 0, Required = false)]
		public QuoteRequestQuotReqGrpNoRelatedSymQuotReqLegsGrpNoLegs[]? NoLegs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegs") is IMessageView viewNoLegs)
			{
				...
				NoLegs = new QuoteRequestQuotReqGrpNoRelatedSymQuotReqLegsGrpNoLegs[count];
