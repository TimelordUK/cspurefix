...
{
	public sealed partial class IOINoUnderlyingMarketDisruptionFallbackReferencePrices : IFixGroup
	{
		...
		[TagDetails(Tag = 41873, Type = TagType.Length, Offset = 4, Required = false, LinksToTag = 41874)]
		public int? EncodedUnderlyingMarketDisruptionFallbackUnderlierSecDescLen {get; set;}
		
		[TagDetails(Tag = 41874, Type = TagType.RawData, Offset = 5, Required = false, LinksToTag = 41873)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedUnderlyingMarketDisruptionFallbackUnderlierSecurityDesc is not null)
			{
				writer.WriteWholeNumber(41873, EncodedUnderlyingMarketDisruptionFallbackUnderlierSecurityDesc.Length);
				writer.WriteBuffer(41874, EncodedUnderlyingMarketDisruptionFallbackUnderlierSecurityDesc);
			}
