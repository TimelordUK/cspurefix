...
{
	public sealed partial class LegDividendConditionsComponent : IFixComponent
	{
		...
		public LegDividendPeriodGrpComponent? LegDividendPeriodGrp {get; set;}
		...
		public LegDividendFXTriggerDateComponent? LegDividendFXTriggerDate {get; set;}
		
		[Component(Offset = 10, Required = false)]
		public LegDividendAccrualFloatingRateComponent? LegDividendAccrualFloatingRate {get; set;}
		
		[TagDetails(Tag = 42345, Type = TagType.Float, Offset = 11, Required = false)]
		public double? LegDividendAccrualFixedRate {get; set;}
		
		[Component(Offset = 12, Required = false)]
		public LegDividendAccrualPaymentDateComponent? LegDividendAccrualPaymentDate {get; set;}
