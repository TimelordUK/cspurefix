...
{
	[MessageType("CollateralInquiry", FixVersion.FIX50SP2)]
	public sealed partial class CollateralInquiry : IFixMessage
	{
		...
		[TagDetails(Tag = 725, Type = TagType.Int, Offset = 3, Required = false)]
		public int? ResponseTransportType {get; set;}
		
		[TagDetails(Tag = 726, Type = TagType.String, Offset = 4, Required = false)]
		public string? ResponseDestination {get; set;}
		
		[Group(NoOfTag = 1012, Offset = 5, Required = false)]
		public CollateralInquiryParties[]? Parties {get; set;}
		...
		[TagDetails(Tag = 899, Type = TagType.Float, Offset = 20, Required = false)]
		public double? MarginExcess {get; set;}
		
		[TagDetails(Tag = 900, Type = TagType.Float, Offset = 21, Required = false)]
		public double? TotalNetValue {get; set;}
		
		[TagDetails(Tag = 901, Type = TagType.Float, Offset = 22, Required = false)]
		public double? CashOutstanding {get; set;}
		
		[Group(NoOfTag = 1020, Offset = 23, Required = false)]
		public CollateralInquiryTrdRegTimestamps[]? TrdRegTimestamps {get; set;}
		
		[TagDetails(Tag = 54, Type = TagType.String, Offset = 24, Required = false)]
		...
		[TagDetails(Tag = 920, Type = TagType.Float, Offset = 28, Required = false)]
		public double? EndAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 921, Type = TagType.Float, Offset = 29, Required = false)]
		public double? StartCash {get; set;}
		
		[TagDetails(Tag = 922, Type = TagType.Float, Offset = 30, Required = false)]
		...
		[Group(NoOfTag = 1019, Offset = 32, Required = false)]
		public CollateralInquiryStipulations[]? Stipulations {get; set;}
		...
		[TagDetails(Tag = 716, Type = TagType.String, Offset = 36, Required = false)]
		public string? SettlSessID {get; set;}
		
		[TagDetails(Tag = 717, Type = TagType.String, Offset = 37, Required = false)]
		public string? SettlSessSubID {get; set;}
		
		[TagDetails(Tag = 715, Type = TagType.LocalDate, Offset = 38, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new CollateralInquiryParties[count];
			...
			if (view.GetView("TrdRegTimestamps") is IMessageView viewTrdRegTimestamps)
			{
				...
				TrdRegTimestamps = new CollateralInquiryTrdRegTimestamps[count];
				for (int i = 0; i < count; i++)
				{
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new CollateralInquiryStipulations[count];
				for (int i = 0; i < count; i++)
				{
					Stipulations[i] = new();
