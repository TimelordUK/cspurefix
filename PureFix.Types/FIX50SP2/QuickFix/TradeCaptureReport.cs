...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class TradeCaptureReport : IFixMessage
	{
		...
		public CollateralAmountGrpComponent? CollateralAmountGrp {get; set;}
		...
		public TransactionAttributeGrpComponent? TransactionAttributeGrp {get; set;}
		...
		public AveragePriceDetailComponent? AveragePriceDetail {get; set;}
		...
		public TradeQtyGrpComponent? TradeQtyGrp {get; set;}
		
		[Component(Offset = 121, Required = true)]
		public TrdCapRptSideGrpComponent? TrdCapRptSideGrp {get; set;}
		...
		public TrdRepIndicatorsGrpComponent? TrdRepIndicatorsGrp {get; set;}
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 145, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 146, Required = false, LinksToTag = 1664)]
		...
		public MandatoryClearingJurisdictionGrpComponent? MandatoryClearingJurisdictionGrp {get; set;}
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 173, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 174, Required = false, LinksToTag = 2372)]
		...
		public AttachmentGrpComponent? AttachmentGrp {get; set;}
