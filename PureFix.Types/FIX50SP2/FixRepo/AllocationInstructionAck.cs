...
{
	[MessageType("AllocationInstructionAck", FixVersion.FIX50SP2)]
	public sealed partial class AllocationInstructionAck : IFixMessage
	{
		...
		public AllocationInstructionAckParties[]? Parties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new AllocationInstructionAckParties[count];
