...
{
	[MessageType("BV", FixVersion.FIX50SP2)]
	public sealed partial class MarketDefinitionUpdateReport : IFixMessage
	{
		...
		[TagDetails(Tag = 2542, Type = TagType.Int, Offset = 11, Required = false)]
		public int? MarketSegmentStatus {get; set;}
		
		[TagDetails(Tag = 2543, Type = TagType.Int, Offset = 12, Required = false)]
		public int? MarketSegmentType {get; set;}
		
		[TagDetails(Tag = 2544, Type = TagType.Int, Offset = 13, Required = false)]
		public int? MarketSegmentSubType {get; set;}
		
		[Component(Offset = 14, Required = false)]
		public InstrumentScopeGrpComponent? InstrumentScopeGrp {get; set;}
		
		[Component(Offset = 15, Required = false)]
		public RelatedMarketSegmentGrpComponent? RelatedMarketSegmentGrp {get; set;}
		...
		public OrdTypeRulesComponent? OrdTypeRules {get; set;}
		
		[Component(Offset = 20, Required = false)]
		public TimeInForceRulesComponent? TimeInForceRules {get; set;}
		
		[Component(Offset = 21, Required = false)]
		public ExecInstRulesComponent? ExecInstRules {get; set;}
		
		[Component(Offset = 22, Required = false)]
		public AuctionTypeRuleGrpComponent? AuctionTypeRuleGrp {get; set;}
		
		[Component(Offset = 23, Required = false)]
		public MarketDataFeedTypesComponent? MarketDataFeedTypes {get; set;}
		
		[Component(Offset = 24, Required = false)]
		public MatchRulesComponent? MatchRules {get; set;}
		
		[Component(Offset = 25, Required = false)]
		public FlexProductEligibilityGrpComponent? FlexProductEligibilityGrp {get; set;}
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 30, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 31, Required = false, LinksToTag = 354)]
