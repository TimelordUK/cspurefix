...
namespace PureFix.Types.FIX44.QuickFix.Types
{
	public sealed partial class UnderlyingStipulationsComponent : IFixComponent
	{
		...
		public IOIUndInstrmtGrpNoUnderlyingsUnderlyingInstrumentUnderlyingStipulationsNoUnderlyingStips[]? NoUnderlyingStips {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoUnderlyingStips") is IMessageView viewNoUnderlyingStips)
			{
				...
				NoUnderlyingStips = new IOIUndInstrmtGrpNoUnderlyingsUnderlyingInstrumentUnderlyingStipulationsNoUnderlyingStips[count];
