...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class Quote : IFixMessage
	{
		...
		public QuoteAttributeGrpComponent? QuoteAttributeGrp {get; set;}
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 94, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 95, Required = false, LinksToTag = 2372)]
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 101, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 102, Required = false, LinksToTag = 2351)]
		public byte[]? EncodedComplianceText {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 103, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 104, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 105, Required = false, LinksToTag = 354)]
