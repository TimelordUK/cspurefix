...
{
	public sealed partial class TradeCaptureReportAckNoSides : IFixGroup
	{
		...
		[TagDetails(Tag = 1506, Type = TagType.String, Offset = 2, Required = false)]
		public string? SideTradeID {get; set;}
		
		[TagDetails(Tag = 1507, Type = TagType.String, Offset = 3, Required = false)]
		public string? SideOrigTradeID {get; set;}
		
		[TagDetails(Tag = 1428, Type = TagType.Int, Offset = 4, Required = false)]
		public int? OrderDelay {get; set;}
		
		[TagDetails(Tag = 1429, Type = TagType.Int, Offset = 5, Required = false)]
		...
		public LimitAmtsComponent? LimitAmts {get; set;}
		
		[TagDetails(Tag = 81, Type = TagType.String, Offset = 11, Required = false)]
		public string? ProcessCode {get; set;}
		
		[TagDetails(Tag = 575, Type = TagType.Boolean, Offset = 12, Required = false)]
		public bool? OddLot {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public ClrInstGrpComponent? ClrInstGrp {get; set;}
		
		[TagDetails(Tag = 2671, Type = TagType.Int, Offset = 14, Required = false)]
		...
		[TagDetails(Tag = 2404, Type = TagType.String, Offset = 18, Required = false)]
		public string? ComplianceText {get; set;}
		
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 19, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 20, Required = false, LinksToTag = 2351)]
		public byte[]? EncodedComplianceText {get; set;}
		
		[TagDetails(Tag = 377, Type = TagType.Boolean, Offset = 21, Required = false)]
		public bool? SolicitedFlag {get; set;}
		
		[TagDetails(Tag = 582, Type = TagType.Int, Offset = 22, Required = false)]
		...
		[TagDetails(Tag = 943, Type = TagType.String, Offset = 25, Required = false)]
		public string? TimeBracket {get; set;}
		
		[TagDetails(Tag = 430, Type = TagType.Int, Offset = 26, Required = false)]
		public int? NetGrossInd {get; set;}
		
		[TagDetails(Tag = 1154, Type = TagType.String, Offset = 27, Required = false)]
		public string? SideCurrency {get; set;}
		
		[TagDetails(Tag = 2901, Type = TagType.String, Offset = 28, Required = false)]
		public string? SideCurrencyCodeSource {get; set;}
		
		[TagDetails(Tag = 1155, Type = TagType.String, Offset = 29, Required = false)]
		public string? SideSettlCurrency {get; set;}
		
		[TagDetails(Tag = 2902, Type = TagType.String, Offset = 30, Required = false)]
		...
		[TagDetails(Tag = 157, Type = TagType.Int, Offset = 33, Required = false)]
		public int? NumDaysInterest {get; set;}
		
		[TagDetails(Tag = 230, Type = TagType.LocalDate, Offset = 34, Required = false)]
		public DateOnly? ExDate {get; set;}
		
		[TagDetails(Tag = 158, Type = TagType.Float, Offset = 35, Required = false)]
		public double? AccruedInterestRate {get; set;}
		
		[TagDetails(Tag = 159, Type = TagType.Float, Offset = 36, Required = false)]
		public double? AccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 738, Type = TagType.Float, Offset = 37, Required = false)]
		public double? InterestAtMaturity {get; set;}
		
		[TagDetails(Tag = 920, Type = TagType.Float, Offset = 38, Required = false)]
		public double? EndAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 921, Type = TagType.Float, Offset = 39, Required = false)]
		public double? StartCash {get; set;}
		
		[TagDetails(Tag = 922, Type = TagType.Float, Offset = 40, Required = false)]
		public double? EndCash {get; set;}
		
		[TagDetails(Tag = 238, Type = TagType.Float, Offset = 41, Required = false)]
		public double? Concession {get; set;}
		
		[TagDetails(Tag = 237, Type = TagType.Float, Offset = 42, Required = false)]
		public double? TotalTakedown {get; set;}
		
		[TagDetails(Tag = 118, Type = TagType.Float, Offset = 43, Required = false)]
		public double? NetMoney {get; set;}
		
		[TagDetails(Tag = 119, Type = TagType.Float, Offset = 44, Required = false)]
		public double? SettlCurrAmt {get; set;}
		
		[TagDetails(Tag = 155, Type = TagType.Float, Offset = 45, Required = false)]
		public double? SettlCurrFxRate {get; set;}
		
		[TagDetails(Tag = 156, Type = TagType.String, Offset = 46, Required = false)]
		public string? SettlCurrFxRateCalc {get; set;}
		
		[TagDetails(Tag = 77, Type = TagType.String, Offset = 47, Required = false)]
		public string? PositionEffect {get; set;}
		
		[TagDetails(Tag = 752, Type = TagType.Int, Offset = 48, Required = false)]
		...
		[TagDetails(Tag = 825, Type = TagType.String, Offset = 52, Required = false)]
		public string? ExchangeRule {get; set;}
		
		[Component(Offset = 53, Required = false)]
		public SettlDetailsComponent? SettlDetails {get; set;}
		
		[TagDetails(Tag = 826, Type = TagType.Int, Offset = 54, Required = false)]
		public int? TradeAllocIndicator {get; set;}
		
		[TagDetails(Tag = 1730, Type = TagType.String, Offset = 55, Required = false)]
		public string? AllocGroupID {get; set;}
		
		[TagDetails(Tag = 2771, Type = TagType.String, Offset = 56, Required = false)]
		public string? PreviousAllocGroupID {get; set;}
		
		[TagDetails(Tag = 2759, Type = TagType.Float, Offset = 57, Required = false)]
		public double? GroupAmount {get; set;}
		
		[TagDetails(Tag = 2767, Type = TagType.Int, Offset = 58, Required = false)]
		public int? AllocGroupStatus {get; set;}
		
		[TagDetails(Tag = 1853, Type = TagType.Int, Offset = 59, Required = false)]
		public int? SideAvgPxIndicator {get; set;}
		
		[TagDetails(Tag = 1854, Type = TagType.String, Offset = 60, Required = false)]
		public string? SideAvgPxGroupID {get; set;}
		
		[TagDetails(Tag = 1852, Type = TagType.Float, Offset = 61, Required = false)]
		public double? SideAvgPx {get; set;}
		
		[TagDetails(Tag = 591, Type = TagType.String, Offset = 62, Required = false)]
		public string? PreallocMethod {get; set;}
		
		[TagDetails(Tag = 70, Type = TagType.String, Offset = 63, Required = false)]
		public string? AllocID {get; set;}
		
		[Component(Offset = 64, Required = false)]
		public TrdAllocGrpComponent? TrdAllocGrp {get; set;}
		
		[TagDetails(Tag = 1072, Type = TagType.Float, Offset = 65, Required = false)]
		public double? SideGrossTradeAmt {get; set;}
		
		[TagDetails(Tag = 1057, Type = TagType.Boolean, Offset = 66, Required = false)]
		public bool? AggressorIndicator {get; set;}
		
		[TagDetails(Tag = 1009, Type = TagType.Float, Offset = 67, Required = false)]
		public double? SideLastQty {get; set;}
		
		[TagDetails(Tag = 1005, Type = TagType.String, Offset = 68, Required = false)]
		public string? SideTradeReportID {get; set;}
		
		[TagDetails(Tag = 1006, Type = TagType.String, Offset = 69, Required = false)]
		public string? SideFillStationCd {get; set;}
		
		[TagDetails(Tag = 1007, Type = TagType.String, Offset = 70, Required = false)]
		public string? SideReasonCd {get; set;}
		
		[TagDetails(Tag = 83, Type = TagType.Int, Offset = 71, Required = false)]
		public int? RptSeq {get; set;}
		
		[TagDetails(Tag = 1008, Type = TagType.Int, Offset = 72, Required = false)]
		public int? SideTrdSubType {get; set;}
		
		[TagDetails(Tag = 1115, Type = TagType.String, Offset = 73, Required = false)]
		public string? OrderCategory {get; set;}
		
		[TagDetails(Tag = 1851, Type = TagType.String, Offset = 74, Required = false)]
		public string? StrategyLinkID {get; set;}
		
		[Component(Offset = 75, Required = false)]
		public TradeReportOrderDetailComponent? TradeReportOrderDetail {get; set;}
		
		[Component(Offset = 76, Required = false)]
		public SideTrdRegTSComponent? SideTrdRegTS {get; set;}
		
		[TagDetails(Tag = 1031, Type = TagType.String, Offset = 77, Required = false)]
		public string? CustOrderHandlingInst {get; set;}
		
		[TagDetails(Tag = 1032, Type = TagType.Int, Offset = 78, Required = false)]
		...
		public RelatedPositionGrpComponent? RelatedPositionGrp {get; set;}
		
		[TagDetails(Tag = 2344, Type = TagType.Int, Offset = 81, Required = false)]
