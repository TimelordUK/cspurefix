...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MarketDefinition : IFixMessage
	{
		...
		[TagDetails(Tag = 1397, Type = TagType.Length, Offset = 7, Required = false, LinksToTag = 1398)]
		public int? EncodedMktSegmDescLen {get; set;}
		
		[TagDetails(Tag = 1398, Type = TagType.RawData, Offset = 8, Required = false, LinksToTag = 1397)]
