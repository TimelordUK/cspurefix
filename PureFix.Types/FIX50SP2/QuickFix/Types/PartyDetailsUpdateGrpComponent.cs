...
{
	public sealed partial class PartyDetailsUpdateGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 1676, Offset = 0, Required = false)]
		public PartyDetailsListUpdateReportNoPartyUpdates[]? NoPartyUpdates {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoPartyUpdates") is IMessageView viewNoPartyUpdates)
			{
				...
				NoPartyUpdates = new PartyDetailsListUpdateReportNoPartyUpdates[count];
