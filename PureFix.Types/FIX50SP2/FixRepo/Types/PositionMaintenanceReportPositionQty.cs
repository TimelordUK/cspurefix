...
{
	public sealed partial class PositionMaintenanceReportPositionQty : IFixGroup
	{
		...
		public PositionMaintenanceReportNestedParties[]? NestedParties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NestedParties") is IMessageView viewNestedParties)
			{
				...
				NestedParties = new PositionMaintenanceReportNestedParties[count];
