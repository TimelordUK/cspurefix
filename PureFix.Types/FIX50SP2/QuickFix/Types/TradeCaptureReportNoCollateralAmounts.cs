...
{
	public sealed partial class TradeCaptureReportNoCollateralAmounts : IFixGroup
	{
		...
		public CollateralReinvestmentGrpComponent? CollateralReinvestmentGrp {get; set;}
