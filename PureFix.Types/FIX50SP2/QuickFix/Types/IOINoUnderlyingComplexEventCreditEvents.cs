...
{
	public sealed partial class IOINoUnderlyingComplexEventCreditEvents : IFixGroup
	{
		...
		public UnderlyingComplexEventCreditEventQualifierGrpComponent? UnderlyingComplexEventCreditEventQualifierGrp {get; set;}
