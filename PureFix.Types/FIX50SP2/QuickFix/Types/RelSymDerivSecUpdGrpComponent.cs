...
{
	public sealed partial class RelSymDerivSecUpdGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 146, Offset = 0, Required = false)]
		public DerivativeSecurityListUpdateReportNoRelatedSym[]? NoRelatedSym {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoRelatedSym") is IMessageView viewNoRelatedSym)
			{
				...
				NoRelatedSym = new DerivativeSecurityListUpdateReportNoRelatedSym[count];
