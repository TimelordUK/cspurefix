...
namespace PureFix.Types.FIX50SP2
{
	...
	public sealed partial class AllocationReport : IFixMessage
	{
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 28, Required = false)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 29, Required = false)]
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 79, Required = false)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 80, Required = false)]
