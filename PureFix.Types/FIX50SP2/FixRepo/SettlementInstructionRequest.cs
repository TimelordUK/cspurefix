...
{
	[MessageType("SettlementInstructionRequest", FixVersion.FIX50SP2)]
	public sealed partial class SettlementInstructionRequest : IFixMessage
	{
		...
		public SettlementInstructionRequestParties[]? Parties {get; set;}
		...
		[TagDetails(Tag = 120, Type = TagType.String, Offset = 10, Required = false)]
		...
		[TagDetails(Tag = 169, Type = TagType.Int, Offset = 14, Required = false)]
		public int? StandInstDbType {get; set;}
		
		[TagDetails(Tag = 170, Type = TagType.String, Offset = 15, Required = false)]
		public string? StandInstDbName {get; set;}
		
		[TagDetails(Tag = 171, Type = TagType.String, Offset = 16, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new SettlementInstructionRequestParties[count];
