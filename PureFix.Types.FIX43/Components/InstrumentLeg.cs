...
namespace PureFix.Types.FIX43.Components
{
	public sealed partial class InstrumentLeg : IFixComponent
	{
		...
		[TagDetails(Tag = 618, Type = TagType.Length, Offset = 28, Required = false)]
		public int? EncodedLegIssuerLen {get; set;}
		
		[TagDetails(Tag = 619, Type = TagType.RawData, Offset = 29, Required = false)]
		...
		[TagDetails(Tag = 621, Type = TagType.Length, Offset = 31, Required = false)]
		public int? EncodedLegSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 622, Type = TagType.RawData, Offset = 32, Required = false)]
