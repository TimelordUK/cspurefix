...
{
	public sealed partial class IOINoReturnRateDates : IFixGroup
	{
		[TagDetails(Tag = 42710, Type = TagType.Int, Offset = 0, Required = false)]
		public int? ReturnRateDateMode {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public ReturnRateValuationDateGrpComponent? ReturnRateValuationDateGrp {get; set;}
		...
		public ReturnRateValuationDateBusinessCenterGrpComponent? ReturnRateValuationDateBusinessCenterGrp {get; set;}
