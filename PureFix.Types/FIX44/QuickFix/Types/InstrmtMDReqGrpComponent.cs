...
{
	public sealed partial class InstrmtMDReqGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 146, Offset = 0, Required = true)]
		public MarketDataRequestInstrmtMDReqGrpNoRelatedSym[]? NoRelatedSym {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoRelatedSym") is IMessageView viewNoRelatedSym)
			{
				...
				NoRelatedSym = new MarketDataRequestInstrmtMDReqGrpNoRelatedSym[count];
