...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class QuoteRequestNoRelatedSym : IFixGroup
	{
		...
		public QuotReqLegsGrpComponent? QuotReqLegsGrp {get; set;}
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 54, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 55, Required = false, LinksToTag = 2372)]
