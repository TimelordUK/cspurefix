...
{
	[MessageType("AllocationReport", FixVersion.FIX50SP2)]
	public sealed partial class AllocationReport : IFixMessage
	{
		...
		[TagDetails(Tag = 715, Type = TagType.LocalDate, Offset = 15, Required = false)]
		...
		[TagDetails(Tag = 442, Type = TagType.String, Offset = 18, Required = false)]
		public string? MultiLegReportingType {get; set;}
		
		[TagDetails(Tag = 582, Type = TagType.Int, Offset = 19, Required = false)]
		public int? CustOrderCapacity {get; set;}
		
		[TagDetails(Tag = 578, Type = TagType.String, Offset = 20, Required = false)]
		public string? TradeInputSource {get; set;}
		
		[TagDetails(Tag = 991, Type = TagType.Float, Offset = 21, Required = false)]
		public double? RndPx {get; set;}
		
		[TagDetails(Tag = 1011, Type = TagType.String, Offset = 22, Required = false)]
		public string? MessageEventSource {get; set;}
		
		[TagDetails(Tag = 579, Type = TagType.String, Offset = 23, Required = false)]
		public string? TradeInputDevice {get; set;}
		
		[TagDetails(Tag = 819, Type = TagType.Int, Offset = 24, Required = false)]
		public int? AvgPxIndicator {get; set;}
		
		[TagDetails(Tag = 857, Type = TagType.Int, Offset = 25, Required = false)]
		public int? AllocNoOrdersType {get; set;}
		
		[TagDetails(Tag = 570, Type = TagType.Boolean, Offset = 26, Required = false)]
		public bool? PreviouslyReported {get; set;}
		
		[TagDetails(Tag = 700, Type = TagType.Boolean, Offset = 27, Required = false)]
		public bool? ReversalIndicator {get; set;}
		
		[TagDetails(Tag = 574, Type = TagType.String, Offset = 28, Required = false)]
		...
		[TagDetails(Tag = 53, Type = TagType.Float, Offset = 35, Required = true)]
		public double? Quantity {get; set;}
		
		[TagDetails(Tag = 854, Type = TagType.Int, Offset = 36, Required = false)]
		public int? QtyType {get; set;}
		
		[TagDetails(Tag = 30, Type = TagType.String, Offset = 37, Required = false)]
		public string? LastMkt {get; set;}
		
		[TagDetails(Tag = 229, Type = TagType.LocalDate, Offset = 38, Required = false)]
		public DateOnly? TradeOriginationDate {get; set;}
		
		[TagDetails(Tag = 336, Type = TagType.String, Offset = 39, Required = false)]
		public string? TradingSessionID {get; set;}
		
		[TagDetails(Tag = 625, Type = TagType.String, Offset = 40, Required = false)]
		public string? TradingSessionSubID {get; set;}
		
		[TagDetails(Tag = 423, Type = TagType.Int, Offset = 41, Required = false)]
		public int? PriceType {get; set;}
		
		[TagDetails(Tag = 6, Type = TagType.Float, Offset = 42, Required = true)]
		public double? AvgPx {get; set;}
		
		[TagDetails(Tag = 860, Type = TagType.Float, Offset = 43, Required = false)]
		...
		[TagDetails(Tag = 74, Type = TagType.Int, Offset = 46, Required = false)]
		public int? AvgPxPrecision {get; set;}
		
		[Group(NoOfTag = 1012, Offset = 47, Required = false)]
		public AllocationReportParties[]? Parties {get; set;}
		
		[TagDetails(Tag = 75, Type = TagType.LocalDate, Offset = 48, Required = true)]
		public DateOnly? TradeDate {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 49, Required = false)]
		...
		[Group(NoOfTag = 1019, Offset = 71, Required = false)]
		public AllocationReportStipulations[]? Stipulations {get; set;}
		
		[Component(Offset = 72, Required = false)]
		public YieldDataComponent? YieldData {get; set;}
		
		[Group(NoOfTag = 1014, Offset = 73, Required = false)]
		public AllocationReportPositionAmountData[]? PositionAmountData {get; set;}
		...
		[Group(NoOfTag = 1062, Offset = 77, Required = false)]
		public AllocationReportRateSource[]? RateSource {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new AllocationReportParties[count];
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new AllocationReportStipulations[count];
				for (int i = 0; i < count; i++)
				{
					Stipulations[i] = new();
			...
			if (view.GetView("PositionAmountData") is IMessageView viewPositionAmountData)
			{
				...
				PositionAmountData = new AllocationReportPositionAmountData[count];
				for (int i = 0; i < count; i++)
				{
			...
			if (view.GetView("RateSource") is IMessageView viewRateSource)
			{
				...
				RateSource = new AllocationReportRateSource[count];
				for (int i = 0; i < count; i++)
				{
					RateSource[i] = new();
