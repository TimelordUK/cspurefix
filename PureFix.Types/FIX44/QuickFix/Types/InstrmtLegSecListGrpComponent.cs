...
{
	public sealed partial class InstrmtLegSecListGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 555, Offset = 0, Required = false)]
		public SecurityListSecListGrpNoRelatedSymInstrmtLegSecListGrpNoLegs[]? NoLegs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegs") is IMessageView viewNoLegs)
			{
				...
				NoLegs = new SecurityListSecListGrpNoRelatedSymInstrmtLegSecListGrpNoLegs[count];
