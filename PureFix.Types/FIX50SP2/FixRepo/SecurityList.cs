...
{
	[MessageType("SecurityList", FixVersion.FIX50SP2)]
	public sealed partial class SecurityList : IFixMessage
	{
		...
		[TagDetails(Tag = 560, Type = TagType.Int, Offset = 6, Required = false)]
		...
		[TagDetails(Tag = 893, Type = TagType.Boolean, Offset = 10, Required = false)]
		public bool? LastFragment {get; set;}
		
		[Component(Offset = 11, Required = true)]
		public StandardTrailerComponent? StandardTrailer {get; set;}
		[TagDetails(Tag = 1465, Type = TagType.String, Offset = 12, Required = false)]
		public string? SecurityListID {get; set;}
		
		[TagDetails(Tag = 1466, Type = TagType.String, Offset = 13, Required = false)]
		public string? SecurityListRefID {get; set;}
		
		[TagDetails(Tag = 1467, Type = TagType.String, Offset = 14, Required = false)]
		public string? SecurityListDesc {get; set;}
		
		[TagDetails(Tag = 1468, Type = TagType.Length, Offset = 15, Required = false, LinksToTag = 1469)]
		public int? EncodedSecurityListDescLen {get; set;}
		
		[TagDetails(Tag = 1469, Type = TagType.RawData, Offset = 16, Required = false, LinksToTag = 1468)]
		public byte[]? EncodedSecurityListDesc {get; set;}
		
		[TagDetails(Tag = 1470, Type = TagType.Int, Offset = 17, Required = false)]
		public int? SecurityListType {get; set;}
		
		[TagDetails(Tag = 1471, Type = TagType.Int, Offset = 18, Required = false)]
