...
{
	public sealed partial class UndInstrmtStrkPxGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 711, Offset = 0, Required = false)]
		public ListStrikePriceUndInstrmtStrkPxGrpNoUnderlyings[]? NoUnderlyings {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoUnderlyings") is IMessageView viewNoUnderlyings)
			{
				...
				NoUnderlyings = new ListStrikePriceUndInstrmtStrkPxGrpNoUnderlyings[count];
