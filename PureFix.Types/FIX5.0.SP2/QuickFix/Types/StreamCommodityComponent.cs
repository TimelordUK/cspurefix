...
{
	public sealed partial class StreamCommodityComponent : IFixComponent
	{
		...
		public StreamCommodityAltIDGrpComponent? StreamCommodityAltIDGrp {get; set;}
		
		[TagDetails(Tag = 41255, Type = TagType.String, Offset = 5, Required = false)]
		public string? StreamCommodityDesc {get; set;}
		
		[TagDetails(Tag = 41256, Type = TagType.Length, Offset = 6, Required = false, LinksToTag = 41257)]
		public int? EncodedStreamCommodityDescLen {get; set;}
		
		[TagDetails(Tag = 41257, Type = TagType.RawData, Offset = 7, Required = false, LinksToTag = 41256)]
		...
		public StreamAssetAttributeGrpComponent? StreamAssetAttributeGrp {get; set;}
		...
		public StreamCommodityDataSourceGrpComponent? StreamCommodityDataSourceGrp {get; set;}
		...
		public StreamCommoditySettlBusinessCenterGrpComponent? StreamCommoditySettlBusinessCenterGrp {get; set;}
		...
		public StreamCommoditySettlPeriodGrpComponent? StreamCommoditySettlPeriodGrp {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedStreamCommodityDesc is not null)
			{
				writer.WriteWholeNumber(41256, EncodedStreamCommodityDesc.Length);
				writer.WriteBuffer(41257, EncodedStreamCommodityDesc);
			}
