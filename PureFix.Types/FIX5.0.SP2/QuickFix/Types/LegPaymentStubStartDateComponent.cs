...
{
	public sealed partial class LegPaymentStubStartDateComponent : IFixComponent
	{
		...
		public LegPaymentStubStartDateBusinessCenterGrpComponent? LegPaymentStubStartDateBusinessCenterGrp {get; set;}
