...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class MarketDataIncrementalRefreshNoMDEntries : IFixGroup
	{
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 87, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 88, Required = false, LinksToTag = 354)]
		...
		public StatsIndGrpComponent? StatsIndGrp {get; set;}
