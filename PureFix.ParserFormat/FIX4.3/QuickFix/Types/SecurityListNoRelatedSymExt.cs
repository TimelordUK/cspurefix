...
{
	public static class SecurityListNoRelatedSymExt
	{
		public static void Parse(this SecurityListNoRelatedSym instance, MsgView? view)
		{
			...
			instance.NoLegs = new SecurityListNoRelatedSymNoLegs[countNoLegs];
