...
{
	public sealed partial class UnderlyingDateAdjustmentComponent : IFixComponent
	{
		[TagDetails(Tag = 40964, Type = TagType.Int, Offset = 0, Required = false)]
		public int? UnderlyingBusinessDayConvention {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public UnderlyingBusinessCenterGrpComponent? UnderlyingBusinessCenterGrp {get; set;}
