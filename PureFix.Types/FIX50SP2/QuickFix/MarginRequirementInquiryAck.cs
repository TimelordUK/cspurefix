...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class MarginRequirementInquiryAck : IFixMessage
	{
		...
		public MarginReqmtInqQualGrpComponent? MarginReqmtInqQualGrp {get; set;}
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& MarginReqmtInqID is not null
				&& MarginReqmtInqQualGrp is not null && ((IFixValidator)MarginReqmtInqQualGrp).IsValid(in config)
				&& MarginReqmtInqStatus is not null
