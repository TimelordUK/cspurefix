...
{
	public sealed partial class IOINoLegStreamCommoditySettlPeriods : IFixGroup
	{
		...
		public LegStreamCommoditySettlDayGrpComponent? LegStreamCommoditySettlDayGrp {get; set;}
