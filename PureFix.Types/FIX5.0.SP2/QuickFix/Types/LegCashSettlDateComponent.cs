...
{
	public sealed partial class LegCashSettlDateComponent : IFixComponent
	{
		...
		public LegCashSettlDateBusinessCenterGrpComponent? LegCashSettlDateBusinessCenterGrp {get; set;}
