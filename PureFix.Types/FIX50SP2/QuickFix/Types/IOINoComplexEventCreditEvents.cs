...
{
	public sealed partial class IOINoComplexEventCreditEvents : IFixGroup
	{
		...
		public ComplexEventCreditEventQualifierGrpComponent? ComplexEventCreditEventQualifierGrp {get; set;}
