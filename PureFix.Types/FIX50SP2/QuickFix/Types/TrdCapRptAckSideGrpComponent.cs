...
{
	public sealed partial class TrdCapRptAckSideGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 552, Offset = 0, Required = false)]
		public TradeCaptureReportAckNoSides[]? NoSides {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoSides") is IMessageView viewNoSides)
			{
				...
				NoSides = new TradeCaptureReportAckNoSides[count];
