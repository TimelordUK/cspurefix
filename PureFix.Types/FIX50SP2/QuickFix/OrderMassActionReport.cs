...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class OrderMassActionReport : IFixMessage
	{
		...
		public AffectedOrdGrpComponent? AffectedOrdGrp {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public NotAffectedOrdGrpComponent? NotAffectedOrdGrp {get; set;}
		
		[Component(Offset = 14, Required = false)]
		public AffectedMarketSegmentGrpComponent? AffectedMarketSegmentGrp {get; set;}
		
		[Component(Offset = 15, Required = false)]
		public NotAffectedMarketSegmentGrpComponent? NotAffectedMarketSegmentGrp {get; set;}
		...
		public TargetMarketSegmentGrpComponent? TargetMarketSegmentGrp {get; set;}
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 30, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 31, Required = false, LinksToTag = 2351)]
		public byte[]? EncodedComplianceText {get; set;}
		
		[TagDetails(Tag = 58, Type = TagType.String, Offset = 32, Required = false)]
		public string? Text {get; set;}
		
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 33, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 34, Required = false, LinksToTag = 354)]
