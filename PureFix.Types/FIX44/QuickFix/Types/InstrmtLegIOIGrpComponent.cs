...
{
	public sealed partial class InstrmtLegIOIGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 555, Offset = 0, Required = false)]
		public IOIInstrmtLegIOIGrpNoLegs[]? NoLegs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegs") is IMessageView viewNoLegs)
			{
				...
				NoLegs = new IOIInstrmtLegIOIGrpNoLegs[count];
