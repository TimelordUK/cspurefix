...
{
	public sealed partial class RelatedOrderGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 73, Offset = 0, Required = false)]
		public ExecutionReportNoOrders[]? NoOrders {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoOrders") is IMessageView viewNoOrders)
			{
				...
				NoOrders = new ExecutionReportNoOrders[count];
