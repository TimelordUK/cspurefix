...
namespace PureFix.Types.FIX43
{
	...
	public sealed partial class RegistrationInstructionsResponse : IFixMessage
	{
		...
		[TagDetails(Tag = 506, Type = TagType.String, Offset = 7, Required = true)]
		public string? RegistStatus {get; set;}
		
		[TagDetails(Tag = 507, Type = TagType.Int, Offset = 8, Required = false)]
		public int? RegistRejReasonCode {get; set;}
		
		[TagDetails(Tag = 496, Type = TagType.String, Offset = 9, Required = false)]
