...
{
	[MessageType("3", FixVersion.FIXT11)]
	public sealed partial class Reject : IFixMessage
	{
		...
		[TagDetails(Tag = 1130, Type = TagType.String, Offset = 4, Required = false)]
		public string? RefApplVerID {get; set;}
		
		[TagDetails(Tag = 1406, Type = TagType.Int, Offset = 5, Required = false)]
		public int? RefApplExtID {get; set;}
		
		[TagDetails(Tag = 1131, Type = TagType.String, Offset = 6, Required = false)]
		public string? RefCstmApplVerID {get; set;}
		
		[TagDetails(Tag = 373, Type = TagType.Int, Offset = 7, Required = false)]
