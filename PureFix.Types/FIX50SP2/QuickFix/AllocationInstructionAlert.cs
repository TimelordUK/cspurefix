...
{
	[MessageType("BM", FixVersion.FIX50SP2)]
	public sealed partial class AllocationInstructionAlert : IFixMessage
	{
		...
		[TagDetails(Tag = 2758, Type = TagType.String, Offset = 4, Required = false)]
		...
		[TagDetails(Tag = 53, Type = TagType.Float, Offset = 26, Required = false)]
		public double? Quantity {get; set;}
		
		[TagDetails(Tag = 854, Type = TagType.Int, Offset = 27, Required = false)]
		public int? QtyType {get; set;}
		
		[TagDetails(Tag = 1736, Type = TagType.Float, Offset = 28, Required = false)]
		public double? AllocGroupQuantity {get; set;}
		
		[TagDetails(Tag = 1737, Type = TagType.Float, Offset = 29, Required = false)]
		public double? AllocGroupRemainingQuantity {get; set;}
		
		[TagDetails(Tag = 2759, Type = TagType.Float, Offset = 30, Required = false)]
		public double? GroupAmount {get; set;}
		
		[TagDetails(Tag = 2760, Type = TagType.Float, Offset = 31, Required = false)]
		public double? GroupRemainingAmount {get; set;}
		
		[TagDetails(Tag = 30, Type = TagType.String, Offset = 32, Required = false)]
		public string? LastMkt {get; set;}
		
		[TagDetails(Tag = 229, Type = TagType.LocalDate, Offset = 33, Required = false)]
		public DateOnly? TradeOriginationDate {get; set;}
		
		[TagDetails(Tag = 336, Type = TagType.String, Offset = 34, Required = false)]
		public string? TradingSessionID {get; set;}
		
		[TagDetails(Tag = 625, Type = TagType.String, Offset = 35, Required = false)]
		...
		[TagDetails(Tag = 6, Type = TagType.Float, Offset = 38, Required = false)]
		public double? AvgPx {get; set;}
		
		[TagDetails(Tag = 860, Type = TagType.Float, Offset = 39, Required = false)]
		public double? AvgParPx {get; set;}
		
		[TagDetails(Tag = 332, Type = TagType.Float, Offset = 40, Required = false)]
		public double? HighPx {get; set;}
		
		[TagDetails(Tag = 333, Type = TagType.Float, Offset = 41, Required = false)]
		...
		[TagDetails(Tag = 2897, Type = TagType.String, Offset = 44, Required = false)]
		public string? CurrencyCodeSource {get; set;}
		
		[TagDetails(Tag = 74, Type = TagType.Int, Offset = 45, Required = false)]
		public int? AvgPxPrecision {get; set;}
		
		[Component(Offset = 46, Required = false)]
		public PartiesComponent? Parties {get; set;}
		
		[TagDetails(Tag = 75, Type = TagType.LocalDate, Offset = 47, Required = true)]
		public DateOnly? TradeDate {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 48, Required = false)]
		public DateTime? TransactTime {get; set;}
		
		[TagDetails(Tag = 87, Type = TagType.Int, Offset = 49, Required = false)]
		...
		[TagDetails(Tag = 775, Type = TagType.Int, Offset = 52, Required = false)]
		public int? BookingType {get; set;}
		
		[TagDetails(Tag = 381, Type = TagType.Float, Offset = 53, Required = false)]
		public double? GrossTradeAmt {get; set;}
		
		[TagDetails(Tag = 238, Type = TagType.Float, Offset = 54, Required = false)]
		public double? Concession {get; set;}
		
		[TagDetails(Tag = 237, Type = TagType.Float, Offset = 55, Required = false)]
		public double? TotalTakedown {get; set;}
		
		[TagDetails(Tag = 118, Type = TagType.Float, Offset = 56, Required = false)]
		public double? NetMoney {get; set;}
		
		[TagDetails(Tag = 77, Type = TagType.String, Offset = 57, Required = false)]
		public string? PositionEffect {get; set;}
		
		[TagDetails(Tag = 754, Type = TagType.Boolean, Offset = 58, Required = false)]
		...
		[TagDetails(Tag = 157, Type = TagType.Int, Offset = 62, Required = false)]
		public int? NumDaysInterest {get; set;}
		
		[TagDetails(Tag = 158, Type = TagType.Float, Offset = 63, Required = false)]
		public double? AccruedInterestRate {get; set;}
		
		[TagDetails(Tag = 159, Type = TagType.Float, Offset = 64, Required = false)]
		public double? AccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 540, Type = TagType.Float, Offset = 65, Required = false)]
		public double? TotalAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 738, Type = TagType.Float, Offset = 66, Required = false)]
		public double? InterestAtMaturity {get; set;}
		
		[TagDetails(Tag = 920, Type = TagType.Float, Offset = 67, Required = false)]
		public double? EndAccruedInterestAmt {get; set;}
		
		[TagDetails(Tag = 921, Type = TagType.Float, Offset = 68, Required = false)]
		public double? StartCash {get; set;}
		
		[TagDetails(Tag = 922, Type = TagType.Float, Offset = 69, Required = false)]
		public double? EndCash {get; set;}
		
		[TagDetails(Tag = 650, Type = TagType.Boolean, Offset = 70, Required = false)]
		...
		[TagDetails(Tag = 892, Type = TagType.Int, Offset = 74, Required = false)]
		public int? TotNoAllocs {get; set;}
		
		[TagDetails(Tag = 893, Type = TagType.Boolean, Offset = 75, Required = false)]
		public bool? LastFragment {get; set;}
		
		[Component(Offset = 76, Required = false)]
		public AllocGrpComponent? AllocGrp {get; set;}
		
		[TagDetails(Tag = 819, Type = TagType.Int, Offset = 77, Required = false)]
		public int? AvgPxIndicator {get; set;}
		
		[TagDetails(Tag = 1731, Type = TagType.String, Offset = 78, Required = false)]
		public string? AvgPxGroupID {get; set;}
		
		[TagDetails(Tag = 715, Type = TagType.LocalDate, Offset = 79, Required = false)]
		public DateOnly? ClearingBusinessDate {get; set;}
		
		[TagDetails(Tag = 828, Type = TagType.Int, Offset = 80, Required = false)]
		public int? TrdType {get; set;}
		
		[TagDetails(Tag = 829, Type = TagType.Int, Offset = 81, Required = false)]
		...
		[TagDetails(Tag = 1031, Type = TagType.String, Offset = 87, Required = false)]
		public string? CustOrderHandlingInst {get; set;}
		
		[TagDetails(Tag = 1032, Type = TagType.Int, Offset = 88, Required = false)]
		public int? OrderHandlingInstSource {get; set;}
		
		[Component(Offset = 89, Required = true)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (GroupRemainingAmount is not null) writer.WriteNumber(2760, GroupRemainingAmount.Value);
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			GroupRemainingAmount = view.GetDouble(2760);
		...
		bool IFixLookup.TryGetByTag(string name, out object? value)
		{
			...
			switch (name)
			{
				...
				case "GroupAmount":
					value = GroupAmount;
					break;
				case "GroupRemainingAmount":
					value = GroupRemainingAmount;
					break;
				case "LastMkt":
					value = LastMkt;
					break;
