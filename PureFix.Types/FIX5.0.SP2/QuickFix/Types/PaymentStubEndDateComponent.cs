...
{
	public sealed partial class PaymentStubEndDateComponent : IFixComponent
	{
		...
		public PaymentStubEndDateBusinessCenterGrpComponent? PaymentStubEndDateBusinessCenterGrp {get; set;}
