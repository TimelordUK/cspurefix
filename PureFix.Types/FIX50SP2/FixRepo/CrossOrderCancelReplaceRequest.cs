...
{
	[MessageType("CrossOrderCancelReplaceRequest", FixVersion.FIX50SP2)]
	public sealed partial class CrossOrderCancelReplaceRequest : IFixMessage
	{
		...
		[TagDetails(Tag = 961, Type = TagType.String, Offset = 4, Required = false)]
		public string? HostCrossID {get; set;}
		
		[TagDetails(Tag = 549, Type = TagType.Int, Offset = 5, Required = true)]
		public int? CrossType {get; set;}
		
		[TagDetails(Tag = 550, Type = TagType.Int, Offset = 6, Required = true)]
		public int? CrossPrioritization {get; set;}
		
		[Group(NoOfTag = 1031, Offset = 7, Required = false)]
		public CrossOrderCancelReplaceRequestRootParties[]? RootParties {get; set;}
		...
		[TagDetails(Tag = 21, Type = TagType.String, Offset = 13, Required = false)]
		public string? HandlInst {get; set;}
		
		[TagDetails(Tag = 18, Type = TagType.String, Offset = 14, Required = false)]
		public string? ExecInst {get; set;}
		
		[TagDetails(Tag = 110, Type = TagType.Float, Offset = 15, Required = false)]
		public double? MinQty {get; set;}
		
		[TagDetails(Tag = 1089, Type = TagType.Float, Offset = 16, Required = false)]
		public double? MatchIncrement {get; set;}
		
		[TagDetails(Tag = 1090, Type = TagType.Int, Offset = 17, Required = false)]
		...
		[TagDetails(Tag = 111, Type = TagType.Float, Offset = 19, Required = false)]
		public double? MaxFloor {get; set;}
		
		[TagDetails(Tag = 100, Type = TagType.String, Offset = 20, Required = false)]
		public string? ExDestination {get; set;}
		
		[TagDetails(Tag = 1133, Type = TagType.String, Offset = 21, Required = false)]
		public string? ExDestinationIDSource {get; set;}
		
		[TagDetails(Tag = 81, Type = TagType.String, Offset = 22, Required = false)]
		public string? ProcessCode {get; set;}
		
		[TagDetails(Tag = 140, Type = TagType.Float, Offset = 23, Required = false)]
		public double? PrevClosePx {get; set;}
		
		[TagDetails(Tag = 114, Type = TagType.Boolean, Offset = 24, Required = false)]
		public bool? LocateReqd {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 25, Required = true)]
		public DateTime? TransactTime {get; set;}
		
		[TagDetails(Tag = 483, Type = TagType.UtcTimestamp, Offset = 26, Required = false)]
		public DateTime? TransBkdTime {get; set;}
		
		[Group(NoOfTag = 1019, Offset = 27, Required = false)]
		public CrossOrderCancelReplaceRequestStipulations[]? Stipulations {get; set;}
		
		[TagDetails(Tag = 40, Type = TagType.String, Offset = 28, Required = true)]
		...
		[TagDetails(Tag = 1092, Type = TagType.String, Offset = 31, Required = false)]
		public string? PriceProtectionScope {get; set;}
		
		[TagDetails(Tag = 99, Type = TagType.Float, Offset = 32, Required = false)]
		...
		[TagDetails(Tag = 15, Type = TagType.String, Offset = 36, Required = false)]
		public string? Currency {get; set;}
		
		[TagDetails(Tag = 376, Type = TagType.String, Offset = 37, Required = false)]
		public string? ComplianceID {get; set;}
		
		[TagDetails(Tag = 23, Type = TagType.String, Offset = 38, Required = false)]
		public string? IOIID {get; set;}
		
		[TagDetails(Tag = 117, Type = TagType.String, Offset = 39, Required = false)]
		public string? QuoteID {get; set;}
		
		[TagDetails(Tag = 59, Type = TagType.String, Offset = 40, Required = false)]
		public string? TimeInForce {get; set;}
		
		[TagDetails(Tag = 168, Type = TagType.UtcTimestamp, Offset = 41, Required = false)]
		public DateTime? EffectiveTime {get; set;}
		
		[TagDetails(Tag = 432, Type = TagType.LocalDate, Offset = 42, Required = false)]
		public DateOnly? ExpireDate {get; set;}
		
		[TagDetails(Tag = 126, Type = TagType.UtcTimestamp, Offset = 43, Required = false)]
		public DateTime? ExpireTime {get; set;}
		
		[TagDetails(Tag = 427, Type = TagType.Int, Offset = 44, Required = false)]
		public int? GTBookingInst {get; set;}
		
		[TagDetails(Tag = 210, Type = TagType.Float, Offset = 45, Required = false)]
		...
		[TagDetails(Tag = 480, Type = TagType.String, Offset = 51, Required = false)]
		public string? CancellationRights {get; set;}
		
		[TagDetails(Tag = 481, Type = TagType.String, Offset = 52, Required = false)]
		public string? MoneyLaunderingStatus {get; set;}
		
		[TagDetails(Tag = 513, Type = TagType.String, Offset = 53, Required = false)]
		public string? RegistID {get; set;}
		
		[TagDetails(Tag = 494, Type = TagType.String, Offset = 54, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("RootParties") is IMessageView viewRootParties)
			{
				...
				RootParties = new CrossOrderCancelReplaceRequestRootParties[count];
			...
			if (view.GetView("Stipulations") is IMessageView viewStipulations)
			{
				...
				Stipulations = new CrossOrderCancelReplaceRequestStipulations[count];
				for (int i = 0; i < count; i++)
				{
					Stipulations[i] = new();
