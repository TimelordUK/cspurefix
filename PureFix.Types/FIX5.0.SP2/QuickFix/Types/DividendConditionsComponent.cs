...
{
	public sealed partial class DividendConditionsComponent : IFixComponent
	{
		...
		public DividendPeriodGrpComponent? DividendPeriodGrp {get; set;}
		...
		public DividendFXTriggerDateComponent? DividendFXTriggerDate {get; set;}
		
		[Component(Offset = 10, Required = false)]
		public DividendAccrualFloatingRateComponent? DividendAccrualFloatingRate {get; set;}
		
		[TagDetails(Tag = 42253, Type = TagType.Float, Offset = 11, Required = false)]
		public double? DividendAccrualFixedRate {get; set;}
		
		[Component(Offset = 12, Required = false)]
		public DividendAccrualPaymentDateComponent? DividendAccrualPaymentDate {get; set;}
