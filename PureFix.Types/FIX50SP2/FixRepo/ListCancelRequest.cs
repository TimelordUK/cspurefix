...
{
	[MessageType("ListCancelRequest", FixVersion.FIX50SP2)]
	public sealed partial class ListCancelRequest : IFixMessage
	{
		...
		public ListCancelRequestParties[]? Parties {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 3, Required = true)]
		public DateTime? TransactTime {get; set;}
		
		[TagDetails(Tag = 229, Type = TagType.LocalDate, Offset = 4, Required = false)]
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("Parties") is IMessageView viewParties)
			{
				...
				Parties = new ListCancelRequestParties[count];
