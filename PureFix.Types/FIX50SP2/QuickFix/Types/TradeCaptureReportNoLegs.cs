...
{
	public sealed partial class TradeCaptureReportNoLegs : IFixGroup
	{
		...
		public LegPositionAmountDataComponent? LegPositionAmountData {get; set;}
		...
		public TradeCapLegUnderlyingsGrpComponent? TradeCapLegUnderlyingsGrp {get; set;}
