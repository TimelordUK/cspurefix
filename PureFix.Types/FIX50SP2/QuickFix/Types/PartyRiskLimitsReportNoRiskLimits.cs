...
{
	public sealed partial class PartyRiskLimitsReportNoRiskLimits : IFixGroup
	{
		[Component(Offset = 0, Required = false)]
		public RiskLimitTypesGrpComponent? RiskLimitTypesGrp {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public RiskInstrumentScopeGrpComponent? RiskInstrumentScopeGrp {get; set;}
