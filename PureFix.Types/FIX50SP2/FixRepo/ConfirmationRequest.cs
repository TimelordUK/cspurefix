...
{
	[MessageType("ConfirmationRequest", FixVersion.FIX50SP2)]
	public sealed partial class ConfirmationRequest : IFixMessage
	{
		...
		[TagDetails(Tag = 70, Type = TagType.String, Offset = 3, Required = false)]
		...
		[TagDetails(Tag = 79, Type = TagType.String, Offset = 7, Required = false)]
		public string? AllocAccount {get; set;}
		
		[TagDetails(Tag = 661, Type = TagType.Int, Offset = 8, Required = false)]
		public int? AllocAcctIDSource {get; set;}
		
		[TagDetails(Tag = 798, Type = TagType.Int, Offset = 9, Required = false)]
