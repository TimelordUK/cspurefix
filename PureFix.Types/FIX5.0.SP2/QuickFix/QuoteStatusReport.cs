...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class QuoteStatusReport : IFixMessage
	{
		...
		public LegQuotStatGrpComponent? LegQuotStatGrp {get; set;}
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 85, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 86, Required = false, LinksToTag = 1664)]
		...
		[TagDetails(Tag = 2372, Type = TagType.Length, Offset = 89, Required = false, LinksToTag = 2371)]
		public int? EncodedTradeContinuationTextLen {get; set;}
		
		[TagDetails(Tag = 2371, Type = TagType.RawData, Offset = 90, Required = false, LinksToTag = 2372)]
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 93, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 94, Required = false, LinksToTag = 354)]
