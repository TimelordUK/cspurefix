...
namespace PureFix.Types.FIX43.QuickFix.Types
{
	public sealed partial class AllocationNoAllocs : IFixGroup
	{
		...
		[TagDetails(Tag = 360, Type = TagType.Length, Offset = 9, Required = false, LinksToTag = 361)]
		public int? EncodedAllocTextLen {get; set;}
		
		[TagDetails(Tag = 361, Type = TagType.RawData, Offset = 10, Required = false, LinksToTag = 360)]
