...
{
	public sealed partial class SecurityXMLComponent : IFixComponent
	{
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (SecurityXML is not null) writer.WriteString(1185, SecurityXML);
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			SecurityXML = view.GetString(1185);
