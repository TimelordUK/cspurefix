...
{
	[MessageType("TradeCaptureReportRequestAck", FixVersion.FIX50SP2)]
	public sealed partial class TradeCaptureReportRequestAck : IFixMessage
	{
		...
		[TagDetails(Tag = 442, Type = TagType.String, Offset = 14, Required = false)]
		...
		[TagDetails(Tag = 1011, Type = TagType.String, Offset = 20, Required = false)]
