...
namespace PureFix.Types.FIX42.QuickFix.Types
{
	public sealed partial class NewOrderListNoOrders : IFixGroup
	{
		...
		public NewOrderListNoAllocs[]? NoAllocs {get; set;}
		...
		public NewOrderListNoTradingSessions[]? NoTradingSessions {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoAllocs") is IMessageView viewNoAllocs)
			{
				...
				NoAllocs = new NewOrderListNoAllocs[count];
			...
			if (view.GetView("NoTradingSessions") is IMessageView viewNoTradingSessions)
			{
				...
				NoTradingSessions = new NewOrderListNoTradingSessions[count];
				for (int i = 0; i < count; i++)
				{
