...
namespace PureFix.Types.FIX44.QuickFix.Types
{
	public sealed partial class NestedParties3Component : IFixComponent
	{
		...
		public NewOrderMultilegPreAllocMlegGrpNoAllocsNestedParties3NoNested3PartyIDs[]? NoNested3PartyIDs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoNested3PartyIDs") is IMessageView viewNoNested3PartyIDs)
			{
				...
				NoNested3PartyIDs = new NewOrderMultilegPreAllocMlegGrpNoAllocsNestedParties3NoNested3PartyIDs[count];
