...
{
	public sealed partial class StrmAsgnRptInstrmtGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 146, Offset = 0, Required = false)]
		public StreamAssignmentReportNoRelatedSym[]? NoRelatedSym {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoRelatedSym") is IMessageView viewNoRelatedSym)
			{
				...
				NoRelatedSym = new StreamAssignmentReportNoRelatedSym[count];
