...
{
	[MessageType("CG", FixVersion.FIX50SP2)]
	public sealed partial class PartyDetailsListReport : IFixMessage
	{
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 13, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 14, Required = false, LinksToTag = 1664)]
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& PartyDetailsListReportID is not null
