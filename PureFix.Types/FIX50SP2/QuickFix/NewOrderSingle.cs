...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class NewOrderSingle : IFixMessage
	{
		...
		[TagDetails(Tag = 2829, Type = TagType.Boolean, Offset = 5, Required = false)]
		...
		public TargetPartiesComponent? TargetParties {get; set;}
		...
		[TagDetails(Tag = 1805, Type = TagType.Int, Offset = 24, Required = false)]
		public int? AuctionInstruction {get; set;}
		
		[TagDetails(Tag = 110, Type = TagType.Float, Offset = 25, Required = false)]
		public double? MinQty {get; set;}
		
		[TagDetails(Tag = 1822, Type = TagType.Int, Offset = 26, Required = false)]
		public int? MinQtyMethod {get; set;}
		
		[TagDetails(Tag = 1089, Type = TagType.Float, Offset = 27, Required = false)]
		public double? MatchIncrement {get; set;}
		
		[TagDetails(Tag = 1090, Type = TagType.Int, Offset = 28, Required = false)]
		public int? MaxPriceLevels {get; set;}
		
		[TagDetails(Tag = 2676, Type = TagType.Float, Offset = 29, Required = false)]
		public double? MaximumPriceDeviation {get; set;}
		
		[Component(Offset = 30, Required = false)]
		public ValueChecksGrpComponent? ValueChecksGrp {get; set;}
		
		[Component(Offset = 31, Required = false)]
		public MatchingInstructionsComponent? MatchingInstructions {get; set;}
		
		[TagDetails(Tag = 2362, Type = TagType.String, Offset = 32, Required = false)]
		public string? SelfMatchPreventionID {get; set;}
		
		[TagDetails(Tag = 2964, Type = TagType.Int, Offset = 33, Required = false)]
		...
		public DisclosureInstructionGrpComponent? DisclosureInstructionGrp {get; set;}
		
		[TagDetails(Tag = 111, Type = TagType.Float, Offset = 36, Required = false)]
		public double? MaxFloor {get; set;}
		
		[TagDetails(Tag = 1300, Type = TagType.String, Offset = 37, Required = false)]
		public string? MarketSegmentID {get; set;}
		
		[TagDetails(Tag = 100, Type = TagType.String, Offset = 38, Required = false)]
		public string? ExDestination {get; set;}
		
		[TagDetails(Tag = 1133, Type = TagType.String, Offset = 39, Required = false)]
		public string? ExDestinationIDSource {get; set;}
		
		[TagDetails(Tag = 2704, Type = TagType.Int, Offset = 40, Required = false)]
		public int? ExDestinationType {get; set;}
		
		[Component(Offset = 41, Required = false)]
		public TrdgSesGrpComponent? TrdgSesGrp {get; set;}
		
		[TagDetails(Tag = 81, Type = TagType.String, Offset = 42, Required = false)]
		...
		[TagDetails(Tag = 140, Type = TagType.Float, Offset = 46, Required = false)]
		public double? PrevClosePx {get; set;}
		
		[TagDetails(Tag = 54, Type = TagType.String, Offset = 47, Required = true)]
		public string? Side {get; set;}
		
		[TagDetails(Tag = 2102, Type = TagType.Boolean, Offset = 48, Required = false)]
		public bool? ShortMarkingExemptIndicator {get; set;}
		
		[TagDetails(Tag = 1688, Type = TagType.Int, Offset = 49, Required = false)]
		public int? ShortSaleExemptionReason {get; set;}
		
		[TagDetails(Tag = 114, Type = TagType.Boolean, Offset = 50, Required = false)]
		public bool? LocateReqd {get; set;}
		
		[TagDetails(Tag = 60, Type = TagType.UtcTimestamp, Offset = 51, Required = true)]
		public DateTime? TransactTime {get; set;}
		
		[Component(Offset = 52, Required = false)]
		public StipulationsComponent? Stipulations {get; set;}
		
		[TagDetails(Tag = 854, Type = TagType.Int, Offset = 53, Required = false)]
		public int? QtyType {get; set;}
		
		[Component(Offset = 54, Required = true)]
		public OrderQtyDataComponent? OrderQtyData {get; set;}
		
		[TagDetails(Tag = 40, Type = TagType.String, Offset = 55, Required = true)]
		public string? OrdType {get; set;}
		
		[TagDetails(Tag = 423, Type = TagType.Int, Offset = 56, Required = false)]
		public int? PriceType {get; set;}
		
		[TagDetails(Tag = 44, Type = TagType.Float, Offset = 57, Required = false)]
		public double? Price {get; set;}
		
		[TagDetails(Tag = 2838, Type = TagType.Float, Offset = 58, Required = false)]
		public double? CurrentWorkingPrice {get; set;}
		
		[TagDetails(Tag = 1092, Type = TagType.String, Offset = 59, Required = false)]
		public string? PriceProtectionScope {get; set;}
		
		[TagDetails(Tag = 99, Type = TagType.Float, Offset = 60, Required = false)]
		...
		[TagDetails(Tag = 1740, Type = TagType.Int, Offset = 66, Required = false)]
		public int? TradePriceNegotiationMethod {get; set;}
		
		[TagDetails(Tag = 1741, Type = TagType.Int, Offset = 67, Required = false)]
		public int? UpfrontPriceType {get; set;}
		
		[TagDetails(Tag = 1742, Type = TagType.Float, Offset = 68, Required = false)]
		public double? UpfrontPrice {get; set;}
		
		[TagDetails(Tag = 376, Type = TagType.String, Offset = 69, Required = false)]
		public string? ComplianceID {get; set;}
		
		[TagDetails(Tag = 2404, Type = TagType.String, Offset = 70, Required = false)]
		public string? ComplianceText {get; set;}
		
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 71, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 72, Required = false, LinksToTag = 2351)]
		public byte[]? EncodedComplianceText {get; set;}
		
		[TagDetails(Tag = 377, Type = TagType.Boolean, Offset = 73, Required = false)]
		public bool? SolicitedFlag {get; set;}
		
		[TagDetails(Tag = 797, Type = TagType.Boolean, Offset = 74, Required = false)]
		public bool? CopyMsgIndicator {get; set;}
		
		[TagDetails(Tag = 23, Type = TagType.String, Offset = 75, Required = false)]
		public string? IOIID {get; set;}
		
		[TagDetails(Tag = 117, Type = TagType.String, Offset = 76, Required = false)]
		public string? QuoteID {get; set;}
		
		[TagDetails(Tag = 59, Type = TagType.String, Offset = 77, Required = false)]
		public string? TimeInForce {get; set;}
		
		[TagDetails(Tag = 168, Type = TagType.UtcTimestamp, Offset = 78, Required = false)]
		public DateTime? EffectiveTime {get; set;}
		
		[TagDetails(Tag = 432, Type = TagType.LocalDate, Offset = 79, Required = false)]
		public DateOnly? ExpireDate {get; set;}
		
		[TagDetails(Tag = 126, Type = TagType.UtcTimestamp, Offset = 80, Required = false)]
		public DateTime? ExpireTime {get; set;}
		
		[TagDetails(Tag = 427, Type = TagType.Int, Offset = 81, Required = false)]
		public int? GTBookingInst {get; set;}
		
		[TagDetails(Tag = 1629, Type = TagType.Int, Offset = 82, Required = false)]
		public int? ExposureDuration {get; set;}
		
		[TagDetails(Tag = 1916, Type = TagType.Int, Offset = 83, Required = false)]
		...
		public CommissionDataGrpComponent? CommissionDataGrp {get; set;}
		
		[TagDetails(Tag = 528, Type = TagType.String, Offset = 86, Required = false)]
		public string? OrderCapacity {get; set;}
		
		[TagDetails(Tag = 529, Type = TagType.String, Offset = 87, Required = false)]
		public string? OrderRestrictions {get; set;}
		
		[TagDetails(Tag = 1815, Type = TagType.Int, Offset = 88, Required = false)]
		public int? TradingCapacity {get; set;}
		
		[TagDetails(Tag = 1934, Type = TagType.Int, Offset = 89, Required = false)]
		...
		public OrderAttributeGrpComponent? OrderAttributeGrp {get; set;}
		...
		[TagDetails(Tag = 354, Type = TagType.Length, Offset = 101, Required = false, LinksToTag = 355)]
		public int? EncodedTextLen {get; set;}
		
		[TagDetails(Tag = 355, Type = TagType.RawData, Offset = 102, Required = false, LinksToTag = 354)]
		...
		[Component(Offset = 111, Required = false)]
		public DiscretionInstructionsComponent? DiscretionInstructions {get; set;}
		
		[TagDetails(Tag = 847, Type = TagType.Int, Offset = 112, Required = false)]
		public int? TargetStrategy {get; set;}
		
		[Component(Offset = 113, Required = false)]
		public StrategyParametersGrpComponent? StrategyParametersGrp {get; set;}
		
		[TagDetails(Tag = 848, Type = TagType.String, Offset = 114, Required = false)]
		public string? TargetStrategyParameters {get; set;}
		
		[TagDetails(Tag = 849, Type = TagType.Float, Offset = 115, Required = false)]
		public double? ParticipationRate {get; set;}
		
		[TagDetails(Tag = 480, Type = TagType.String, Offset = 116, Required = false)]
		public string? CancellationRights {get; set;}
		
		[TagDetails(Tag = 481, Type = TagType.String, Offset = 117, Required = false)]
		public string? MoneyLaunderingStatus {get; set;}
		
		[TagDetails(Tag = 513, Type = TagType.String, Offset = 118, Required = false)]
		public string? RegistID {get; set;}
		
		[TagDetails(Tag = 494, Type = TagType.String, Offset = 119, Required = false)]
		public string? Designation {get; set;}
		
		[TagDetails(Tag = 1028, Type = TagType.Boolean, Offset = 120, Required = false)]
		public bool? ManualOrderIndicator {get; set;}
		
		[TagDetails(Tag = 1029, Type = TagType.Boolean, Offset = 121, Required = false)]
		public bool? CustDirectedOrder {get; set;}
		
		[TagDetails(Tag = 1030, Type = TagType.String, Offset = 122, Required = false)]
		public string? ReceivedDeptID {get; set;}
		
		[TagDetails(Tag = 1031, Type = TagType.String, Offset = 123, Required = false)]
		public string? CustOrderHandlingInst {get; set;}
		
		[TagDetails(Tag = 1032, Type = TagType.Int, Offset = 124, Required = false)]
		public int? OrderHandlingInstSource {get; set;}
		
		[TagDetails(Tag = 1724, Type = TagType.Int, Offset = 125, Required = false)]
		public int? OrderOrigination {get; set;}
		
		[TagDetails(Tag = 2882, Type = TagType.Int, Offset = 126, Required = false)]
		public int? ContraOrderOrigination {get; set;}
		
		[TagDetails(Tag = 1725, Type = TagType.String, Offset = 127, Required = false)]
		public string? OriginatingDeptID {get; set;}
		
		[TagDetails(Tag = 1726, Type = TagType.String, Offset = 128, Required = false)]
		public string? ReceivingDeptID {get; set;}
		
		[TagDetails(Tag = 2883, Type = TagType.Int, Offset = 129, Required = false)]
		public int? RoutingArrangmentIndicator {get; set;}
		
		[TagDetails(Tag = 2884, Type = TagType.Int, Offset = 130, Required = false)]
		public int? ContraRoutingArrangmentIndicator {get; set;}
		
		[TagDetails(Tag = 2525, Type = TagType.Boolean, Offset = 131, Required = false)]
		public bool? AffiliatedFirmsTradeIndicator {get; set;}
		
		[TagDetails(Tag = 522, Type = TagType.Int, Offset = 132, Required = false)]
		public int? OwnerType {get; set;}
		
		[Component(Offset = 133, Required = false)]
		public TrdRegTimestampsComponent? TrdRegTimestamps {get; set;}
		
		[Component(Offset = 134, Required = false)]
		public TrdRegPublicationGrpComponent? TrdRegPublicationGrp {get; set;}
		
		[TagDetails(Tag = 2524, Type = TagType.Int, Offset = 135, Required = false)]
		public int? TradeReportingIndicator {get; set;}
		
		[TagDetails(Tag = 1080, Type = TagType.String, Offset = 136, Required = false)]
		public string? RefOrderID {get; set;}
		
		[TagDetails(Tag = 1081, Type = TagType.String, Offset = 137, Required = false)]
		public string? RefOrderIDSource {get; set;}
		
		[TagDetails(Tag = 1685, Type = TagType.Int, Offset = 138, Required = false)]
		public int? ThrottleInst {get; set;}
		
		[TagDetails(Tag = 1806, Type = TagType.String, Offset = 139, Required = false)]
		public string? RefClOrdID {get; set;}
		
		[TagDetails(Tag = 1803, Type = TagType.Int, Offset = 140, Required = false)]
		public int? AuctionType {get; set;}
		
		[TagDetails(Tag = 1804, Type = TagType.Float, Offset = 141, Required = false)]
		public double? AuctionAllocationPct {get; set;}
		
		[Component(Offset = 142, Required = true)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedComplianceText is not null)
			{
				writer.WriteWholeNumber(2351, EncodedComplianceText.Length);
				writer.WriteBuffer(2352, EncodedComplianceText);
			}
