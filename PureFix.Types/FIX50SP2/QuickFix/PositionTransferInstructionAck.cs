...
namespace PureFix.Types.FIX50SP2.QuickFix
{
	...
	public sealed partial class PositionTransferInstructionAck : IFixMessage
	{
		...
		[TagDetails(Tag = 1664, Type = TagType.Length, Offset = 12, Required = false, LinksToTag = 1665)]
		public int? EncodedRejectTextLen {get; set;}
		
		[TagDetails(Tag = 1665, Type = TagType.RawData, Offset = 13, Required = false, LinksToTag = 1664)]
		...
		bool IFixValidator.IsValid(in FixValidatorConfig config)
		{
			return
				...
				&& TransferInstructionID is not null
