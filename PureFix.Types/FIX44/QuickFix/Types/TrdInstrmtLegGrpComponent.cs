...
{
	public sealed partial class TrdInstrmtLegGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 555, Offset = 0, Required = false)]
		public TradeCaptureReportTrdInstrmtLegGrpNoLegs[]? NoLegs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegs") is IMessageView viewNoLegs)
			{
				...
				NoLegs = new TradeCaptureReportTrdInstrmtLegGrpNoLegs[count];
