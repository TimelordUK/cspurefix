...
{
	public sealed partial class PositionReportPositionQty : IFixGroup
	{
		...
		public PositionReportNestedParties[]? NestedParties {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NestedParties") is IMessageView viewNestedParties)
			{
				...
				NestedParties = new PositionReportNestedParties[count];
