...
{
	[MessageType("TradingSessionStatus", FixVersion.FIX50SP2)]
	public sealed partial class TradingSessionStatus : IFixMessage
	{
		...
		[TagDetails(Tag = 336, Type = TagType.String, Offset = 5, Required = true)]
		...
		[TagDetails(Tag = 1368, Type = TagType.Int, Offset = 11, Required = false)]
		public int? TradSesEvent {get; set;}
		
		[TagDetails(Tag = 567, Type = TagType.Int, Offset = 12, Required = false)]
		public int? TradSesStatusRejReason {get; set;}
		
		[TagDetails(Tag = 341, Type = TagType.UtcTimestamp, Offset = 13, Required = false)]
		public DateTime? TradSesStartTime {get; set;}
		
		[TagDetails(Tag = 342, Type = TagType.UtcTimestamp, Offset = 14, Required = false)]
		public DateTime? TradSesOpenTime {get; set;}
		
		[TagDetails(Tag = 343, Type = TagType.UtcTimestamp, Offset = 15, Required = false)]
		public DateTime? TradSesPreCloseTime {get; set;}
		
		[TagDetails(Tag = 344, Type = TagType.UtcTimestamp, Offset = 16, Required = false)]
		public DateTime? TradSesCloseTime {get; set;}
		
		[TagDetails(Tag = 345, Type = TagType.UtcTimestamp, Offset = 17, Required = false)]
		public DateTime? TradSesEndTime {get; set;}
		
		[TagDetails(Tag = 387, Type = TagType.Float, Offset = 18, Required = false)]
