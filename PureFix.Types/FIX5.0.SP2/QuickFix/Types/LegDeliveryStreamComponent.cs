...
{
	public sealed partial class LegDeliveryStreamComponent : IFixComponent
	{
		[TagDetails(Tag = 41429, Type = TagType.Int, Offset = 0, Required = false)]
		public int? LegDeliveryStreamType {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public LegDeliveryStreamCommoditySourceGrpComponent? LegDeliveryStreamCommoditySourceGrp {get; set;}
		...
		public LegDeliveryStreamCycleGrpComponent? LegDeliveryStreamCycleGrp {get; set;}
