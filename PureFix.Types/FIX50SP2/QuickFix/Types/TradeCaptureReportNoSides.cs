...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class TradeCaptureReportNoSides : IFixGroup
	{
		...
		public SideRegulatoryTradeIDGrpComponent? SideRegulatoryTradeIDGrp {get; set;}
		...
		[TagDetails(Tag = 2351, Type = TagType.Length, Offset = 39, Required = false, LinksToTag = 2352)]
		public int? EncodedComplianceTextLen {get; set;}
		
		[TagDetails(Tag = 2352, Type = TagType.RawData, Offset = 40, Required = false, LinksToTag = 2351)]
		...
		public TradePositionQtyComponent? TradePositionQty {get; set;}
		...
		public SideCollateralAmountGrpComponent? SideCollateralAmountGrp {get; set;}
