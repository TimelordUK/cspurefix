...
{
	public sealed partial class ComplexEventRelativeDateComponent : IFixComponent
	{
		...
		public ComplexEventDateBusinessCenterGrpComponent? ComplexEventDateBusinessCenterGrp {get; set;}
