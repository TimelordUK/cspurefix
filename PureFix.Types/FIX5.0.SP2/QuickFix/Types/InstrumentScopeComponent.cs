...
{
	public sealed partial class InstrumentScopeComponent : IFixComponent
	{
		...
		public InstrumentScopeSecurityAltIDGrpComponent? InstrumentScopeSecurityAltIDGrp {get; set;}
		...
		[TagDetails(Tag = 1620, Type = TagType.Length, Offset = 21, Required = false, LinksToTag = 1621)]
		public int? InstrumentScopeEncodedSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 1621, Type = TagType.RawData, Offset = 22, Required = false, LinksToTag = 1620)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (InstrumentScopeEncodedSecurityDesc is not null)
			{
				writer.WriteWholeNumber(1620, InstrumentScopeEncodedSecurityDesc.Length);
				writer.WriteBuffer(1621, InstrumentScopeEncodedSecurityDesc);
			}
