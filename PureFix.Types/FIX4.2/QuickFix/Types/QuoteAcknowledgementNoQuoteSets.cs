...
{
	public sealed partial class QuoteAcknowledgementNoQuoteSets : IFixValidator, IFixEncoder
	{
		...
		public QuoteAcknowledgementNoQuoteSetsNoQuoteEntries[]? NoQuoteEntries { get; set; }
