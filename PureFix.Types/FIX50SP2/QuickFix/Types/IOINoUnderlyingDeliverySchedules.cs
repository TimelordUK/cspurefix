...
{
	public sealed partial class IOINoUnderlyingDeliverySchedules : IFixGroup
	{
		...
		public UnderlyingDeliveryScheduleSettlDayGrpComponent? UnderlyingDeliveryScheduleSettlDayGrp {get; set;}
