...
{
	public sealed partial class MarketSegmentGrpComponent : IFixComponent
	{
		[Group(NoOfTag = 1310, Offset = 0, Required = false)]
		public SecurityDefinitionNoMarketSegments[]? NoMarketSegments {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoMarketSegments") is IMessageView viewNoMarketSegments)
			{
				...
				NoMarketSegments = new SecurityDefinitionNoMarketSegments[count];
