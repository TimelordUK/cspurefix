...
{
	public sealed partial class IOINoCashSettlTerms : IFixGroup
	{
		...
		public CashSettlDealerGrpComponent? CashSettlDealerGrp {get; set;}
		...
		public CashSettlDateComponent? CashSettlDate {get; set;}
