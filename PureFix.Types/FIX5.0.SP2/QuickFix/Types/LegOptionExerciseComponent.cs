...
{
	public sealed partial class LegOptionExerciseComponent : IFixComponent
	{
		[TagDetails(Tag = 41481, Type = TagType.String, Offset = 0, Required = false)]
		public string? LegExerciseDesc {get; set;}
		
		[TagDetails(Tag = 41482, Type = TagType.Length, Offset = 1, Required = false, LinksToTag = 41483)]
		public int? EncodedLegExerciseDescLen {get; set;}
		
		[TagDetails(Tag = 41483, Type = TagType.RawData, Offset = 2, Required = false, LinksToTag = 41482)]
		...
		public LegSettlMethodElectionDateComponent? LegSettlMethodElectionDate {get; set;}
		
		[Component(Offset = 12, Required = false)]
		public LegOptionExerciseDatesComponent? LegOptionExerciseDates {get; set;}
		
		[Component(Offset = 13, Required = false)]
		public LegOptionExerciseExpirationComponent? LegOptionExerciseExpiration {get; set;}
		
		[Component(Offset = 14, Required = false)]
		public LegOptionExerciseMakeWholeProvisionComponent? LegOptionExerciseMakeWholeProvision {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedLegExerciseDesc is not null)
			{
				writer.WriteWholeNumber(41482, EncodedLegExerciseDesc.Length);
				writer.WriteBuffer(41483, EncodedLegExerciseDesc);
			}
