...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class ClrInstGrpComponent : IFixComponent
	{
		...
		public AllocationInstructionNoClearingInstructions[]? NoClearingInstructions {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoClearingInstructions") is IMessageView viewNoClearingInstructions)
			{
				...
				NoClearingInstructions = new AllocationInstructionNoClearingInstructions[count];
