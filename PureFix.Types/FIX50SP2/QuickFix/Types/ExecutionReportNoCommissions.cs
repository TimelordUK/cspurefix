...
{
	public sealed partial class ExecutionReportNoCommissions : IFixGroup
	{
		...
		[TagDetails(Tag = 2651, Type = TagType.Length, Offset = 14, Required = false, LinksToTag = 2652)]
		public int? EncodedCommissionDescLen {get; set;}
		
		[TagDetails(Tag = 2652, Type = TagType.RawData, Offset = 15, Required = false, LinksToTag = 2651)]
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedCommissionDesc is not null)
			{
				writer.WriteWholeNumber(2651, EncodedCommissionDesc.Length);
				writer.WriteBuffer(2652, EncodedCommissionDesc);
			}
		}
