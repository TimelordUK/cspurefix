...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class BaseTradingRulesComponent : IFixComponent
	{
		...
		public TickRulesComponent? TickRules {get; set;}
		
		[Component(Offset = 1, Required = false)]
		public LotTypeRulesComponent? LotTypeRules {get; set;}
		
		[Component(Offset = 2, Required = false)]
		public PriceLimitsComponent? PriceLimits {get; set;}
		
		[Component(Offset = 3, Required = false)]
		public PriceRangeRuleGrpComponent? PriceRangeRuleGrp {get; set;}
		
		[Component(Offset = 4, Required = false)]
		public QuoteSizeRuleGrpComponent? QuoteSizeRuleGrp {get; set;}
