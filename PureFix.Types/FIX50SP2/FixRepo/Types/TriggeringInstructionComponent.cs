...
{
	public sealed partial class TriggeringInstructionComponent : IFixComponent
	{
		...
		[TagDetails(Tag = 1102, Type = TagType.Float, Offset = 2, Required = false)]
		public double? TriggerPrice {get; set;}
		
		[TagDetails(Tag = 1103, Type = TagType.String, Offset = 3, Required = false)]
		public string? TriggerSymbol {get; set;}
		
		[TagDetails(Tag = 1104, Type = TagType.String, Offset = 4, Required = false)]
		public string? TriggerSecurityID {get; set;}
		
		[TagDetails(Tag = 1105, Type = TagType.String, Offset = 5, Required = false)]
		public string? TriggerSecurityIDSource {get; set;}
		
		[TagDetails(Tag = 1106, Type = TagType.String, Offset = 6, Required = false)]
		public string? TriggerSecurityDesc {get; set;}
		
		[TagDetails(Tag = 1107, Type = TagType.String, Offset = 7, Required = false)]
		public string? TriggerPriceType {get; set;}
		
		[TagDetails(Tag = 1108, Type = TagType.String, Offset = 8, Required = false)]
		public string? TriggerPriceTypeScope {get; set;}
		
		[TagDetails(Tag = 1109, Type = TagType.String, Offset = 9, Required = false)]
		public string? TriggerPriceDirection {get; set;}
		
		[TagDetails(Tag = 1110, Type = TagType.Float, Offset = 10, Required = false)]
		public double? TriggerNewPrice {get; set;}
		
		[TagDetails(Tag = 1111, Type = TagType.String, Offset = 11, Required = false)]
		public string? TriggerOrderType {get; set;}
		
		[TagDetails(Tag = 1112, Type = TagType.Float, Offset = 12, Required = false)]
		public double? TriggerNewQty {get; set;}
		
		[TagDetails(Tag = 1113, Type = TagType.String, Offset = 13, Required = false)]
		public string? TriggerTradingSessionID {get; set;}
		
		[TagDetails(Tag = 1114, Type = TagType.String, Offset = 14, Required = false)]
