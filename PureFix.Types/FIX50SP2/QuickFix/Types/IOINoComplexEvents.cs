...
{
	public sealed partial class IOINoComplexEvents : IFixGroup
	{
		...
		public ComplexEventDatesComponent? ComplexEventDates {get; set;}
		...
		public ComplexEventRateSourceGrpComponent? ComplexEventRateSourceGrp {get; set;}
		
		[Component(Offset = 30, Required = false)]
		public ComplexEventRelativeDateComponent? ComplexEventRelativeDate {get; set;}
		
		[Component(Offset = 31, Required = false)]
		public ComplexEventPeriodGrpComponent? ComplexEventPeriodGrp {get; set;}
		...
		public ComplexEventCreditEventSourceGrpComponent? ComplexEventCreditEventSourceGrp {get; set;}
		
		[Component(Offset = 38, Required = false)]
		public ComplexEventCreditEventGrpComponent? ComplexEventCreditEventGrp {get; set;}
