...
{
	public sealed partial class UnderlyingInstrument : IFixValidator, IFixEncoder
	{
		...
		public UnderlyingInstrumentNoUnderlyingSecurityAltID[]? NoUnderlyingSecurityAltID { get; set; }
