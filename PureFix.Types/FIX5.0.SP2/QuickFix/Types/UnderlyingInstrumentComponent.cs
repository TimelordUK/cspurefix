...
namespace PureFix.Types.FIX50SP2.QuickFix.Types
{
	public sealed partial class UnderlyingInstrumentComponent : IFixComponent
	{
		...
		public UnderlyingSecurityXMLComponent? UnderlyingSecurityXML {get; set;}
		...
		[TagDetails(Tag = 362, Type = TagType.Length, Offset = 63, Required = false, LinksToTag = 363)]
		public int? EncodedUnderlyingIssuerLen {get; set;}
		
		[TagDetails(Tag = 363, Type = TagType.RawData, Offset = 64, Required = false, LinksToTag = 362)]
		...
		[TagDetails(Tag = 2721, Type = TagType.Length, Offset = 67, Required = false, LinksToTag = 2722)]
		public int? EncodedUnderlyingFinancialInstrumentFullNameLen {get; set;}
		
		[TagDetails(Tag = 2722, Type = TagType.RawData, Offset = 68, Required = false, LinksToTag = 2721)]
		...
		[TagDetails(Tag = 364, Type = TagType.Length, Offset = 72, Required = false, LinksToTag = 365)]
		public int? EncodedUnderlyingSecurityDescLen {get; set;}
		
		[TagDetails(Tag = 365, Type = TagType.RawData, Offset = 73, Required = false, LinksToTag = 364)]
		...
		public UndlyInstrumentPartiesComponent? UndlyInstrumentParties {get; set;}
		...
		public UnderlyingEvntGrpComponent? UnderlyingEvntGrp {get; set;}
		...
		[TagDetails(Tag = 2287, Type = TagType.Length, Offset = 125, Required = false, LinksToTag = 2288)]
		public int? EncodedUnderlyingOptionExpirationDescLen {get; set;}
		
		[TagDetails(Tag = 2288, Type = TagType.RawData, Offset = 126, Required = false, LinksToTag = 2287)]
		...
		public UnderlyingSecondaryAssetGrpComponent? UnderlyingSecondaryAssetGrp {get; set;}
		
		[Component(Offset = 139, Required = false)]
		public UnderlyingAssetAttributeGrpComponent? UnderlyingAssetAttributeGrp {get; set;}
		...
		public UnderlyingComplexEventsComponent? UnderlyingComplexEvents {get; set;}
		...
		public UnderlyingDateAdjustmentComponent? UnderlyingDateAdjustment {get; set;}
		
		[Component(Offset = 188, Required = false)]
		public UnderlyingPricingDateTimeComponent? UnderlyingPricingDateTime {get; set;}
		
		[Component(Offset = 189, Required = false)]
		public UnderlyingMarketDisruptionComponent? UnderlyingMarketDisruption {get; set;}
		
		[Component(Offset = 190, Required = false)]
		public UnderlyingOptionExerciseComponent? UnderlyingOptionExercise {get; set;}
		
		[Component(Offset = 191, Required = false)]
		public UnderlyingStreamGrpComponent? UnderlyingStreamGrp {get; set;}
		
		[Component(Offset = 192, Required = false)]
		public UnderlyingProvisionGrpComponent? UnderlyingProvisionGrp {get; set;}
		
		[Component(Offset = 193, Required = false)]
		public UnderlyingAdditionalTermGrpComponent? UnderlyingAdditionalTermGrp {get; set;}
		
		[Component(Offset = 194, Required = false)]
		public UnderlyingProtectionTermGrpComponent? UnderlyingProtectionTermGrp {get; set;}
		
		[Component(Offset = 195, Required = false)]
		public UnderlyingCashSettlTermGrpComponent? UnderlyingCashSettlTermGrp {get; set;}
		
		[Component(Offset = 196, Required = false)]
		public UnderlyingPhysicalSettlTermGrpComponent? UnderlyingPhysicalSettlTermGrp {get; set;}
		
		[Component(Offset = 197, Required = false)]
		public UnderlyingRateSpreadScheduleComponent? UnderlyingRateSpreadSchedule {get; set;}
		
		[Component(Offset = 198, Required = false)]
		public UnderlyingDividendPayoutComponent? UnderlyingDividendPayout {get; set;}
		
		[Component(Offset = 199, Required = false)]
		public UnderlyingExtraordinaryEventGrpComponent? UnderlyingExtraordinaryEventGrp {get; set;}
		...
		void IFixEncoder.Encode(IFixWriter writer)
		{
			...
			if (EncodedUnderlyingFinancialInstrumentFullName is not null)
			{
				writer.WriteWholeNumber(2721, EncodedUnderlyingFinancialInstrumentFullName.Length);
				writer.WriteBuffer(2722, EncodedUnderlyingFinancialInstrumentFullName);
			}
			...
			if (EncodedUnderlyingOptionExpirationDesc is not null)
			{
				writer.WriteWholeNumber(2287, EncodedUnderlyingOptionExpirationDesc.Length);
				writer.WriteBuffer(2288, EncodedUnderlyingOptionExpirationDesc);
			}
