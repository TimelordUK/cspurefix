...
namespace PureFix.Types.FIX44.QuickFix.Types
{
	public sealed partial class LegPreAllocGrpComponent : IFixComponent
	{
		...
		public NewOrderMultilegLegOrdGrpNoLegsLegPreAllocGrpNoLegAllocs[]? NoLegAllocs {get; set;}
		...
		void IFixParser.Parse(IMessageView? view)
		{
			...
			if (view.GetView("NoLegAllocs") is IMessageView viewNoLegAllocs)
			{
				...
				NoLegAllocs = new NewOrderMultilegLegOrdGrpNoLegsLegPreAllocGrpNoLegAllocs[count];
